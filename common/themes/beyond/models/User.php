...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function setAvatars($avatars, $id) {
        $model = $this->findIdentity($id);
        $model->avatar = json_encode($avatars);
        return $model->save();
    }
    ...
    public function getAvatar($size = 'small', $id) {
        $model = $this->findIdentity($id);
        if (!empty($model->avatar)) {
            $avatars = json_decode($model->avatar);
    ...
    public function getIsProfileTitle() {
        $check = Profile::findOne($this->id);
        $title = \app\models\Tbtitlename::findOne($check->User_title);
