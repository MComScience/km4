...
<div class="vw-fi-rep-list-search">
    ...
    <div class="form-group" >
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <input type="text" class="form-control" style="background-color: white;text-align:right" readonly="" name="rep_summary_id" id="rep_summary_id" value="<?php //echo $rep_summary_id;    ?>">
        </div>
        <label class="col-lg-1 col-md-1 col-sm-12 col-xs-12 control-label no-padding-right">วันที่</label>
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <?=
            $form->field($model, 'repdate', ['showLabels' => false])->widget(yii\jui\DatePicker::classname(), [
                'language' => 'th',
