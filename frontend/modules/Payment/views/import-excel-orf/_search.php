...
<div class="VwRepUcOpipListSearch">
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin-top: 8px">
          <label><span class="text"></span><input type="checkbox" class="colored-success" name="VwRepUcSearch[itemstatus]" id="chk_orf"  data-toggle="checkbox-x"><span class="text"> แสดงเฉพาะรายการที่ยังไม่บันทึกลูกหนี้</span></label>
...
$script = <<< JS
    ...
    $("input[id=chk_orf]").click(function () {
    if ($(this).is(":checked"))
    {   
