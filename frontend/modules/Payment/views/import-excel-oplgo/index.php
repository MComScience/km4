                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'hAlign' => GridView::ALIGN_CENTER,
                            'value' => function ($model) {
                                if ($model->fund_section == null) {
                                    return '-';
                                } else {
                                    return $model->fund_section." ".$model->fund_region;
                                }
                            }
                        ],
                        [
...
<?php
$script = <<< JS
$(".file-caption-name").text('eclaim_xxx_(OPLGO หรือ IPLGO)');
