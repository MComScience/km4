...
use app\modules\Payment\models\VwRepUcOpcs;

/**
 * VwRepUcOpcsSearch represents the model behind the search form about `app\modules\Payment\models\VwRepUcOpcs`.
 */
class VwRepUcOpcsSearch extends VwRepUcOpcs
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['doc_type', 'invoice_eclaim_num', 'import_by', 'Import_date', 'pid', 'pt_name', 'pt_registry_datetime', 'pt_discharge_datetime', 'hcode'], 'safe'],
