...
class vwptar extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['pt_ar_id', 'pt_visit_number', 'pt_ar_seq', 'pt_ar_usage', 'credit_group_id', 'refer_hsender_doc_qtylimited', 'refer_hsender_sent_typeid', 'refer_hrecieve_doc_id', 'ar_id', 'pt_hospital_number'], 'integer'],
            [['refer_hsender_doc_start', 'refer_hsender_doc_expdate', 'refer_hrecieve_doc_date'], 'safe'],
            [['medical_right_group_id', 'medical_right_group', 'medical_right_desc', 'medical_right_id', 'ar_card_id'], 'string', 'max' => 50],
