...
/**
 * This is the model class for table "tb_fi_nhso_inv_detail".
 *
 ...
 *
 * @property TbFiNhsoInv $nhsoInv
 */
class TbFiNhsoInvDetail extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['nhso_inv_ids', 'nhso_inv_id'], 'required'],
            ...
            [['nhso_inv_id'], 'exist', 'skipOnError' => true, 'targetClass' => TbFiNhsoInv::className(), 'targetAttribute' => ['nhso_inv_id' => 'nhso_inv_id']],
        ];
    }
     ...
     */
    public function getNhsoInv()
    {
        return $this->hasOne(TbFiNhsoInv::className(), ['nhso_inv_id' => 'nhso_inv_id']);
    }
}
