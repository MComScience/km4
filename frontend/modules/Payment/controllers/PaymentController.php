    ...
    public function actionViewDetailInv()
    {
        if (isset($_POST['expandRowKey'])) {
            ...
            if (!empty($find_visit_number)) {
            	...
            	return '<div class="alert alert-warning">ไม่พบข้อมูล pt_visit_number ใน (vw_inv_for_rep_list) ที่ inv_id='.$inv_id.'</div>';
            }
        } else {
    ...
    public function actionViewDetailRep()
    {
        if (isset($_POST['expandRowKey'])) {
            ...
            if (!empty($find_visit_number)) {
            	...
            	return '<div class="alert alert-warning">ไม่พบข้อมูล pt_visit_number ใน (vw_fi_rep_hearder) ที่ rep_id='.$rep_id.'</div>';
            }
        } else {
            return '<div class="alert alert-warning">ไม่พบข้อมูล</div>';
        }
    ...
    public function actionViewDetailItem()
    {
        if (isset($_POST['expandRowKey'])) {
            ...
            if(!empty($findIds)){
            	...
            	return '<div class="alert alert-warning">ไม่พบข้อมูล cpoe_ids ใน (vw_fi_rep_detail) ที่ ids_rep='.$ids_rep.'</div>';
            }
        } else {
            return '<div class="alert alert-warning">ไม่พบข้อมูล</div>';
        }
