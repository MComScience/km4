            ...
            <div class="tab-content">
                <div id="home" class="tab-pane in active">
                    <div class="tbqr2-form">
                        ...
                        <div class="form-group">
                            <?= Html::activeLabel($model, 'QRmassage', ['label' => 'ข้อความ', 'class' => 'col-sm-2 control-label no-padding-right']) ?>
                            <div class="col-sm-3">
                                <?= $form->field($model, 'QRmassage', ['showLabels' => false])->textarea(['rows' => 3, 'style' => 'background-color: #ffff99;',]); ?>
...
\yii\bootstrap\Modal::begin([
    'id' => 'modalvendor',
    'header' => '<h4 class="modal-title">บันทึกรายการ</h4>',
