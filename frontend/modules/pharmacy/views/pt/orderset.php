...
<script>
    function GetmodalIVSolution() {
        ...
        $.ajax({
            url: 'index.php?r=pharmacy/pt/ivsolution',
            type: 'get',
    ...
    function GetmodalIVSolutionPremed() {
        ...
        var vn = <?= "'" . $modelChemo->pt_visit_number . "'" ?>;
        $.ajax({
            url: 'index.php?r=pharmacy/pt/ivsolution-premed',
            type: 'get',
            data: {drugset_id: drugset_id, vn: vn},
            dataType: 'json',
            success: function (data) {
    ...
    function EditIVSolution(e) {
        ...
        $.ajax({
            url: 'index.php?r=pharmacy/pt/edit-ivsolution',
            type: 'post',
    ...
    function SaveDraftOrderSet() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=pharmacy/pt/savedraft-orderset',
            data: frm.serialize(),
            success: function (data) {
                swal({
                    title: "",
    ...
    function SaveOrderSet() {
        ...
        $.ajax({
            type: frm.attr('method'),
            url: 'index.php?r=pharmacy/pt/save-orderset',
            data: frm.serialize(),
            success: function (data) {
                swal({
                    title: "",
