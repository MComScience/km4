...
/* @var $model app\modules\pharmacy\models\TbCpoeSearch */
...
<div class="tb-cpoe-search">
    ...
    <?php // echo $form->field($model, 'pt_cpr_number') ?>

    <?php // echo $form->field($model, 'pt_ocpa_number') ?>
    ...
    <?php // echo $form->field($model, 'drugset_id') ?>

    <?php // echo $form->field($model, 'pt_trp_regimen_name') ?>
