...
$this->params['breadcrumbs'][] = ['label' => 'จ่ายยา', 'url' => ['/pharmacy/rx-issue/issue-list']];
                        ...
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12" style="text-align: right;">
                                    <?= Html::a('Close', ['/pharmacy/rx-issue/issue-list'], ['class' => 'btn btn-default']); ?>
                                    <?= Html::button('Call patient', ['class' => 'btn btn-success','id' => 'callpatient']); ?>
                                    <?= Html::button('Order Complete Issue', ['class' => 'btn btn-primary', 'id' => 'issue']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
