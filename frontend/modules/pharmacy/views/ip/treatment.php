...
$this->params['breadcrumbs'][] = ['label' => 'Chemo Order : ผู้ป่วยใน', 'url' => ['/pharmacy/ip/treatment', 'data' => $header->pt_visit_number]];
        ...
        swal({
            ...
            confirmButtonText: "Confirm",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post(
                                'index.php?r=pharmacy/ip/delete',
                                {
                                    id: fID
                                },
                        function (data)
...
<script>
        ...
        swal({
            ...
            closeOnCancel: true,
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post(
                                'index.php?r=pharmacy/ip/delete-drugset',
                                {
                                    id: id
                                },
                                function (data)
    ...
    function Duplicate() {
        ...
        $.ajax({
            type: 'POST',
            url: 'index.php?r=pharmacy/ip/duplicate',
            data: frm.serialize(),
            dataType: "JSON",
            success: function () {
                swal({
