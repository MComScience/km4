                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        ...
                        $form->field($model, 'cpoe_drugprandialadviceid', ['showLabels' => false])->widget(DepDrop::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'url' => Url::to(['/pharmacy/pt/get-drugadvice']),
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <div class="form-group" style="text-align: right;">
            ...
            <?= Html::button('Save', ['type' => 'button', 'class' => 'btn btn-success ladda-button', 'id' => 'Savedrugsetdetail', 'data-style' => 'expand-left']); ?>
        </div>
    </div>
</div>
<!-- End Row -->
...
<script>
    ...
    function CalculateQty1() {
        ...
        $.ajax({
            type: frm.attr('method'),
            url: 'index.php?r=pharmacy/ip/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
            success: function (data) {
    ...
    function CalculateDrugprice1() {
        ...
        $.ajax({
            url: "index.php?r=pharmacy/ip/calculate-drugprice",
            type: "post",
    ...
    $('select[id=tbdrugsetdetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=pharmacy/ip/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
