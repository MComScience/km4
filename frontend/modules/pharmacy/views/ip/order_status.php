        ...
        swal({
            ...
            confirmButtonText: "Confirm",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post(
                                'index.php?r=pharmacy/orderip/delete',
                                {
                                    id: fID
                                },
                        function (data)
                                        ...
                                        'buttons' => [
                                            'update' => function ($url, $model, $key) {
                                                if ($model['drugset_id'] != null) {
                                                    return Html::a('<span class="btn btn-info btn-xs"> Edit </span>', Url::to(['/pharmacy/rxorderip/create', 'data' => $key, 'vn' => $model['pt_vn_number']]), [
                                                                'title' => 'Edit',
                                                                'data-pjax' => 0,
                                                    ]);
                                                } else {
                                                    return Html::a('<span class="btn btn-info btn-xs"> Edit </span>', Url::to(['/pharmacy/orderip/index', 'id' => $key]), [
                                                                'title' => 'Edit',
                                                                'data-pjax' => 0,
                                                    ]);
                                                }
