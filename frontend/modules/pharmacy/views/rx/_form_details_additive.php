        ...
        <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-1">
                    <p></p>
                    <?php // Html::a('Calculate', 'javascript:void(0);', ['onclick' => 'CalculateQty(this);', 'class' => 'btn btn-sm btn-primary ladda-button','data-style' => 'slide-left','id' => 'CalculateQty']); ?>
                </div>
            </div><!-- End Row -->
        </div><!-- End Well -->
    </div>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('input[id=tbcpoedetail-itemqty1]').val(data.Qty);
