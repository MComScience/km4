...
<div class="tb-cpoe-form">
    ...
    <div class="form-group">
    	<div class="col-sm-1">
    		<?php echo Html::a('Select Package', ['select-package', 'type' => $type, 'data' => $model['cpoe_id']], ['class' => 'btn btn-warning btn-sm']); ?>
    	</div>
        <?= Html::activeLabel($model, 'cpoe_num', ['label' => 'ใบสั่งยาเลขที่', 'class' => 'col-sm-1 control-label no-padding-right']) ?>
        <div class="col-sm-2">
