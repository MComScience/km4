            ...
            <div class="row">
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <?= Html::a('คำนวณปริมาณ', 'javascript:void(0);', ['onclick' => 'CalculateQty1(this);', 'class' => 'btn btn-block btn-primary ladda-button', 'data-style' => 'slide-left', 'id' => 'CalculateQty1']); ?>
                    </div>
                </div>
            </div>
        </div><!-- End Well -->
        ...
        <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-1">
                    <p></p>
                    <span style="font-size: 13pt;">set</span>
                </div>
            </div><!-- End Row -->
        </div><!-- End Well -->
    </div>
...
<script>
    ...
    function CalculateQty1() {
        ...
        $.ajax({
            type: frm.attr('method'),
            url: 'index.php?r=pharmacy/rx/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
            success: function (data) {
    ...
    function CalculateDrugprice1() {
        ...
        $.ajax({
            url: "index.php?r=pharmacy/rx/calculate-drugprice",
            type: "post",
    ...
    $("div[id=drugroutename]").click(function () {
        $('select[id=cat-id]').on('change', function () {
            ...
            if (routeid != '') {
                $.ajax({
                    url: "index.php?r=pharmacy/rx/getroute-select",
                    type: "get",
    ...
    $('select[id=tbcpoedetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=pharmacy/rx/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
