...
<div class="row">
    <div class="col-md-7 col-md-offset-0">
        <div id="simplewizard" class="wizard" data-target="#simplewizard-steps">
            <ul class="steps">
                <li id="simplewizardstep1" data-target="#simplewizardstep1" class="active"><span class="step">1</span><?= $type == 21 ? 'เลือก KVO Solution' : 'เลือกยา' ?><span class="chevron"></span></li>
                    ...
                    <div class="tabbable">
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <div id="content1" class="tab-pane in active">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        */?>
                                        <?php // echo $druglistop;?><div class="tbitem"></div>
                                        <br/>
                                        <?= Html::button('Close', ['type' => 'button', 'class' => 'btn btn-default pull-right', 'data-dismiss' => 'modal']); ?>
                            ...
                            <div id="content2" class="tab-pane">
                                <div class="row">
                                    <?php echo $this->render('_form_ised', ['model' => $cpoeModel, 'isedmodel' => $isedModel,]) ?>
                                </div>
                            </div>
                            <!-- End Content -->
                            ...
                            <div id="content3" class="tab-pane">
                                <?php
                                echo $this->render('_form_details_bytype', [
                                    'model' => $cpoeModel,
                                    'cpoeid' => $cpoeid,
                                    'route' => $route,
                                    'type' => $type,
