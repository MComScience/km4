...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6">
        ...
        <div class="well">
            ...
            <div class="row">
                <div class="form-group">
                    <?= Html::activeLabel($model, 'Item_comment4', ['label' => '<b>คำสั่งเพิ่มเติม</b>', 'class' => 'col-sm-2 control-label no-padding-right']) ?>
                    <div class="col-xs-12 col-sm-6 col-md-8">
...
<div class="row">
    <div class="form-group">
        <div class="col-xs-12 col-sm-6 col-md-8">
            ...
            <?= $form->field($model, 'cpoe_Itemtype', ['showLabels' => false])->hiddenInput(['value' => $type == 'homemed' ? '' : $type]) ?>
        ...
        <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-1">
                    <p></p>
                    <span class="disunitontable" style="font-size: 13pt;"></span>
                </div>
            </div><!-- End Row -->
        </div><!-- End Well -->
    </div>
