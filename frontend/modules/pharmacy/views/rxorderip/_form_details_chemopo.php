...
<script>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=pharmacy/rxorderip/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=pharmacy/rxorderip/calculate-drugprice",
            type: "post",
    ...
    $('select[id=tbcpoedetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=pharmacy/rxorderip/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
