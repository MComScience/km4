...
$this->params['breadcrumbs'][] = ['label' => 'Rx Order : ผู้ป่วยนอก', 'url' => ['create', 'data' => $model['cpoe_id'], 'vn' => $header['pt_visit_number']]];
                    ...
                    <div class="tabbable">  
                        ...
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <p style="text-align: right;">
                                <?= Html::a('Close', ['/pharmacy/pt/treatment', 'data' => $model['pt_vn_number']], ['class' => 'btn btn-default']); ?>
...
<script>
    function GetmodalIVSolution() {
        ...
        $.ajax({
            url: 'index.php?r=pharmacy/rxorder/ivsolution',
            type: 'get',
            data: {cpoeid: cpoeid},
            dataType: 'json',
    ...
    function EditIVSolution(id) {
        $.ajax({
            url: 'index.php?r=pharmacy/rxorder/edit-ivsolution',
            type: 'post',
            data: {id: id},
            dataType: 'json',
            success: function (data) {
    ...
    function GetmodalIVSolutionPremed() {
        var cpoeid = $('#tbcpoe-cpoe_id').val();
        $.ajax({
            url: 'index.php?r=pharmacy/rxorder/ivsolution-premed',
            type: 'get',
            data: {cpoeid: cpoeid},
            dataType: 'json',
            success: function (data) {
