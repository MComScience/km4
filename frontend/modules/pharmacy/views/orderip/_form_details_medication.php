            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        <?= $form->field($model, 'cpoe_doseqty', ['showLabels' => false])->textInput(['style' => 'background-color: white','value' => empty($moidel['cpoe_doseqty']) ? '1' : $model['cpoe_doseqty']]) ?>  
                    </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <div class="form-group" style="text-align: right;">
            ...
            <?= Html::button('Save', ['type' => 'button', 'class' => 'btn btn-success ladda-button', 'id' => 'Savecpoedetail','data-style' => 'expand-left']); ?>
        </div>
    </div>
</div>
<?php ActiveForm::end(); ?>
...
<script>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=pharmacy/orderip/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=pharmacy/orderip/calculate-drugprice",
            type: "post",
    ...
    $("div[id=drugroutename]").click(function () {
        $('select[id=cat-id]').on('change', function () {
            ...
            if (routeid != '') {
                $.ajax({
                    url: "index.php?r=pharmacy/orderip/getroute-select",
                    type: "get",
    ...
    $('select[id=tbcpoedetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=pharmacy/orderip/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
