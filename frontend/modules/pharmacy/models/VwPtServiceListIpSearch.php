...
/**
 * VwPtServiceListIpSearch represents the model behind the search form about `app\modules\pharmacy\models\VwPtServiceListIp`.
 */
class VwPtServiceListIpSearch extends VwPtServiceListIp
{
    /**
     * @inheritdoc
     */
