 ...
 * @property string $pt_trp_chemo_name
...
class VwPtTrpChemo extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pt_trp_regimen_name', 'cpoe_status_decs'], 'string', 'max' => 100],
            [['medical_right_desc', 'pt_trp_regimen_id', 'pt_trp_credit_id', 'pt_trp_regimen_paycode'], 'string', 'max' => 50],
            [['pt_trp_cpr_number', 'pt_trp_ocpa_number'], 'string', 'max' => 20],
            [['pt_trp_comment'], 'string', 'max' => 255],
            [['pt_trp_chemo_name'], 'string', 'max' => 17],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pt_trp_chemo_name' => 'Pt Trp Chemo Name',
