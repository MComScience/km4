...
/**
 * VwPtServiceListOpSearch represents the model behind the search form about `app\modules\pharmacy\models\VwPtServiceListOp`.
 */
class VwPtServiceListOpSearch extends VwPtServiceListOp
{
    ...
    public function searchIndex($params) {
        $query = VwPtServiceListOp::find()->select(['HNVN', 'pt_name', 'pt_right','pt_visit_number']);
        ...
        $query->andFilterWhere(['like', 'HNVN', $this->HNVN])
                ->andFilterWhere(['like', 'pt_name', $this->pt_name])
