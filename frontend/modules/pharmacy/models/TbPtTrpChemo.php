...
/**
 * This is the model class for table "tb_pt_trp_chemo".
 *
 ...
 *
 * @property TbPtTrpChemoDetail[] $tbPtTrpChemoDetails
 */
class TbPtTrpChemo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['pt_hospital_number', 'medical_right_id', 'credit_group_id', 'pt_trp_regimen_status', 'pt_trp_regimen_createby', 'pt_visit_number'], 'integer'],
     ...
     */
    public function getTbPtTrpChemoDetails()
    {
        return $this->hasMany(TbPtTrpChemoDetail::className(), ['pt_trp_chemo_id' => 'pt_trp_chemo_id']);
    }
}
