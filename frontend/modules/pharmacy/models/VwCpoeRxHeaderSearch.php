...
class VwCpoeRxHeaderSearch extends VwCpoeRxHeader
{
    ...
    {
        return [
            [['schedule_type','cpoe_id', 'cpoe_type', 'pt_vn_number', 'cpoe_order_by', 'cpoe_order_section', 'pt_hospital_number', 'pt_admission_number', 'pt_status', 'pt_age_registry_date', 'cpoe_createby', 'cpoe_status'], 'integer'],
