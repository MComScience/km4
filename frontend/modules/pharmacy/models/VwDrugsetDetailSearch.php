...
use app\modules\pharmacy\models\VwDrugsetDetail;

/**
 * VwDrugsetDetailSearch represents the model behind the search form about `app\modules\pharmacy\models\VwDrugsetDetail`.
 */
class VwDrugsetDetailSearch extends VwDrugsetDetail
{
     ...
     */
    public function search($params,$drugsetid)
    {
        $query = VwDrugsetDetail::find()->where(['drugset_id' => $drugsetid,'cpoe_Itemtype' => [10,20,21,22,40,50,53,54]]);
