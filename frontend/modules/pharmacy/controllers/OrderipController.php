...
/**
 * OrderipController implements the CRUD actions for TbCpoe model.
 */
class OrderipController extends Controller {
    ...
    public function actionIndex($id) {
        ...
        $header = VwPtServiceListIp::findOne($model['pt_vn_number']);
    ...
    public function actionArdetail() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                $headerdetail = VwPtServiceListIp::findOne(['pt_visit_number' => $request->get('vn_number')]);
