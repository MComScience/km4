...
/**
 * PtController implements the CRUD actions for TbPtTrpChemo model.
 */
class PtController extends Controller {
    ...
    public function actionArdetail() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                $headerdetail = VwPtServiceListOp::findOne(['pt_visit_number' => $request->get('vn')]);
    ...
    public function actionOrderset($chemoid, $drugsetid) {
        ...
        $header = VwPtServiceListOp::findOne($modelChemo->pt_visit_number);
    ...
    public function actionCreateRxorder($drugset_id, $chemoid) {
        ...
        return $this->redirect(['/pharmacy/rxorder/create', 'data' => $cpoe_id, 'vn' => $vn]);
    }
