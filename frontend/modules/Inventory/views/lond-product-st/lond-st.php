...
$this->title = "ร่างใบส่งคืนสินค้าขอยืม";
    ...
    <div class="tab-content">
        <div id="tab" class="tab-pane in active ">
            <div class="tb-st2-temp-index">
                <?php Pjax::begin(['id'=>'lond_product_temp','timeout' => 5000]) ?>
                <?php echo $this->render('_search_lond_temp', ['model' => $searchModel]); ?>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'hAlign' => GridView::ALIGN_CENTER,
                            'value' => function ($model) {
                                if ($model->vender->VenderName == null) {
                                    return '-';
                                } else {
