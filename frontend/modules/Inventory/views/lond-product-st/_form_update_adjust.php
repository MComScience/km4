        ...
        <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <br>
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right"><h5 class="row-title before-success">ยอดยืม</h5></label>
                        <div class="col-sm-8">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="radio">
                                <label><input type="radio" name="แพค" id="แพคGR" value="yes"/> <span class="text">แพค</span></label>
                                <label><input type="radio" name="แพค" id="ชิ้นGR" value="no"/> <span class="text">ชิ้น</span></label>
                            </div>
                            
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">จำนวนแพค<a id="checkจำนวนแพคGR"></a></label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">หน่วยแพค<a id="checkหน่วยแพคGR"></a></label>
                        <div class="col-sm-8">
                           <input type="text" id="GRPackUnit" name="GRPackUnit" class="form-control" style="background-color: white;text-align:right;" readonly="" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?=
                            $form->field($modelGR, 'GRItemPackID', ['showLabels' => false])->textInput([
                                'value' => number_format($GRItemPackSKUQty, 2),
                                'style' => 'background-color: white;text-align:right;margin-top: 10px;',
                                'readonly' => true,
                            ])
                            ?>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">ราคาต่อแพค<a id="checkราคาต่อแพคGR"></a></label>
                        <div class="col-sm-8">
                            <?=
                            $form->field($modelGR, 'GRPackUnitCost', ['showLabels' => false])->textInput([
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">จำนวน(<?php echo $modelGR->DispUnit;?>)<a id="checkจำนวนGR"></a></label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">ราคาต่อหน่วย<a id="checkราคาต่อหน่วยGR"></a></label>
                        <div class="col-sm-8">
                            <?=
                            $form->field($modelGR, 'GRItemUnitCost', ['showLabels' => false])->textInput([
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right">คืนแล้ว(<?php echo $modelGR->DispUnit;?>)</label>
                        <div class="col-sm-8">
                        <input type="text" id="STSentQty" name="STSentQty" class="form-control" style="background-color: white;text-align:right;" readonly="" value="<?php echo $STSentQty; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <br>
                        <label class="col-sm-4 control-label no-padding-right">ค้างส่ง(<?php echo $modelGR->DispUnit;?>)</label>
                        <div class="col-sm-8">
                        <input type="text" name="STLeftQty" id="STLeftQty" class="form-control" style="background-color: white;text-align:right;margin-top: -10px;" readonly="" value="0.00">
                        </div>
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <br>
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right"><h5 class="row-title before-success">ยอดคืน</h5></label>
                        <div class="col-sm-8">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <input type="hidden" name="ids_gr" id="ids_gr" value="<?php echo $ids_gr;?>">
            <input type="hidden" id="GRUnit" name="GRUnit" value="<?php echo $GRUnit;?>">
            <input type="hidden" id="STLeftQty2" name="STLeftQty2">
            <?php ActiveForm::end(); ?>
        </div>
    </div>
</div>
...
$(document).ready(function () {
        var GRUnit = $('#GRUnit').val();
        var packgrqty = parseFloat($("#vwst2gr2detailgroup-grpackqty").val().replace(/[,]/g, ""));
        var itemgrqty = parseFloat($("#vwst2gr2detailgroup-gritemqty").val().replace(/[,]/g, ""));
        var STSentQty = parseFloat($("#STSentQty").val().replace(/[,]/g, ""));
        if(packgrqty != 0){
            $('#GRPackUnit').val(GRUnit);
            // var sumGR = packgrqty-STSentQty;
            // $('#STLeftQty').val(addCommas(sumGR.toFixed(2)));
            var sumGR = itemgrqty-STSentQty;
            $('#STLeftQty').val(addCommas(sumGR.toFixed(2)));
        }else{
            var sumGR = itemgrqty-STSentQty;
            $('#STLeftQty').val(addCommas(sumGR.toFixed(2)));
    ...
    $("#vwst2detailsub-stpackqty").keyup(function () {
       $('#vwst2detailsub-stpackqty').autoNumeric('init');
        ...
        var STLeftQty = parseFloat($("#STLeftQty").val().replace(/[,]/g, ""));
        var jj = uni * orq;
        ...
        var resultLeft = STLeftQty-unitlot;
        $('#STLeftQty2').val(resultLeft);
        if(checkpacklot == 'edit'){
            if (unitlot>checklot){
               swal("ใส่เกินจำนวนที่มีอยู่ในสต็อก","","warning");
                ...
                $('#STLeftQty2').val(STLeftQty);
            }
            if(unitlot>STLeftQty){
                swal("ใส่เกินจำนวนที่ยืม","","warning");
                $('#vwst2detailsub-stpackqty').val('0.00');
                $('#vwst2detailsub-stitemqty').val('0.00');
                $('#vwst2detailsub-stextenedcost').val('0.00');
                $('#STLeftQty2').val(STLeftQty);
