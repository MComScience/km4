...
//                                                },
                                ...
                                <div style="text-align: right;margin-right: 10px">
                                    ...
                                    <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Save Draft', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-success']) ?>
  ...
  $(document).ajaxStart(function(){
    ...
    $('#_clear').click(function (e) {
          $.ajax({
            url: 'index.php?r=Inventory/stock-issue/_clear',
            type: 'POST',
   ...
   $('#_stock_issu').click(function (e) {
    ...
    if (result) {
          $.ajax({
            url: 'index.php?r=Inventory/stock-issue/cmd-st2-stk-issu',
            type: 'POST',
            data:$("#form_st_main").serialize(),
            success: function (data) {
               window.location.replace("index.php?r=Inventory/stock-issue");
...
function init_click_handlers() {
      ...
      var stkid = $('#tbst2temp-stissue_stkid').val();
       ...
       // var stkid = $('#tbst2temp-stissue_stkid').val();
          var  srid = $('#srid').val();
        $.get(
                'index.php?r=Inventory/stock-issue/select-lot',
                {
                    id: fID,
                stkid:stkid,
                    srid:srid
    ...
    $('.activity-update-link').click(function (e) {
     ...
     if(stkid!==""){                         
        $.ajax({
                url: 'index.php?r=Inventory/stock-issue/edit-detail',
