...
$(document).ready(function () {
        $('.submenu').css("style":"display: none");
...
$btnprint = '<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="index.php?r=Inventory/dashboard-sub/export-pdf&type=1" target="_blank" data-pjax="0"><i class="text-danger fa fa-file-pdf-o"></i> PDF</a>
        </li>
        <li>
            <a href="index.php?r=Inventory/dashboard-sub/export-excel&type=1" target="_blank" data-pjax="0"><i class="text-success fa fa-file-excel-o"></i> Excel</a>
        </li>
    </ul>
</div>';
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane in active">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <?php Pjax::begin(); ?> 
                            <!-- <?php echo $this->render('_search-datatable',['model'=>$searchModel]);?> -->
                            <?=
                            fedemotta\datatables\DataTables::widget([
                                ...
                                'clientOptions' => [
                                    ...
                                    'language' => [
                                        ...
                                        // 'search' => '_INPUT_'.' '.$this->render('_search-datatable'),
                                        // 'search' => '_INPUT_'.' '.$searchModel,
                                    ],
