...
<div class="vw-stk-balance-item-id-index">
    ...
    <div class="vwsr2listdraf-index">
        <?php  echo $this->render('_tab', ['model' => $searchModel, 'action' => 'list-drug']); ?>  
        <div class="well">

            <?php  $this->render('_search', ['model' => $searchModel, 'action' => 'list-drug']); ?>   
