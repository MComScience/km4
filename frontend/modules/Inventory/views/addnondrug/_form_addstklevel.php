...
<div class="well">
    <div class="tb-stk_levelinfo-form">
        ...
        <div class="form-group">
            <?= Html::activeLabel($modelstk, 'ItemReorderLevel', ['label' => 'จุดสั่งซื้อสินค้า', 'class' => 'col-sm-3 control-label no-padding-right']) ?>
            <div class="col-sm-4">
                <?=
        ...
        <div class="form-group">
            <?= Html::activeLabel($modelstk, 'ItemTargetLevel', ['label' => 'เป้าหมายการจัดเก็บ', 'class' => 'col-sm-3 control-label no-padding-right']) ?>
            <div class="col-sm-4">
                <?=
