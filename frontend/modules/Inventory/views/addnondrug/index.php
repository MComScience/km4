...
<div class="clearfix"></div>
HTML;
$this->registerJs('$("#nonedrug_tab").addClass("active");');
$this->title = 'เวชภัณฑ์';
                        ...
                        fedemotta\datatables\DataTables::widget([
                            ...
                            'clientOptions' => [
                                ...
                                'language' => [
                                    ...
                                    'search' => '_INPUT_ <a class="btn btn-success" href="create-itemnew"><i class="glyphicon glyphicon-plus"></i> เพิ่มรายการสินค้า</a>'
                                ],
