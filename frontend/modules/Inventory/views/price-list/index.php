    ...
    <div class="tab-content">
        <div id="tab" class="tab-pane in active ">
            <div class="vw-qu-pricelist-index">
                <?php Pjax::begin([ 'timeout' => 6000,'id' => 'price_list']) ?>
                            ...
                            'buttons' => [
                                ...
                                'view' => function ($url, $model, $key) {
                                    ...
                                    'print'=> function ($url, $model, $key) {
                                        return Html::a('<span class="btn btn-info btn-xs">Print</span>', Url::to(['export-pdf','id' => $model['ids_qu']]), [
                                                'title' => 'Print',
                                                'data-pjax' => '0',
                                                'target' => '_blank',
                                        ]);
...
function init_click_handlers() {
                    ...
                    url: 'active',
                            ...
                            $('#price_list').waitMe('hide'); 
                                if (data == 'updatesuccess') {
                                    ...
                                    $.pjax.reload({container: '#price_list'}); 
                                }
                            }
            });
        });
    ...
    $('#price_list').on('pjax:success', function () {
