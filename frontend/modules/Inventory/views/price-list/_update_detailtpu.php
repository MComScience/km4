...
$form = ActiveForm::begin([
    'type' => ActiveForm::TYPE_HORIZONTAL, 'id' => 'formpricelisttpu',
    ...
    <div class="row">
        <div class="col-xs-6">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right" style="padding-top: 0px !important;">ใบสำคัญการขึ้นทะเบียนตำรับยา<a id="checkไฟล์แนบ"></a></label>
                <div class="col-sm-8">
...
<!--                  <button class="btn btn-danger btn-xs" >Delete</button>
            ...
            <div class="form-group">
               <label class="col-sm-4 control-label no-padding-right">เอกสารกำกับยา<a id="checkไฟล์แนบ"></a></label>
                <div class="col-sm-8">
...
<!--                  <button class="btn btn-danger btn-xs" >Delete</button>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right" style="padding-top: 0px !important;">หนังสือรับรองมาตรฐานการผลิต<a id="checkไฟล์แนบ"></a></label>
                <div class="col-sm-8">
...
<!--                  <button class="btn btn-danger btn-xs" >Delete</button>
            ...
            <div class="form-group">
                 <label class="col-sm-4 control-label no-padding-right" style="padding-top: 0px !important;">ใบรายงานผลตรวจวิเคราะห์คุณภาพ<a id="checkไฟล์แนบ"></a></label>
                <div class="col-sm-8">
