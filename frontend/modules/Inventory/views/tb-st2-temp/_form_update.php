                        ...
                        <div class="form-group">
                            ...
                            kartik\grid\GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                    'header' => '<a>Actions</a>',
                                    'headerOptions' => ['style' => 'text-align:center;background-color: #F0FFF0;'],
                                    'width' => '90px',
                                    'attribute' => 'STQty',
                                    'format' => ['decimal', 2],
                                    ...
                                    'noWrap' => true,
                                    'options' => ['style' => 'background-color:#F0FFF0;'],
                                    'hAlign' => GridView::ALIGN_CENTER,
                                    'headerOptions' => ['hidden'=>true],
                                    'template' => ' {view}',
                                    ...
                                    'groupHeader' => function ($model, $key, $index, $widget) { // Closure method
                                        ...
                                        return [
                                            ...
                                            'contentOptions' => [// content html attributes for each summary cell
                                                ...
                                                8 => ['style' => 'text-align:center;background-color: #F0FFF0']
                                            ],
...
$('#print_tran').click(function (e) {      
     window.open("index.php?r=Report/report-inventory/stocktranfer&STID="+$('#stid').val(),'_blank');     
 });                 
     ...
     swal({
        ...
        function (isConfirm) {
          ...
          $.ajax({
            ...
            data:$("#form_st_main").serialize(),
            success: function (data) { 
             setTimeout("location.href = 'index.php?r=Inventory/tb-st2-temp';", 10);
            }
...
<script>
    ...
    function (isConfirm) {
        if (isConfirm) {           
            $.post(
                    'index.php?r=Inventory/stock-request/autolot',
                    {
                        SRID: SRID , STID:STID , userid:userid
                    },
            function (data)
            {    
                $.pjax.reload({container: '#sr2_detail_'});
