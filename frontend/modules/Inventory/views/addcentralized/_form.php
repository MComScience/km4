        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        $form->field($model, 'ItemNDMedSupplyCatID', ['showLabels' => false])->widget(Select2::classname(), [
                            'data' => yii\helpers\ArrayHelper::map(\app\models\TbItemndmedsupply::find()->where(['ItemNDMedSupplyCatID_sub' => 6])->all(), 'ItemNDMedSupplyCatID', 'ItemNDMedSupply'),
                            'pluginOptions' => [
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <div id="webcam2"></div>
                        <p><img id="image2" src="<?php echo !empty($model->ItemPic3) ? Yii::getAlias('@web') . '/' . $model->ItemPic3 : ''; ?>" /></p>
