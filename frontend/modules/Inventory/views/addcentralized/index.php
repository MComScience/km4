...
<div class="clearfix"></div>
HTML;
$this->registerJs('$("#centralized_tab").addClass("active");');
$this->title = 'จ่ายกลาง';
                ...
                <div id="home" class="tab-pane in active">
                    <div class="tb-item-index">
                        <?php if ($balancecount == 0) { ?>
                            ...
                            </div> <a class="btn btn-success" href="createheaderipdopd"><i class="glyphicon glyphicon-plus"></i> เพิ่มรายการสินค้า</a>
                        <?php } ?>
                        ...
                        fedemotta\datatables\DataTables::widget([
                            ...
                            'clientOptions' => [
                                ...
                                'language' => [
                                    ...
                                    'search' => '_INPUT_ <a class="btn btn-success" href="createheaderipdopd"><i class="glyphicon glyphicon-plus"></i> เพิ่มรายการสินค้า</a>'
                                ],
