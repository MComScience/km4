...
<div class="clearfix"></div>
HTML;
$this->registerJs('$("#supplies_tab").addClass("active");');
$this->title = 'พัสดุ';
...
<div class="row">
                ...
                <div id="home" class="tab-pane in active">
                    <div class="tb-item-index">
                        <?php if ($balancecount == 0) { ?>
                            <div class="col-md-3">
                                <input type="text" class="form-control input-sm" size="40" style="background-color: white" placeholder="ค้นหาข้อมูล...">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="officematerial"><i class="fa fa-edit"></i> สำนักงาน</a></li>
                                    <li><a href="homekitchensupplies"><i class="fa fa-edit"></i> งานบ้านงานครัว</a></li>
                                </ul>
                            </div>
                        <?php } ?>
    ...
    <ul class="dropdown-menu">
      <li><a href="officematerial"><i class="fa fa-edit"></i> สำนักงาน</a></li>
      <li><a href="homekitchensupplies"><i class="fa fa-edit"></i> งานบ้านงานครัว</a></li>
      <li><a href="comsupplies"><i class="fa fa-edit"></i> วัสดุคอมพิวเตอร์</a></li>
    </ul>
  </div>'
                                ],
