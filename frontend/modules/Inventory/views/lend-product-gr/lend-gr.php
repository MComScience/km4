...
$this->title = "ร่างใบรับสินค้าให้ยืม";
        ...
        <div class="tab-content">
            <div id="tab" class="tab-pane in active ">
                <div class="tb-gr2-temp-index">
                    <?php Pjax::begin(['id'=>'lend_product_temp','timeout' => 5000]) ?>
                    <?php echo $this->render('_search_lend_temp', ['model' => $searchModel]); ?>
