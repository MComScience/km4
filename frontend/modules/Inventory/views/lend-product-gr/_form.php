           ...
           <ul class="nav nav-tabs" id="myTab">
                <li class="tab-success active">
                    <a data-toggle="tab" href="#home">
                        <?= Html::encode('บันทึกใบรับสินค้าให้ยืม') ?>
                    </a>
                </li>
            </ul> 
                           ...
                           <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-4">
                                    ...
                                    ])->label('รหัสผู้ยืม', ['class' => 'col-sm-4 control-label no-padding-right'])
                                    ?>
                                    <?=
                                    $form->field($modelGR, 'datavender')->textInput([
                                        ...
                                        'value'=> $vendername,
                                        'readonly'=>true,
                                        ])->label('ชื่อผู้ยืม', ['class' => 'col-sm-4 control-label no-padding-right'])
                                    ?>
                                     <?=
...
<!-------------------------------START Detail GR Donate IF Create and Edit---------------------------------->
                            <?php if (empty($view)) { ?>
                                <div class="form-group">
                                    <?php \yii\widgets\Pjax::begin([ 'id' => 'gr_lend_detail']) ?>
                                    <?=
...
function init_click_handlers() {
    ...
    $('.activity-delete-link').click(function (e) {
        ...
        bootbox.confirm('Are you sure?', function (result) {
            if (result) {
                ...
                function (data)
                {
                   $.pjax.reload({container: '#gr_lend_detail'});
                }
                );
            }
        });
    ...
    $('#gr_lend_detail').on('pjax:success', function () {
