...
<div class="vw-sa-list-index">
    <div class="vwsr2listdraf-index">
        ...
        <div class="well">
            ...
            <?php echo $this->render('_search', ['model' => $searchModel,'action'=>'history']); ?>   
            <?=
            GridView::widget([
                    ...
                    [
                        ...
                        'buttons' => [
                            'view' => function ($url, $model, $key) {
                                return Html::a('<span class="btn btn-success btn-xs"> Detail </span>', $url . '&appvo=3', [
                                            'title' => 'Edit',
                                ]);
                            },
                                    'update' => function ($url, $model, $key) {
                                return Html::a('<span class="btn btn-info btn-xs"> Edit </span>', $url . '&appvo=3', [
                                            'title' => 'Edit',
                                ]);
                            },
