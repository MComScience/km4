        ...
        <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                 ...
                 <div class="form-group">
                  <label class="col-md-2 col-lg-2 control-label no-padding-right">
                  ...
                  <div class="col-md-3 col-lg-3">
                       <input type="text" class="form-control" style="background-color: white;text-align:right" readonly="" name="PackNote" id="PackNote" value=""/>
                    </div>
                  <!-- <label class="col-md-1 col-lg-1 control-label no-padding-right">ราคาแพค<a id="checkราคาต่อแพค"></a></label> -->
                </div>
                <div class="form-group">
               		<label class="col-md-2 col-lg-2 control-label no-padding-right">
	                    <div class="radio" style="margin-top:-8px;">
                 	...
                 	<div class="col-md-3 col-lg-3">
                 		<?=
                            $form->field($modelST, 'STItemQty', ['showLabels' => false])->textInput([
                                'value' => $STItemQty !='0' ? number_format($STItemQty, 2) : '1.00',//!empty($STItemQty)
                                'style' => 'background-color: white;text-align:right',
                            ])
                        ?>
                 	</div>
                 	<div class="col-md-3 col-lg-3" style="margin-top:8px;">
                   	...
                   	<!-- <label class="col-md-offset-1 col-lg-offset-1 col-md-2 col-lg-2 control-label no-padding-right">ราคาต่อหน่วย<a id="checkราคาต่อหน่วย"></a></label> -->
               	...
               	<div class="form-group">
                    ...
                    <?=
                        $form->field($modelST, 'STPackUnitCost', ['showLabels' => false])->hiddenInput([
                  ...
                  <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                    <?=
                        $form->field($modelST, 'STItemUnitCost', ['showLabels' => false])->hiddenInput([
                    ...
                    ?>
               		...
               		<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
               			<?=
	                        $form->field($modelST, 'ItemPackSKUQty', ['showLabels' => false])->hiddenInput([
                    ...
                    <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                        <?=
                            $form->field($modelST, 'STExtenedCost', ['showLabels' => false])->hiddenInput([
...
$(document).ready(function () {
    ...
    $('#vwst2detailsub-stpackunit').on('change', function () {
            ...
            var qty = parseFloat($("#vwst2detailsub-stpackqty").val().replace(/[,]/g, ""));
             $.ajax({
                url: "index.php?r=Inventory/daily-issue/get-qty",
                type: "post",
    ...
    function fn_check_btn_save(){
        var st_qty = parseFloat($("#vwst2detailsub-stitemqty").val().replace(/[,]/g, ""));
        if(st_qty>0){
