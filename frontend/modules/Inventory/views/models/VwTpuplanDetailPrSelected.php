...
/**
 * This is the model class for table "vw_tpuplan_detail_pr_selected".
 *
 ...
 */
class VwTpuplanDetailPrSelected extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'vw_tpuplan_detail_pr_selected';
    }
    ...
    {
        return [
            [['ids', 'TMTID_TPU', 'PCPlanTypeID', 'ItemPackID', 'PRCreateBy'], 'integer'],
            [['TPUUnitCost', 'TPUOrderQty'], 'required'],
            [['TPUUnitCost', 'PRApprovedOrderQty', 'PRTPUAvalible', 'PRQty', 'PRUnitCost', 'GPUStdCost','TPUOrderQty','PRPackQty'], 'safe'],
