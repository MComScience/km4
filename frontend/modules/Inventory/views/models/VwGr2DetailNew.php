...
/**
 * This is the model class for table "vw_gr2_detail_new".
 *
 ...
 */
class VwGr2DetailNew extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['POPackQtyApprove', 'POPackCostApprove', 'POApprovedUnitCost', 'POApprovedOrderQty', 'GRPackQty', 'GRPackUnitCost', 'GRItemQty', 'GRItemUnitCost', 'GRItemPackSKUQty', 'GRLeftItemQty', 'GRLeftPackQty', 'POQty', 'POUnitCost', 'GRReceivedQty', 'GRQty', 'GRUnitCost', 'GRExtenedCost', 'GRLeftQty'], 'safe'],
