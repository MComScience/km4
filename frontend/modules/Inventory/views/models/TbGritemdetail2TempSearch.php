...
/**
 * TbGritemdetail2TempSearch represents the model behind the search form about `app\modules\Inventory\models\TbGritemdetail2Temp`.
 */
class TbGritemdetail2TempSearch extends TbGritemdetail2Temp
{
    ...
    {
        $query = TbGritemdetail2Temp::find();
