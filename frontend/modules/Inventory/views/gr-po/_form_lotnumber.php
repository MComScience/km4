...
<!---------------------------------START FROM Goods Receiving---------------------------------------------->                          <div class="form-group">
                            ...
                            <div class="form-group" >
                                <label class="col-sm-2 control-label no-padding-right"><b>สั่งซื้อ:</b></label>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="form-group" style="margin-top:8px;">
                               <label class="col-sm-2 control-label no-padding-right"><b>รับครั้งนี้:</b></label>
                                <label class="col-sm-1 control-label no-padding-right">
                                    <div class="radio">
                                    <label>แพค  <input type="radio" name="แพค" id="แพค" value="yes"/><span class="text"></span></label>
                                    </div>
                            ...
                            <div class="form-group" style="margin-top:8px;">
                                ...
                                <label class="col-sm-1 control-label no-padding-right">
                                    ...
                                    <div class="radio">
                                    <label>จำนวน  <input type="radio" checked="checked" name="แพค" id="ชิ้น" value="no"/><span class="text"></span></label>
                                    </div>
                                </label>
                                <div class="col-sm-2">
                                    <?=
                                ...
                                <div class="col-sm-2">
                                 <input type="hidden" id="LeftItemQty" value="<?php echo number_format($GRLeftItemQty, 2) ?>">
                                 <input type="text" class="form-control" style="background-color: white;text-align:right" readonly="" name="has" id="has" />
                                </div>
                    ...
                    <div class="well">
                        <div class="tb-pr2-form">
                            ...
                            ?>
                             ...
                             <label class="col-sm-2 control-label no-padding-right"></label>
                                <div class="col-sm-3" style="display: none;">
                                   <label><input type="radio" name="แพค" id="แพคlot" value="no"/></label>
                                   <label><input type="radio" name="แพค" id="ชิ้นlot" value="no"/></label>
                                </div>
                            </div>
                             <div class="form-group" >
                            ...
                            <div class="form-group" style="text-align: right"><br>
                                <?= Html::a('Close', ['create','GRID' => $GRID,'POID'=>$POID,'view' => ''], ['class' => 'btn btn-default']) ?>
...
$(document).ready(function () {
     ...
     var receive = $('#vwgr2detail-gritemqty').val();
     var LeftItemQty = $('#LeftItemQty').val();
     var has = LeftItemQty-receive || 0;
     $('#has').val(addCommas(has.toFixed(2)));  
     console.log(receive);
     console.log(LeftItemQty);
     ...
     if (checkpackst == "" || checkpackst == "0.00") {
            var stitemqty = parseFloat($("#vwgr2detailnew-poqty").val().replace(/[,]/g, "")) || 0;
...
//------------------------------------START CALCUlATE FROM Goods Receiving----------------------------------
    ...
    $("#vwgr2detail-grpackqty").keyup(function () {
        ...
        if(result < 0){
                swal("รับครั้งนี้เกินจำนวนที่สั่งซื้อ?","","warning");
                //alert ('รับครั้งนี้เกินจำนวนค้างส่งของการเคลม?');
