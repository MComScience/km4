...
$this->title = "ร่างใบรับสินค้าจากการสั่งซื้อ";
        ...
        <div class="tab-content">
            <div id="tab" class="tab-pane in active ">
                <div class="tb-gr2-temp-index">
                    <?php Pjax::begin(['id'=>'gr_po_temp','timeout' => 5000]) ?>
                    <?php echo $this->render('_search_gr2_temp', ['model' => $searchModel]); ?>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'buttons' => [
                                    ...
                                    //Update
                                        if ($action === 'update') {
                                                return Url::to(['create-gr', 'GRID' => $model->GRID,'view' => '']);
                                        }
                                       if ($action === 'delete') {//Delete
                                            return Url::to(['delete-gr', 'id' => $model->GRID]);
                                        }
                                    }
                                ],
