...
<?= Html::encode('บันทึกใบรับสินค้า') ?>
                        ...
                        <!-----------------------------------------START Header GR-PO----------------------------------------> 
                            ...
                            <div class="tb-gr2-temp-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-4">
                                        <?=
                                        $form->field($modelST, 'PONum')->textInput([
                                            'maxlength' => true,
                                            'readonly' => true,
                                            'style' => 'background-color:white'
                                        ...
                                        ?>
                                        <?=
                                        $form->field($modelST, 'PODate')->widget(yii\jui\DatePicker::classname(), [
                                            'language' => 'th',
                                            'dateFormat' => 'dd/MM/yyyy',
                                            'clientOptions' => [
                                                'changeMonth' => true,
                                        ...
                                        ?>
                                        <?=
                                        $form->field($modelST, 'PODueDate')->widget(yii\jui\DatePicker::classname(), [
                                            'language' => 'th',
                                            'dateFormat' => 'dd/MM/yyyy',
                                            'clientOptions' => [
                                                'changeMonth' => true,
                                        ...
                                        ?>
                                        <?=
                                        $form->field($modelST, 'POType')->textInput([
                                            'maxlength' => true,
                                            'readonly' => true,
                                            'style' => 'background-color:white',
                                            'value' => $modelST->potype->POType,
                                        ])->label('ประเภทการสั่งซื้อ', ['class' => 'col-sm-4 control-label no-padding-right'])
                                        ?>
                                    </div>
                                    <div class="col-xs-6 col-sm-4">
                                        <?=
                                        $form->field($modelST, 'PRNum')->textInput([
                                            'maxlength' => true,
                                            'readonly' => true,
                                            'style' => 'background-color:white',
    ...
    <?= $form->field($modelST, 'POID', ['showLabels' => false])->hiddenInput() ?>
    ...
    <?= $form->field($modelGR, 'GRNum', ['showLabels' => false])->hiddenInput() ?>
                                ...
                                <!-------------------------------START Detail GR Donate IF Create and Edit---------------------------------->
                                    ...
                                    <div class="form-group">
                                        <?php \yii\widgets\Pjax::begin(['id' => 'gr_detail']) ?>
                                        <?=
...
//                                                },
                                ...
                                <br><br>
                                <div class="row">
                                    <h5 class="row-title before-success">รายละเอียดสินค้าบริจาค</h5>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                    </div>
                                </div>
                                    <?php if ($view == '') { ?>
...
function init_click_handlers() {
    $('.activity-select-link').click(function (e) {
        ...
        $.post(
                        'select-detail',
                        {
                            id: fID, POID:POID, venderinvoicenum:venderinvoicenum, GRDate:GRDate, StkID:StkID
                        },
                function (data)
                {
    ...
    $('.activity-delete-link').click(function (e) {
        ...
        bootbox.confirm('Are you sure?', function (result) {
            if (result) {
                ...
                function (data)
                {
                   $.pjax.reload({container: '#gr_detail'});
                }
                );
            }
        });
    ...
    $('#gr_detail').on('pjax:success', function () {
