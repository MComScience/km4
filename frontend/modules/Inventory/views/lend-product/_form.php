                    ...
                    <div class="well">
                        ...
                        <div class="tb-st2-temp-form">
                            ...
                            <label class="col-sm-2 control-label no-padding-right">กำหนดส่งสินค้าคืน<a id="checkDuedate"></a></label>
                                ...
                                <label class="col-sm-2 control-label no-padding-right">เลขที่ผู้ยืม<a id="checkVendername"></a></label>
                                <div class="col-sm-3">
                                    <?=
                                    $form->field($modelST, 'STPerson', ['showLabels' => false])->textInput([
                                        ...
                                        //'readonly' => true,
                                        'style' => 'background-color:#FFFF99',
                                        'placeholder' => 'คลิกเพื่อเลือกผู้ยืม...',
                                    ])
                                    ?>
                                </div>
                            </div>
                            <div class="form-group" >
                                ...
                                <label class="col-sm-2 control-label no-padding-right">ชื่อผู้ยืม</label>
                                <div class="col-sm-3">
                                    <?=
                            ...
                            <?= Html::activeLabel($modelST, 'STDueDate', ['class' => 'col-sm-2 control-label no-padding-right']) ?>
                                ...
                                <label class="col-sm-2 control-label no-padding-right">เลขที่ผู้ยืม</label>
                                <div class="col-sm-3">
                                    <?=
                                    $form->field($modelST, 'STPerson', ['showLabels' => false])->textInput([
                                        'maxlength' => true,
