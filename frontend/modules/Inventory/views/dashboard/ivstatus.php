...
$btnprint = '<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="index.php?r=Inventory/dashboard/export-pdf&type=1" target="_blank" data-pjax="0"><i class="text-danger fa fa-file-pdf-o"></i> PDF</a>
        </li>
        <li>
            <a href="index.php?r=Inventory/dashboard/export-excel&type=1" target="_blank" data-pjax="0"><i class="text-success fa fa-file-excel-o"></i> Excel</a>
        </li>
    </ul>
</div>';
