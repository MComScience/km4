...
<div class="clearfix"></div>
HTML;
$title = 'สถานะสินค้าคงคลังเวชภัณฑ์มิใช่ยา';
$pdfHeader = [
    'L' => [
        'content' => 'รายงาน',
        'font-size' => 8,
...
<div class="vw-stk-balance-item-id-index">
    ...
    <div class="vwsr2listdraf-index">
        <?php echo $this->render('_tabnew', ['model' => $searchModel]); ?>  
        <div class="well">

            <?php yii\widgets\Pjax::begin(['id' => 'grid-user-pjax', 'timeout' => 5000]) ?>
            <?php // echo $this->render('_search', ['model' => $searchModel, 'action' => 'list-nondrugnew']); ?>   
            <?php
            echo
            GridView::widget([
...
//                                     'mode' => 'c',
                            ...
                            GridView::EXCEL => [
                                ...
                                'showFooter' => true,
                                'showCaption' => true,
                                'filename' => 'ข้อมูลสินยอดคงคลังสินค้า',
                                'alertMsg' => false, //'The EXCEL export file will be generated for download.',
...
function init_click_handlers() {
    $('.activity-stockcard-link').click(function (e) {
       var stkid = $(this).closest('tr').children('td:eq(7)').text();
       var itemid = $(this).closest('tr').children('td:eq(2)').text();
              $.post(
                        'index.php?r=Inventory/dashboard/view-stockcard',
                        {
