...
?>
<?php
$this->title = 'ใบขอเบิกสินค้า';
$this->params['breadcrumbs'][] = ['label' => 'เบิก โอน จ่าย', 'url' => ['wait-approve']];
...
<!--                            <a href="index.php?r=Inventory/stock-request/wait-approve" class="btn btn-default">Close</a>-->
                        <?php } else if ($type == 'waitsale') { ?>
                            <?= Html::a('Close',['wait-receive'],['class' => 'btn btn-default']); ?>
<!--                            <a href="index.php?r=Inventory/stock-request/wait-sale" class="btn btn-default">Close</a>-->
                        <?php } else if ($type == 'waitreceive') { ?>
                            <?= Html::a('Close',['history'],['class' => 'btn btn-default']); ?>
<!--                            <a href="index.php?r=Inventory/stock-request/wait-receive" class="btn btn-default">Close</a>-->
                        <?php } else { ?>
                            <?= Html::a('Close',['wait-sale'],['class' => 'btn btn-default']); ?>
<!--                            <a href="index.php?r=Inventory/stock-request/history" class="btn btn-default">Close</a>-->
                        <?php } ?>
                    </div>
                </div>
