...
$this->params['breadcrumbs'][] = ['label' => 'เบิก โอน จ่าย', 'url' => ['approve-sr']];
...
<h5 class="row-title before-success">รายละเอียด</h5>
        ...
        <div id="wait" style="display:none;width:69px;height:89px;border:1px solid black;position:absolute;top:50%;left:50%;padding:2px;"><img src='/images/712.gif' width="64" height="64" /><br>Loading..</div>
            <div>
                <a class="btn btn-success ladda-button" data-style ='expand-left' id="addtpu" href="javascript:void(0)"><i class="glyphicon glyphicon-plus"> รายการยา</i></a> 
                <a class="btn btn-success ladda-button" data-style ='expand-left' id="addnd" href="javascript:void(0)"><i class="glyphicon glyphicon-plus"> รายการเวชภัณฑ์</i></a>
                    <br><br>
                    ...
                    <div class="form-group">
                        ...
                        kartik\grid\GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                'header' => '<a>คงคลังผู้ขอ</a>',
                                'headerOptions' => ['style' => 'text-align:center;'],
                                'attribute' => 'req_balance_qty',
                                'width' => '90px',
                                'format' => ['decimal', 2],
                                'hAlign' => GridView::ALIGN_RIGHT,
                                'value' => function ($model) {
                                    if ($model->sr2detail['req_balance_qty'] == NULL) {
                                            return '0.00';
                                        }else{
                                            return $model->sr2detail->req_balance_qty;
                                        }
                                    }
                                ],
                                [
                                'header' => '<a>ขอเบิก</a>',
                                'width' => '90px',
                                'headerOptions' => ['style' => 'text-align:center;','colspan'=>'2'],
                                'attribute' => 'SRPackQty',
                                'format' => ['decimal', 2],
                                'hAlign' => GridView::ALIGN_RIGHT,
                                'value' => function ($model) {
                                ...
                                [
                                'header' => '<a>คงคลังผู้เบิก</a>',
                                'width' => '90px',
                                'headerOptions' => ['style' => 'text-align:center;background-color:rgb(217, 237, 247);'],
                                ...
                                'hAlign' => GridView::ALIGN_RIGHT,
                                'value' => function ($model) {
                                        if ($model->sr2detail['stk_avalible_qty'] == NULL) {
                                             return '0.00';
                                        } else {
                                            return $model->sr2detail->stk_avalible_qty;
                                        }
                                    }
                                ],
                                [
                                ...
                                'buttonOptions' => ['class' => 'btn btn-default'],
                                    'buttons' => [
                                        'view' => function ($url, $model, $key) {
                                            if ($model->sr2detail->SRApproveQty == ''|| $model->sr2detail->SRApproveQty=='0') {
                                                $status = '';
                                            } else {
                                                $status = 'disabled';
                                            }
                                ...
                                'groupHeader' => function ($model, $key, $index, $widget) { // Closure method
                                    if($model->sr2detail->SRApproveQty=='0'||$model->sr2detail->SRApproveQty==''){
                                        $name_btn = 'OK all';
                                        ...
                                        $name_btn = 'Cancel all';
                                        $class_btn = 'btn btn-xs btn-warning';
                                        $title_btn = 'Cancel';
                                        $id = 'cancel';
                                    }
                                return [
                                        ...
                                        'content' => [// content to show in each summary cell
                                            ...
                                            6 => '',
                                            7 => '<font color="black">จำนวน</font>',
                                            8 => '<font color="black">หน่วย</font>',
                                            9 =>  Html::a($name_btn, 'javascript:void(0)', [
                                                'class' => $class_btn,
                                                'title' => $title_btn,
                                                'id' => $id,
                                                'onclick' => 'okall(id)',
                                        ...
                                        'contentOptions' => [// content html attributes for each summary cell
                                            ...
                                            3 => ['style' => 'color:green;text-align:center;background-color:#dff0d8 '],
                                            4 => ['style' => 'color:green;text-align:center;background-color:#dff0d8 '],
                                            5 => ['style' => 'color:green;text-align:center;background-color:#dff0d8 '],
                                            6 => ['style' => 'color:green;text-align:center;background-color:rgb(217, 237, 247);'],
                                            7 => ['style' => 'text-align:center;background-color:rgb(217, 237, 247);'],
                                            8 => ['style' => 'text-align:center;background-color:rgb(217, 237, 247);'],
                ...
                <div style="text-align: right;margin-right: 10px">
                    <a href="/km4/Inventory/stock-request/approve-sr" class="btn btn-default">Close</a>
...
$s = <<< JS
    ...
    $('#addtpu').click(function (e) {
       ...
       run_waitMe(2);
          $.ajax({
            url: '/km4/Inventory/stock-request/gettpu2',
            type: 'POST',
    ...
    $('#addnd').click(function (e) {
         ...
         var SRID = $('#srid_').val();
                 run_waitMe(2);
          $.ajax({
            url: '/km4/Inventory/stock-request/getnd2',
            type: 'POST',
            data:{stkid:tbsr2srissuestkid,receivestkid:tbsr2srreceivestkid,SRID:SRID},
            dataType: 'json',
            success: function (data) {
    ...
    $('#save_reject').click(function (e){
       ...
       var SRRejectNote = $('#reject_detail').val();
        run_waitMe(2);
        $.ajax({
            url: '/km4/Inventory/stock-request/rejecct',
            data:{id:srid,SRRejectNote:SRRejectNote},
            type: 'GET',
            success: function (data) {
                if(data =='1'){
                 swal("", "Reject Successfully!", "success");
                 setTimeout("location.href = '/km4/Inventory/stock-request/approve-sr';",10);  
   }
        }
      });  
    ...
    $('#approve').click(function (e){
        ...
        var srid = $('#srid_').val();
         run_waitMe(2);
        $.ajax({
            url: '/km4/Inventory/stock-request/sr2_approve',
            data:{id:srid},
            type: 'GET',
            success: function (data) {
                 setTimeout("location.href = '/km4/Inventory/stock-request/approve-sr';",10);   
...
function init_click_handlers() {
    ...
    swal({
        ...
        function (isConfirm) {
         ...
         run_waitMe(2);
        $.get(
                '/km4/Inventory/stock-request/cmd_sr2_approve_ok',
                {
                    id: fID
                },
        function (data)
    ...
    $('.activity-update-link').click(function (e) {
        var fID = $(this).closest('tr').data('key');
         run_waitMe(2);
               $.ajax({
                    url: '/km4/Inventory/stock-request/detailedit',
            data:{id:fID},
            type: 'GET',
            success: function (data) {
      ...
      swal({
        ...
        function (isConfirm) {
            if (isConfirm) {
                run_waitMe(2);            
                $.post(
                        '/km4/Inventory/stock-request/delete-detail',
                        {
                            id: fID
                        },
                function (data)
...
<script>
    ...
    function (isConfirm) {
        if (isConfirm) {           
            $.post(
                    '/km4/Inventory/stock-request/okall',
                    {
                        SRID: SRID
                    },
            function (data)
    ...
    function SelectGPU(id, type, balance) {
        ...
        var SRID = $("#srid_").val();
        $.ajax({
            url: '/km4/Inventory/stock-request/detailselect2',
            type: 'POST',
