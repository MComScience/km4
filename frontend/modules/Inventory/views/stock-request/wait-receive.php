...
<div class="tbsr2-index">
    <div class="vwsr2listdraf-index">
        ...
        <div class="well">
            ...
            <?php echo $this->render('_search', ['model' => $searchModel, 'type' => 'wait-receive']); ?>
                    ...
                    [
                        ...
                        'buttons' => [
                            'update' => function ($url, $model, $key) {
                                ...
                                return Html::a('<span class="btn btn-success btn-xs"> Detail </span>', $url . '&type=waitreceive', [
                                            'title' => 'Detail',
                                            'data-pjax' => 0
                                ]);
                            },
