...
<div class="well">
    <div class="tb-itempack-form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <textarea class="form-control" rows="3" readonly="" style="background-color: white" id="tbitempack-itemname"><?php echo $itemname ?></textarea>
            </div>
        </div>
        <br>
        <div class="form-group">
        ...
        <div class="form-group">
            <?= Html::activeLabel($modelitempack, 'ItemPackUnit', ['label' => 'หน่วยแพค' . '<font color="red"> *</font>', 'class' => 'col-sm-3 control-label no-padding-right']) ?>
            <div class="col-sm-4">
                <?=
...
$check = $checked ? ' checked="checked"' : '';
        ...
        <div class="form-group">
            <?= Html::activeLabel($modelitempack, 'ItemPackBarcode', ['label' => 'แพค Barcode' . '<font color="red"> *</font>', 'class' => 'col-sm-3 control-label no-padding-right']) ?>
            <div class="col-sm-7">
                <?=
        ...
        <div class="form-group">
            <?= Html::activeLabel($modelitempack, 'ItemPackNote', ['label' => 'หมายเหตุ' . '<font color="red"> *</font>', 'class' => 'col-sm-3 control-label no-padding-right']) ?>
            <div class="col-sm-7">
                <?=
