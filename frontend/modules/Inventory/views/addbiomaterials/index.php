...
<div class="clearfix"></div>
HTML;
$this->registerJs('$("#biomaterials_tab").addClass("active");');
$this->title = 'วัสดุทางการแพทย์';
                        ...
                        <?php if ($balancecount == 0) { ?>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="ipdopd"><i class="fa fa-edit"></i> IPD/OPD</a></li>
                                    <li><a href="ic"><i class="fa fa-edit"></i> IC</a></li>
                                    <li><a href="or"><i class="fa fa-edit"></i> OR</a></li>
                                </ul>
                            </div>
                        <?php } ?>
                      ...
                      <ul class="dropdown-menu">
                          ...
                          <li><a href="or"><i class="fa fa-edit"></i> OR</a></li>
                            ...
                            'columns' => [
                                    ...
                                    'headerOptions' => ['style' => 'text-align:center;color:black;width:30%;background-color: #DFF0D8',],
                                    'header' => 'Actions',
                                    'contentOptions' => ['class' => 'text-center'],
