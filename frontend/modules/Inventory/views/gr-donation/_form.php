            ...
            <ul class="nav nav-tabs" id="myTab">
                <li class="tab-success active">
                    <a data-toggle="tab" href="#home">
                        <?php if (empty($view)) { ?>  
                            <?= Html::encode('บันทึกใบรับสินค้า') ?>
                        <?php } ?>
                        <?php if ($view == 'view') { ?>  
    <?= Html::encode('ประวัติใบรับสินค้า') ?>
<?php } ?>
                    </a>
                </li>
            </ul> 
                        ...
                        <!--------------------------------------------START Header GR Donate-------------------------------->   
                            ...
                            <div class="tb-gr2-temp-form">
                                ...
                                <div class="form-group" >
                                    ...
                                    <label class="col-sm-2 control-label no-padding-right">รหัส<a id="checkVenderID"></a></label>
                                    <div class="col-sm-3">
                                        <?=
                                        $form->field($modelGR, 'VenderID', ['showLabels' => false])->textInput([
                                            'maxlength' => true,
                                            //'readonly' => true,
                                            'style' => 'background-color:#FFFF99',
                                            'placeholder' => 'คลิกเพื่อเลือกรหัส...',
                                        ])
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group" >
                                    ...
                                    <label class="col-sm-2 control-label no-padding-right">ชื่อ</label>
                                    <div class="col-sm-3">
                                        <?=
                                        $form->field($modelGR, 'datavender', ['showLabels' => false])->textInput([
                                            'maxlength' => true,
                                            'style' => 'background-color:white',
                                            'value' => $vendername,
                                            'readonly' => true,
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-sm-3">
                                        <?=
                                        $form->field($modelGR, 'GRTypeID', ['showLabels' => false])->widget(\kartik\widgets\Select2::classname(), [
                                            'data' => yii\helpers\ArrayHelper::map(app\modules\Inventory\models\TbGrtype::find()->where(['GRTypeID' => [5, 7, 8]])->all(), 'GRTypeID', 'GRType'),
                                            'options' => ['placeholder' => 'เลือกประเภทการรับ...'],
                                            'pluginOptions' => [
                                                'allowClear' => true,
                                            ],
                                        ])
                                    ...
                                    <label class="col-sm-2 control-label no-padding-right">หมายเลขใบส่งสินค้า<a id="checkInvoiceNum"></a></label>
                                    <div class="col-sm-3">
                                        <?=
                                        $form->field($modelGR, 'VenderInvoiceNum', ['showLabels' => false])->textInput([
                                            'maxlength' => true,
                                            //'readonly' => true,
                                            'style' => 'background-color:#FFFF99'
                                        ])
                                ...
                                <div class="form-group" >
                                    ...
                                    <label class="col-sm-2 control-label no-padding-right">รับเข้าคลัง<a id="checkInvoiceNum"></a></label>
                                    <div class="col-sm-3">
                                        <?=
    ...
    <?= $form->field($modelGR, 'GRNum', ['showLabels' => false])->hiddenInput() ?>
                                <br>
                                <!-----------------------------------------END Header GR Donate----------------------------------------->
                                <!------------------------------------------START Detail GR Donate-------------------------------------->
                                <div class="row">
                                ...
                                <div class="tb-gr2-temp-form">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label class="col-sm-2 control-label no-padding-right">รับเข้าคลัง</a></label>
                                        <div class="col-sm-3">
                                            <?=
    ...
    <?= $form->field($modelGR, 'GRNum', ['showLabels' => false])->hiddenInput() ?>
                                    ...
                                    <?php if (empty($view)) { ?>
                                    <div class="form-group">
                                        <?php \yii\widgets\Pjax::begin([ 'id' => 'gr_donate_detail']) ?>
                                        <?=
                                                            ...
                                                            'groupHeader' => function ($model, $key, $index, $widget) { // Closure method
                                                                return [
                                                                    ...
                                                                    'contentOptions' => [// content html attributes for each summary cell
                                                                        ...
                                                                        1 => ['style' => 'background-color: #ddd;color:#000000;'],
...
$(document).ready(function () {
	 $('#checkVenderID,#checkInvoiceNum').html('<font color="red">*</font>');
...
$('#getvwitemlisttpu').click(function (e) {
                ...
                var VenderID = $("#tbgr2temp-venderid").val();
                var venderinvoicenum = $("#tbgr2temp-venderinvoicenum").val();
                var StkID = $('#tbgr2temp-stkid').val();
                var GRTypeID = $('#tbgr2temp-grtypeid').val();
                var GRDate = $('#tbgr2temp-grdate').val();
                //wait();
                if(VenderID==''){
		            swal('','กรุณาเลือกเลขที่ผู้เสียภาษี','warning');
		        }else if(venderinvoicenum==''){
		            swal('','กรุณากำหนดหมายเลขใบส่งสินค้า','warning');
		        }else if(StkID==''){
		            swal('','กรุณาเลือกคลังที่จะรับเข้า','warning');
		        }else{
		         	$.ajax({
		                    url: 'getdata-tpu',
		                    type: 'GET',
		                    data: {GRID:GRID,VenderID:VenderID,venderinvoicenum:venderinvoicenum,StkID:StkID,GRTypeID:GRTypeID,GRDate:GRDate},
		                    dataType: 'json',
		                    success: function (data) {
		                            $('#home').waitMe('hide');
		                            $('#getdatavendor').find('.modal-body').html(data);
