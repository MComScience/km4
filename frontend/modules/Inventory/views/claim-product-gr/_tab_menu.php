    ...
    <ul class="nav nav-tabs" id="myTab">
        <li class="tab-success" id="tab_A">
            <a data-toggle="tab" href="#tab">
                <?= Html::encode('ใบส่งสินค้าเคลม') ?> <span ><?php  echo '(' . $statusGRST . ')'; ?></span>
            </a>
        </li>

        <li class="tab-success" id="tab_B">
            <a data-toggle="tab" href="#tab">
                <?= Html::encode('ร่างใบรับสินค้าเคลม') ?> <span ><?php echo '(' . $statusGRTemp . ')'; ?></span>
            </a>
        </li>
        
        <li class="tab-success" id="tab_C">
            <a data-toggle="tab" href="#tab">
                <?= Html::encode('ประวัติใบรับสินค้าเคลม') ?> <span ><?php echo '(' . $statusGR . ')'; ?></span>
            </a>
        </li>
    </ul>
