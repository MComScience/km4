           ...
           <ul class="nav nav-tabs" id="myTab">
                <li class="tab-success active">
                    <a data-toggle="tab" href="#home">
                        <?= Html::encode('บันทึกใบรับสินค้าการขอยืม') ?>
                    </a>
                </li>
            </ul> 
                        ...
                        <div class="tb-gr2-temp-form">
                           <?php
                            ...
                            <div class="form-group" >
                                ...
                                <label class="col-sm-2 control-label no-padding-right">รหัสผู้ให้ยืม<a id="checkVenderID"></a></label>
                                <div class="col-sm-3">
                                    <?=
                                    $form->field($modelGR, 'VenderID', ['showLabels' => false])->textInput([
                                        ...
                                        'placeholder' => 'คลิกเพื่อเลือกผู้ให้ยืม...',
                                    ])
                                    ?>
                                </div>
                            </div>
                             ...
                             <div class="form-group" >
                                ...
                                <?= Html::activeLabel($modelGR, 'PODueDate', ['label' => 'กำหนดการส่งคืน' . '<font color="red"> *</font>','class' => 'col-sm-2 control-label no-padding-right']) ?>
                                <div class="col-sm-3">
                                    <?=
                                    $form->field($modelGR, 'PODueDate', ['showLabels' => false])->widget(yii\jui\DatePicker::classname(), [
                                        'language' => 'th',
                                        'dateFormat' => 'dd/MM/yyyy',
                                        'clientOptions' => [
                                            'changeMonth' => true,
                             ...
                             <div class="form-group" >
                                <label class="col-sm-2 control-label no-padding-right">รับเข้าคลัง<a id="checkstk"></a></label>
                                <div class="col-sm-3">
                                    <?=
                           ...
                           <?php
                            ...
                            <div class="form-group" >
                             ...
                             <div class="form-group" >
                                ...
                                <?= Html::activeLabel($modelGR, 'PODueDate', ['label' => 'กำหนดการส่งคืน','class' => 'col-sm-2 control-label no-padding-right']) ?>
                                <div class="col-sm-3">
                                    <?=
                                    $form->field($modelGR, 'PODueDate', ['showLabels' => false])->widget(yii\jui\DatePicker::classname(), [
                                        'language' => 'th',
...
$(document).ready(function () {
	 $('#checkVenderID,#checkInvoiceNum,#checkstk').html('<font color="red">*</font>');
...
$('#getvwitemlisttpu').click(function (e) {
                ...
                var PODueDate = $("#tbgr2temp-poduedate").val();
                wait();
                $.ajax({
                    url: 'getdata-tpu',
                    type: 'GET',
                    data: {GRID: GRID,VenderInvoiceNum:VenderInvoiceNum,VenderID:VenderID,PODueDate:PODueDate},
                    dataType: 'json',
                    success: function (data) {
                            $('#home').waitMe('hide')
                            $('#getdatavendor').find('.modal-body').html(data);
