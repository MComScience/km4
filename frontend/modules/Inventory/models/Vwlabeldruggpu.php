...
/**
 * This is the model class for table "vw_label_druggpu".
 *
 ...
 */
class Vwlabeldruggpu extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['DrugLabel', 'Druglabel1', 'Druglabel2'], 'string', 'max' => 255],
        ];
    }
