...
/**
 * TbStkTransSearch represents the model behind the search form about `app\modules\Inventory\models\TbStkTrans`.
 */
class TbStkTransSearch extends TbStkTrans
{
    /**
     * @inheritdoc
     */
    ...
    public function searchstktran($StkID, $ItemID) {
        $query = TbStkTrans::find();
