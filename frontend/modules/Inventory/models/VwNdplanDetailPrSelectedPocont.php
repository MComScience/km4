...
/**
 * This is the model class for table "vw_ndplan_detail_pr_selected_pocont".
 *
 ...
 */
class VwNdplanDetailPrSelectedPocont extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'vw_ndplan_detail_pr_selected_pocont';
    }
    ...
    {
        return [
            [['PCPlanTypeID', 'ItemID','ItemPackID', 'PRCreateBy'], 'integer'],
            [['PCPlanNDUnitCost', 'PCPlanNDQty', 'PRApprovedQtySUM', 'PRNDAvalible', 'PRQty', 'PRUnitCost','PRPackQty'], 'safe'],
            [['DispUnit'], 'required'],
