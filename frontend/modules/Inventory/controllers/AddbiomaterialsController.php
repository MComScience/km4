...
class AddbiomaterialsController extends Controller {
    ...
    public function actionIndex() {
        ...
        $dataProvider = $searchModel->searchipdopd(Yii::$app->request->queryParams);
        $dataProvider->pagination->pageSize = 10;
        $CreatedBy = Yii::$app->user->identity->profile->user_id;
        $VwItemBalance = TbItem::find()->where('ItemID like "3%"')->count();
    ...
    function actionIpdopd() {
        return $this->redirect(['create-itemnew', 'type' => 3]);
    }

    function actionIc() {
        return $this->redirect(['create-itemnew', 'type' => 4]);
    }

    function actionOr() {
        return $this->redirect(['create-itemnew', 'type' => 5]);
    }
