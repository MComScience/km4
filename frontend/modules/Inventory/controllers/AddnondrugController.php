...
class AddnondrugController extends Controller {
    ...
    public function actionIndex() {
        ...
        $dataProvider = $searchModel->searchnondrug(Yii::$app->request->queryParams);
    ...
    public function actionCreateItemnew() {
        $posts = Yii::$app->db->createCommand("SELECT tb_item.ItemID FROM tb_item WHERE tb_item.ItemID LIKE '2%' ORDER BY tb_item.ItemID DESC LIMIT 1")->queryOne();
    ...
    public function actionAdditemprice() {
        if ($_GET['id'] != null) {
            $model = \app\modules\Inventory\models\TbItemIDPrice::findOne(['ItemID' => $_GET['id']]);
