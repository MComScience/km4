...
class StdController extends Controller {
    ...
    public function actionNewStd() {
        $searchModel = new VwStdTrpChemoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->post());

        return $this->render('newstd', [
                    'searchModel' => $searchModel,
                    'dataProvider' => $dataProvider,
        ]);
    }
    ...
    public function actionSaveChemodetail() {
        ...
        if ($request->isPost) {
            ...
            $std_trp_chemo_ids = !empty($post['VwStdTrpChemoDetail']['std_trp_chemo_ids']) ? $post['VwStdTrpChemoDetail']['std_trp_chemo_ids'] : NULL;
            ...
            $std_trp_comment = !empty($post['VwStdTrpChemoDetail']['std_trp_comment']) ? $post['VwStdTrpChemoDetail']['std_trp_comment'] : NULL;
            
            Yii::$app->db->createCommand('CALL cmd_std_orderset_draft('
                    . ':std_trp_chemo_ids,'
                    . ':chemo_cycle_seq,'
                    . ':chemo_cycle_day,'
                    ...
                    . ':drugset_ids,'
                    . ':std_trp_comment);')
                    ->bindParam(':std_trp_chemo_ids', $std_trp_chemo_ids)
