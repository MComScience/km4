...
use app\modules\chemos\models\TbStdTrpChemo;

/**
 * TbStdTrpChemoSearch represents the model behind the search form about `app\modules\chemos\models\TbStdTrpChemo`.
 */
class TbStdTrpChemoSearch extends TbStdTrpChemo
{
    ...
    public function rules()
    {
        return [
            ...
            [['std_trp_regimen_name', 'medical_right_id', 'std_trp_regimen_id', 'std_trp_credit_id', 'std_trp_regimen_paycode', 'std_trp_comment', 'std_trp_regimen_date', 'dx_code', 'ca_stage_code', 'regimen_for_cr', 'std_trp_for_op', 'std_trp_for_ip', 'drugset_type'], 'safe'],
        ];
    }
