 ...
 *
 * @property TbPtTrpChemoDetail $chemoRegimenIds
 */
class TbDrugsetDetail extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['chemo_regimen_ids'], 'exist', 'skipOnError' => true, 'targetClass' => TbPtTrpChemoDetail::className(), 'targetAttribute' => ['chemo_regimen_ids' => 'chemo_regimen_ids']],
        ];
    }
     ...
     */
    public function getChemoRegimenIds()
    {
        return $this->hasOne(TbPtTrpChemoDetail::className(), ['chemo_regimen_ids' => 'chemo_regimen_ids']);
    }
    
    public function getDrugset() {
        return $this->hasOne(TbDrugset::className(), ['drugset_id' => 'drugset_id']);
    }
}
