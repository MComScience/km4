...
use app\modules\chemo\models\VwCpoeRxDetail2;

/**
 * VwCpoeRxDetail2Search represents the model behind the search form about `app\modules\chemo\models\VwCpoeRxDetail2`.
 */
class VwCpoeRxDetail2Search extends VwCpoeRxDetail2
{
    ...
    public function search($params,$id)
    {
        $query = VwCpoeRxDetail2::find()
                ->where(['cpoe_id' => $id,'cpoe_Itemtype' => [21,22,50,53,54,10,20]]);
    ...
    public function search_premed($params,$id)
    {
        $query = VwCpoeRxDetail2::find()
                ->where(['cpoe_id' => $id,'cpoe_Itemtype' => 22]);
    ...
    public function search_iv($params,$id)
    {
        $query = VwCpoeRxDetail2::find()
                ->where(['cpoe_id' => $id,'cpoe_Itemtype' => [50,53]]);
    ...
    public function search_medicat($params,$id)
    {
        $query = VwCpoeRxDetail2::find()
                ->where(['cpoe_id' => $id,'cpoe_Itemtype' => [10,20,54]]);
