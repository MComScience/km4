...
class TbStdTrpChemo extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'std_trp_regimen_name' => 'Regimen Name',
            'medical_right_id' => 'สิทธิ์การรักษา',
    ...
    {
        return $this->hasOne(\app\modules\chemos\models\VwStdTrpChemo::className(), ['std_trp_chemo_id' => 'std_trp_chemo_id']);
    }
}
