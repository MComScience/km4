        ...
        <div class="well">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        <div class="btn-group btn-group-justified">
                            <a class="disabled btn btn-default btn-sm <?= $model['cpoe_rxordertype'] == '1' ? 'active' : null; ?>" id="orderoneday1"><?= Html::encode('Oder One Day'); ?></a>
                            <a class="disabled btn btn-default btn-sm <?= $model['cpoe_rxordertype'] == '2' ? 'active' : null; ?>" id="orderoneday2"><?= Html::encode('Order for continuation'); ?></a>
                        </div>
                    </div>
                </div>
            </div><!-- End Row -->
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        <div class="btn-group btn-group-justified">
                            <?= Html::a('7d', 'javascript:void(0);', ['class' => 'disabled btn btn-default btn-sm day', 'id' => '7d']) ?>
                            <?= Html::a('14d', 'javascript:void(0);', ['class' => 'disabled btn btn-default btn-sm day', 'id' => '14d']) ?>
                            <?= Html::a('21d', 'javascript:void(0);', ['class' => 'disabled btn btn-default btn-sm day', 'id' => '21d']) ?>
                            <?= Html::a('28d', 'javascript:void(0);', ['class' => 'disabled btn btn-default btn-sm day', 'id' => '28d']) ?>
                            <?= Html::a('60d', 'javascript:void(0);', ['class' => 'disabled btn btn-default btn-sm day', 'id' => '60d']) ?>
                            <?= Html::a('90d', 'javascript:void(0);', ['class' => 'disabled btn btn-default btn-sm day', 'id' => '90d']) ?>
                        </div>
                    </div>
                </div>
            </div><!-- End Row -->
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <?= $form->field($model, 'cpoe_period_value', ['showLabels' => false])->textInput(['style' => 'background-color: white', 'type' => 'number', 'value' => empty($model['cpoe_period_value']) ? '1' : $model['cpoe_period_value'], 'readonly' => true]) ?>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <?=
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        <div class="radio">
                            <label>
                                <input disabled="" type="radio" name="once" id="Onceradio" <?= !empty($model->cpoe_once) ? 'checked=""' : ''; ?> class="colored-success">
                                <span class="text"><?= Html::encode('Every day'); ?></span>
                            </label>
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <label>
                                <input disabled="" type="radio" name="once" id="Repeatradio" class="colored-success" <?= !empty($model->cpoe_repeat) ? 'checked=""' : ''; ?>>
...
<div class="row">
    <div class="form-group">
        <div class="col-xs-12 col-sm-6 col-md-8">
            ...
            <?= $form->field($model, 'cpoe_id', ['showLabels' => false])->hiddenInput(['value' => !empty($model['cpoe_id']) ? $model['cpoe_id'] : $cpoeid]) ?>
            <?= $form->field($model, 'chemo_regimen_ids', ['showLabels' => false])->hiddenInput(['value' => $regimenids]) ?>
            ...
            <?= $form->field($model, 'cpoe_level', ['showLabels' => false])->hiddenInput() ?>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <div class="form-group" style="text-align: right;">
            ...
            <?= Html::button('Save', ['type' => 'button', 'class' => 'btn btn-success', 'id' => 'Savecpoedetail']); ?>
        </div>
    </div>
</div>
<?php ActiveForm::end(); ?>
...
<script>
    ...
    $("input[id=inputPRN]").click(function () {
        if ($(this).is(":checked"))
        {
            document.getElementById("tbcpoedetail-ised_reason").disabled = false;//กรณีเลือก PRN
        } else {
            document.getElementById("tbcpoedetail-ised_reason").disabled = true;//กรณีไม่เลือก PRN
        }
    });
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=chemos/rxorder/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=chemos/rxorder/calculate-drugprice",
            type: "post",
    ...
    $('select[id=tbcpoedetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=chemos/rxorder/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
