                ...
                <div class="invoice-container">
                    <ul>
                        <div class="row">
                            ...
                            <li class="pull-right">
                                <?=
                                Html::a('<i class="glyphicon glyphicon-list-alt"></i>' . 'Detail', ['/chemo/pttrp/ardetail', 'vn_number' => $header['pt_visit_number']], ['role' => 'modal-remote', 'class' => 'btn btn-info  btn-xs'])
                                ?>
                                &nbsp;
                            </li>
                        </div>
