...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <h5 class="success">
            <b><?= Html::encode('Base Solution :'); ?></b>  <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Base Solution', ['create-base', 'drugset_id' => $drugset_id, 'chemo_ids' => $chemo_ids, 'chemo_id' => $chemo_id, 'drugset_ids' => $drugset_ids], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote']); ?>
        </h5>
        ...
        <h5 class="success">
            <b><?= Html::encode('Drug Additive :') ?></b> <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Drug Additive', ['create-additive', 'drugset_id' => $drugset_id, 'chemo_ids' => $chemo_ids, 'chemo_id' => $chemo_id, 'drugset_ids' => $drugset_ids], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote']); ?>
        </h5>
...
<script>
    function GettbBasesolution() {
        ...
        $.ajax({
            url: "index.php?r=chemos/std/gettb-basesolution",
            type: "POST",
    ...
    function GettbDrugAdditive() {
        ...
        var chemo_id = <?= "'" . $chemo_id . "'"; ?>;
        $.ajax({
            url: "index.php?r=chemos/std/gettb-drugadditive",
            type: "POST",
            data: {parent: parent, chemo_id: chemo_id},
            dataType: "JSON",
            success: function (result) {
    ...
    function SaveIVSolutionitem(id) {
        ...
        $.post(
                'index.php?r=chemos/std/saveitem-ivsolution',
                {
    ...
    $(document).ready(function () {
        ...
        function GetItemDetail() {
            ...
            if (id != '') {
                ...
                $.ajax({
                    url: "index.php?r=chemos/std/selectitem",
                    type: "get",
                    data: {id: id},
                    dataType: "JSON",
                    success: function (result) {
