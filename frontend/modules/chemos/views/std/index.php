...
$this->params['breadcrumbs'][] = ['label' => 'Chemo Order : ผู้ป่วยนอก', 'url' => ['/chemos/pttrp/treatmentindex', 'hn' => $data_vn->pt_hospital_number, 'vn' => $data_vn->pt_visit_number]];
                        ...
                        GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'headerOptions' => ['style' => 'text-align:center;color:black;background-color: #ddd'],
                                    'value' => function ($model) {
                                return empty($model->medical_right_desc) ? '-' : $model->medical_right_desc;
                            }
                                ],
                                [
