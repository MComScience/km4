...
<div class="row">
    <div class="col-md-7 col-md-offset-0">
        <div id="simplewizard" class="wizard" data-target="#simplewizard-steps">
            <ul class="steps">
                <li id="simplewizardstep1" data-target="#simplewizardstep1" class="active"><span class="step">1</span>เลือกยา<span class="chevron"></span></li>
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <div id="content2" class="tab-pane content2">
                                ...
                                <?=
                                $this->render('_form_details_chemopo', [
                                    'model' => $drugsetmodel,
                                    'chemo_ids' => $chemo_ids,
