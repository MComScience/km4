            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <?= $form->field($model, 'cpoe_period_value', ['showLabels' => false])->textInput(['style' => 'background-color: white', 'type' => 'number', 'readonly' => true]) ?>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <?=
...
<div class="row">
    <div class="form-group">
        <div class="col-xs-12 col-sm-6 col-md-8">
            ...
            <?= $form->field($model, 'std_trp_chemo_ids', ['showLabels' => false])->hiddenInput(['value' => $chemo_ids]) ?>
...
<script>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=chemos/std/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=chemos/std/calculate-drugprice",
            type: "post",
    ...
    $("div[id=drugroutename]").click(function () {
        $('select[id=cat-id]').on('change', function () {
            ...
            if (routeid != '') {
                $.ajax({
                    url: "index.php?r=chemos/std/getroute-select",
                    type: "get",
    ...
    $('select[id=tbdrugsetdetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=chemos/std/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
