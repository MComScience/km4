...
$this->params['breadcrumbs'][] = ['label' => 'ห้องจ่ายยาผู้ป่วยนอก', 'url' => ['/chemos/std/new-std']];
            ...
            <div class="tab-content">
                <div id="content1" class="tab-pane in active">
                    <div class="tb-std-trp-chemo-index">
                        <p>
                            <?= Html::a('New Standard Regimen', ['new-regimen'], ['role' => 'modal-remote', 'class' => 'btn btn-purple', 'data-toggle' => 'tooltip', 'title' => 'New Regimen']) ?>
                        </p>
