        ...
        swal({
            ...
            confirmButtonText: "Confirm",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post(
                                'index.php?r=chemo/std/delete-drugsetdetail',
                                {
                                    id: fID
                                },
                        function (data)
...
<div class="form-group">
    <div class="col-lg-12 col-sm-6 col-xs-12">
        <h5 class="success">
            ...
            <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Add', ['create-keep-vein', 'drugset_id' => $drugset_id, 'chemo_ids' => $model->std_trp_chemo_ids, 'chemo_id' => $model['std_trp_chemo_id']], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote',]); ?>
            <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Premedication', ['create-premedication', 'drugset_id' => $drugset_id, 'chemo_ids' => $model->std_trp_chemo_ids, 'chemo_id' => $model['std_trp_chemo_id']], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote',]); ?>
            <?=
            ...
            Html::a('<i class="glyphicon glyphicon-plus"></i>Chemo Inj', ['create-inj', 'drugset_id' => $drugset_id, 'chemo_ids' => $model->std_trp_chemo_ids, 'chemo_id' => $model['std_trp_chemo_id']], ['class' => 'btn btn-purple btn-sm', 'role' => 'modal-remote',]);
            ?>
            <b><?= Html::encode('Home med :'); ?></b>
            <?=
            Html::a('<i class="glyphicon glyphicon-plus"></i>Drug', ['create-medication', 'drugset_id' => $drugset_id, 'chemo_ids' => $model->std_trp_chemo_ids, 'chemo_id' => $model['std_trp_chemo_id']], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote',]) . ' ' .
            Html::a('<i class="glyphicon glyphicon-plus"></i>Chemo P.O.', ['create-chemopo', 'drugset_id' => $drugset_id, 'chemo_ids' => $model->std_trp_chemo_ids, 'chemo_id' => $model['std_trp_chemo_id']], ['class' => 'btn btn-purple btn-sm', 'role' => 'modal-remote',]);
            ?>
        </h5>
        ...
        <div class="form-group">
            <div class="col-lg-12 col-sm-6 col-xs-12">
                <h5 class="success">
                    ...
                    <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Add', ['create-premedication', 'drugset_id' => $drugset_id, 'chemo_ids' => $model->std_trp_chemo_ids, 'chemo_id' => $model['std_trp_chemo_id']], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote',]); ?>
                </h5>
                <?=
                GridView::widget([
                            ...
                            <div class="col-lg-12 col-sm-6 col-xs-12">
                                ...
                                <script>
                                    function GetmodalIVSolution() {
                                        ...
                                        $.ajax({
                                            url: 'index.php?r=chemo/std/ivsolution',
                                            type: 'get',
                                    ...
                                    function EditIVSolution(id) {
                                        ...
                                        var chemo_id = <?= "'" . $model->std_trp_chemo_id . "'" ?>;
                                        $.ajax({
                                            url: 'index.php?r=chemo/std/edit-ivsolution',
                                            type: 'get',
