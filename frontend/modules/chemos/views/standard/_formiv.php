...
<div class="row tableparent">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <h5 class="success">
            <b><?= Html::encode('Base Solution :'); ?></b>  <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Base Solution', ['create-base', 'drugset_id' => $drugset_id, 'chemo_id' => $chemo_id, 'parent' => $drugset_ids, 'drugset_type' => $drugset_type], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote']); ?>
        </h5>
        ...
        <h5 class="success">
            <b><?= Html::encode('Drug Additive :') ?></b> <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Drug Additive', ['create-additive', 'drugset_id' => $drugset_id, 'chemo_id' => $chemo_id, 'parent' => $drugset_ids,'drugset_type' => $drugset_type], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote']); ?>
        </h5>
...
<script>
    function GettbBasesolution() {
        ...
        var drugset_type = <?= "'" . $drugset_type . "'"; ?>;
        LoadingClass();
        $.ajax({
            url: "index.php?r=chemos/standard/gettb-basesolution",
            type: "POST",
            data: {parent: parent, chemo_id: chemo_id,drugset_type:drugset_type},
            dataType: "JSON",
    ...
    function GettbDrugAdditive() {
        ...
        LoadingClass();
        $.ajax({
            url: "index.php?r=chemos/standard/gettb-drugadditive",
            type: "POST",
            data: {parent: parent, chemo_id: chemo_id,drugset_type:drugset_type},
            dataType: "JSON",
            success: function (result) {
    ...
    function SaveIVSolutionitem(id) {
        ...
        $.post(
                'index.php?r=chemos/standard/saveitem-ivsolution',
                {
