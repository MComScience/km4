...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <div class="form-group" style="text-align: right;">
            ...
            <button type="button" class="btn btn-success ladda-button" data-style="expand-left" id="Savedrugsetdetail">Save</button>
        </div>
    </div>
</div>
<!-- End Row -->
...
<script>
    ...
    $('select[id=tbdrugsetdetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=chemos/standard/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
