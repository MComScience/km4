...
<script>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=chemos/order/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=chemos/order/calculate-drugprice",
            type: "post",
    ...
    $("div[id=drugroutename]").click(function () {
        $('select[id=cat-id]').on('change', function () {
            ...
            if (routeid != '') {
                $.ajax({
                    url: "index.php?r=chemos/order/getroute-select",
                    type: "get",
    ...
    $('select[id=tbcpoedetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=chemos/order/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
