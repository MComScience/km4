                    ...
                    'buttons' => [
                        'rxorder' => function ($key, $model) {
                            if ($model['pt_trp_regimen_status'] == 2) {
                                $url = ['create-rxorder', 'ids' => $model['chemo_regimen_ids'], 'vn' => $model['pt_visit_number']];
...
<script>
        ...
        swal({
            ...
            closeOnCancel: true,
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post(
                                'index.php?r=chemos/pttrp/delete-chemodetails',
                                {
                                    id: id
                                },
                                function (data)
    ...
    function Duplicate() {
        ...
        $.ajax({
            type: 'POST',
            url: 'index.php?r=chemos/pttrp/duplicate',
            data: frm.serialize(),
            dataType: "JSON",
