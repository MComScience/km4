...
use app\modules\chemo\models\TbCpoeStatus;
?>
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <?= Html::a('Select Regiment', ['/chemos/std/index', 'vn' => $model['pt_visit_number'], 'ptid' => $model['pt_trp_chemo_id']], ['class' => 'btn btn-purple']); ?>
    </div>
