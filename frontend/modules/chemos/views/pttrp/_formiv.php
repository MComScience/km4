...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <h5 class="success">
            <b><?= Html::encode('Base Solution :'); ?></b> <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Add', ['create-base', 'drugset_id' => $drugset_id, 'vn_number' => $vn, 'drugset_ids' => $drugset_ids], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote']); ?>
        </h5>
        <div id="detailsBaseSolution"></div>  
        <hr>
        <h5 class="success">
            <b><?= Html::encode('Drug Additive :') ?></b> <?= Html::a('<i class="glyphicon glyphicon-plus"></i>Add', ['create-additive', 'drugset_id' => $drugset_id, 'vn_number' => $vn, 'drugset_ids' => $drugset_ids], ['class' => 'btn btn-success btn-sm', 'role' => 'modal-remote']); ?>
        </h5>
...
<script>
    function GettbBasesolution() {
        ...
        $.ajax({
            url: "index.php?r=chemos/pttrp/gettb-basesolution",
            type: "POST",
            data: {parent: parent},
            dataType: "JSON",
    ...
    function GettbDrugAdditive() {
        var parent = <?= "'" . $drugset_ids . "'"; ?>;
        $.ajax({
            url: "index.php?r=chemos/pttrp/gettb-drugadditive",
            type: "POST",
            data: {parent: parent},
            dataType: "JSON",
            success: function (result) {
    ...
    $(document).ready(function () {
        ...
        function GetItemDetail() {
            ...
            if (id != '') {
                ...
                $.ajax({
                    url: "index.php?r=chemos/pttrp/selectitem",
                    type: "get",
                    data: {id: id},
                    dataType: "JSON",
                    success: function (result) {
