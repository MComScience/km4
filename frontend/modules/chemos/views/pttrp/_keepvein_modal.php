...
<div class="row">
    <div class="col-md-7 col-md-offset-0">
        <div id="simplewizard" class="wizard" data-target="#simplewizard-steps">
            <ul class="steps">
                <li id="simplewizardstep1" data-target="#simplewizardstep1" class="active"><span class="step">1</span>เลือก KVO Solution<span class="chevron"></span></li>
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <div id="content3" class="tab-pane">
                                ...
                                <?=
                                $this->render('_form_details_keepvein', [
                                    'model' => $drugsetmodel,
