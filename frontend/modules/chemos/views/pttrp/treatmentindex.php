...
$this->params['breadcrumbs'][] = ['label' => 'Chemo Order : ผู้ป่วยนอก', 'url' => ['/chemos/pttrp/treatmentindex', 'hn' => $header->pt_hospital_number, 'vn' => $header->pt_visit_number]];
...
$(document).ready(function () {
    ...
    $(".modal-content").addClass('animated fadeInDownBig');
});
JS;
                                        ...
                                        <div class="tbpttrp-chemo-index">
                                            <div id="ajaxCrudDatatable">
                                                ...
                                                <?php if ($checkplan == 'False') : ?>
                                                    <?= Html::a('New Treatment Plan', ['newtreatment-plan', 'vn' => $header['pt_visit_number']], ['role' => 'modal-remote', 'title' => 'New Treatment Plan', 'class' => 'btn btn-purple', 'id' => 'newtreatment']); ?>
                                                <?php endif; ?>
        ...
        swal({
            ...
            confirmButtonText: "Confirm",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post(
                                'index.php?r=chemos/pttrp/delete',
                                {
                                    id: fID
                                },
                        function (data)
