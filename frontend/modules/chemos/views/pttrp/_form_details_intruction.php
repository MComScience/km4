...
use app\modules\chemo\models\TbDrugroute;
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        ...
                        $form->field($model, 'cpoe_drugprandialadviceid', ['showLabels' => false])->widget(DepDrop::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'url' => Url::to(['/chemo/pttrp/get-drugadvice']),
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-xs-12 col-sm-6 col-md-8">
                    ...
                    <?= $form->field($model, 'cpoe_id', ['showLabels' => false])->hiddenInput(['value' => $drugset_id]) ?>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-12">
        <div class="form-group" style="text-align: right;">
            ...
            <button type="button" class="btn btn-success" id="Savedrugsetdetail">Save</button>
        </div>
    </div>
</div>
<!-- End Row -->
