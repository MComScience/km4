                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <div id="content3" class="tab-pane">
                                ...
                                <?=
                                $this->render('_form_details_medication', [
                                    'model' => $drugsetmodel,
...
//                            (min < Item_Cr_Amt && ItemQtyAvalible < max)
        ...
        function CheckedItemType() {
            var typeid = $('input[id=tbdrugsetdetail-cpoe_itemtype]').val();
            if (typeid == '10') {
                ...
                document.getElementById("cpoetype10").checked = true;
                $('input[id=tbdrugsetdetail-cpoe_itemtype]').val('10');
            }
        }
    });
    ...
    function SelectItemDrug(e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[id=tbdrugsetdetail-itemprice]').val(result.ItemPrice);//Set Itemprice ที่ได้จากการเลือก ItemID
    ...
    function GetDisunit(id) {
        $.ajax({
            url: "index.php?r=chemos/pttrp/get-disunit",
            type: "POST",
            data: {id: id},
            dataType: "JSON",
            success: function (result) {
    ...
    $("input[id=cpoetype10]").click(function () {
        ...
        {
            $('input[id=tbdrugsetdetail-cpoe_itemtype]').val($(this).val()); //Set Value ให้กับ Input
        } else {//ถ้าไม่ Checked 
            $('input[id=tbdrugsetdetail-cpoe_itemtype]').val(null); //Set Value = Null
        }
    });
    ...
    $("input[id=cpoetype20]").click(function () {
        if ($(this).is(":checked"))//ถ้า Checked 
        {
            ...
            $('input[id=tbdrugsetdetail-cpoe_itemtype]').val(); //Set Value = Null
        }
    });
</script>