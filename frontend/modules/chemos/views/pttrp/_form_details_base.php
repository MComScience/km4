...
<script>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            ...
            url: 'index.php?r=chemos/pttrp/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=chemos/pttrp/calculate-drugprice",
            type: "post",
    ...
    $("div[id=drugroutename]").click(function () {
        $('select[id=cat-id]').on('change', function () {
            ...
            if (routeid != '') {
                $.ajax({
                    url: "index.php?r=chemos/pttrp/getroute-select",
                    type: "get",
    ...
    $('select[id=tbdrugsetdetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=chemos/pttrp/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
