<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th width="20%" style="font-size:16pt;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 10px;">
    ...
    <tbody>
        ...
        foreach ($rs as $r) {
            ?>
            <tr>
                <td  style="font-size:16pt"><?php echo $r['PRNum'] ?></td><td  style="font-size:16pt"><?php echo Yii::$app->componentdate->convertMysqlToThaiDate($r['PRDate']) ?></td><td  style="font-size:16pt"><?php echo $r['PRCreatedBy'] ?></td><td  style="font-size:16pt"><?php echo $r['PRReasonNote'] ?></td><td  style="font-size:16pt"><?php echo$r['PRRejectReason'] ?></td>
            </tr>
            <tr>
                <td  colspan="5">
                    <table border="0"  width="100%">
                        ...
                        foreach ($result as $value) {
                            ?>
                            <tr>
                                <td width="2%"></td><td width="15%" style="font-size:14pt"><?php echo $value['TMTID_GPU'] ?></td><td width="20%" style="font-size:14pt"><?php echo $value['ItemName'] ?></td><td width="10%" style="font-size:14pt"><?php echo $value['VerifyQty'] ?></td><td width="10%" style="font-size:14pt"><?php echo $value['VerifyUnitCost'] ?></td><td width="10%" style="font-size:14pt"><?php echo $value['VerifyUnit'] ?></td><td width="10%" style="font-size:14pt"><?php echo $value['ExtenedCost'] ?></td>
                            </tr>
                            <?php
                        }
                        ?>
