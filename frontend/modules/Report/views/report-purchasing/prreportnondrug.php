...
<tr>
    <td style="text-align: left;font-size: 16pt;" colspan="2">
        ...
        foreach ($rs as $value) {
            ?>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo Yii::$app->componentdate->format_number($i) ?>. <?php echo $value->ItemName; ?>  จำนวน <?php echo Yii::$app->componentdate->format_number($value->PRQty) ?> <?php echo $value->PRUnit ?> ราคา <?php echo Yii::$app->componentdate->format_number($value->ExtenedCost); ?> บาท<br>
            <?php $i++;
        }
        ?>
