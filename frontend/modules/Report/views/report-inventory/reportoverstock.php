<table border="0" cellpadding="0" cellspacing="0" width="100%">    
    <thead>
        <tr>
            ...
            <td style="text-align:center;font-size:16pt;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 10px;" width="50%">
    ...
    <tbody>
        <?php
        $rs = \app\modules\Inventory\models\VwStkBalancetotalItemID::findAll(['OverStock' => 'Y', 'ItemCatID' => $ItemCatID]);
...
<?php
$count = \app\modules\Inventory\models\VwStkBalancetotalItemID::find()->where(['OverStock' => 'Y', 'ItemCatID' => $ItemCatID])->count();
?>
