<table border="0" cellpadding="0" cellspacing="0" width="100%">  
    ...
    <tbody>
        <?php
        $rs = \app\modules\Report\models\VwStkBalancetotalIotnumber::find()->where(['ItemCatID' => $ItemCatID,'ExpDate'=>'Y'])->all();
        foreach ($rs as $r) {
            ?>
            <tr>
                <td  style="font-size:16pt;text-align: center"><?php echo $r['ItemID'] ?></td><td  style="font-size:16pt;text-align: center"><?php echo $r['ItemInternalLotNum'] ?></td><td  style="font-size:16pt"><?php echo $r['ItemName'] ?></td><td  style="font-size:16pt;text-align: right"><?php echo number_format($r['ItemQtyBalance'], 2) ?></td><td  style="font-size:16pt;text-align: center" ><?php echo $r['DispUnit'] ?></td><td  style="font-size:16pt;text-align: center"><?php echo $r['ItemExpDate2'] ?></td><td  style="font-size:16pt;text-align: center"><?php echo $r['ItemExpDateControl'] ?></td>
            </tr>
        <?php } ?>
    </tbody>
</table>
<?php
$count = \app\modules\Report\models\VwStkBalancetotalIotnumber::find()->where(['ItemCatID' => $ItemCatID,'ExpDate'=>'Y'])->count();
?>
