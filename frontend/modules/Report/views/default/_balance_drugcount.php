...
<?php if ($content == 'H') : ?>
    <table width="100%">
        <tr>
            ...
            <td width="66.66%" style="text-align:center;font-size:18pt">
                <strong><?= $title ?></strong>
            </td>
        <tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0"  width="100%"> 
        <thead>
            <tr>
                ...
                <th style="text-align:center;font-size:16pt;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 10px;" width="37%">
        ...
        <tbody>
            <?php foreach ($rows as $r) : ?>
                <tr>
                    ...
                    <td  style="font-size:16pt;text-align: center;vertical-align: top;"><?php echo Html::label('................') ?></td>
                    <td  style="font-size:16pt;text-align: center;vertical-align: top;"><?php echo Html::label('...............') ?></td>
                </tr>
                <?php $i++; ?>
            <?php endforeach; ?>
