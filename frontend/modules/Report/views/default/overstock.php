...
<?php if ($content == 'H') : ?>
    <table width="100%">
        <tr>
            ...
            <td width="33%" style="text-align:center;font-size:16pt">
                <strong><p>รายงานสินค้าสูงกว่าระดับการจัดเก็บ</p><p>Over Stock</p></strong>
            </td>
        <tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">    
        <thead>
            <tr>
                ...
                <td style="text-align:center;font-size:16pt;border-top: 1px solid black;border-bottom: 1px solid black;padding-top: 10px;" width="35%">
