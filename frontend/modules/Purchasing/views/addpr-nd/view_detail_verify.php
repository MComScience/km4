...
//                        ],
                        'attributes' => [
                            ...
                            [
                                ...
                                'label' => 'ราคากลาง',
                                'value' => $model->PRItemStdCost != 0 ? number_format($model->PRItemStdCost,2) : '-',
                            ],
                            [
                                'attribute' => 'PRItemUnitCost',
                                'label' => 'ราคาต่อหน่วยตามแผน',
                                'value' => $model->PRItemUnitCost != 0 ? number_format($model->PRItemUnitCost,2) : '-',
                            ],
                            [
                                'attribute' => 'PRItemOrderQty',
                                'label' => 'ปริมาณตามแผน',
                                'value' => $model->PRItemOrderQty != 0 ? number_format($model->PRItemOrderQty,2) : '-',
                            ],
                            [
                                'attribute' => 'PRApprovedOrderQtySum',
                                'label' => 'ปริมาณขอซื้อแล้ว',
                                'value' => $model->PRApprovedOrderQtySum != 0 ? number_format($model->PRApprovedOrderQtySum,2) : '-',
                            ],
                            [
                                'attribute' => 'PRItemAvalible',
                                'label' => 'ปริมาณขอซื้อได้',
                                'value' => $model->PRItemAvalible != 0 ? number_format($model->PRItemAvalible,2) : '-',
                            ],
                            [
                                'attribute' => 'PRItemAvalible',
                                'label' => '-',
...
//                    ],
                        'attributes' => [
                            [
                                ...
                                'valueColOptions' => ['style' => 'width:50%'],
                                'displayOnly' => true,
                                'value' => $model->PRPackQty != 0 ? number_format($model->PRPackQty,2) : '-',
                            ],
                            [
                                'attribute' => 'PackUnit',
                                'label' => 'หน่วยแพค',
                            ...
                            [
                                ...
                                'label' => 'ราคา/แพค',
                                'value' => $model->ItemPackCost != 0 ? number_format($model->ItemPackCost,2) : '-',
                            ],
                            [
                                'attribute' => 'PROrderQty',
                                'label' => 'จำนวนขอซื้อ',
                                'value' => $model->PROrderQty != 0 ? number_format($model->PROrderQty,2) : '-',
                            ],
                            [
                                'attribute' => 'DispUnit',
                                'value' => $model->detail->DispUnit != null ? $model->detail->DispUnit : '0.00',
                                'label' => 'หน่วย',
                            ],
                            [
                                'attribute' => 'PRUnitCost',
                                'label' => 'ราคาต่อหน่วย',
                                'value' => $model->PRUnitCost != 0 ? number_format($model->PRUnitCost,2) : '-',
                            ],
                            [
...
//                    ],
                        'attributes' => [
                            [
                                ...
                                'label' => 'ปริมาณ/แพค',
                                'value' => $packunit['ItemPackSKUQty'] != 0 ? number_format($packunit['ItemPackSKUQty'],2) : '-',
                            ],
                            [
                                'attribute' => 'DispUnit',
                    ...
                    DetailView::widget([
                        ...
                        'attributes' => [
                            [
                                'attribute' => 'ItemPackSKUQty',
                                'label' => 'ปริมาณ/แพค',
                                'value' => $packverify['ItemPackSKUQty'] != 0 ? number_format($packverify['ItemPackSKUQty'],2) : '-',
                            ],
                            [
                                'attribute' => 'DispUnit',
...
<script>
    function OKVerify(d) {
        ...
        bootbox.confirm('ยืนยันการทวนสอบ?', function (result) {
            if (result) {
                $.post(
                        'ok-verify',
                        {
