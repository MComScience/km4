                ...
                <div id="home" class="tab-pane in active">
                    <div class="well">
                        <div class="tb-pr2-form ">
                            <?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'id' => 'formverify_nd']); ?>
                            <div class="form-group" >
                                ...
                                <div class="col-sm-3">
                                    <?=
                                    $form->field($modelPR2, 'DepartmentID', ['showLabels' => false])->widget(Select2::classname(), [
                            ...
                            <div class="form-group" >
                                ...
                                <p></p>
                                <?php Pjax::begin(['id' => 'verify_nd_pjax_id']) ?>
                                <?=
                                GridView::widget([
                                    ...
                                    'columns' => [
                                            ...
                                            'detailUrl' => Url::to(['view-detailnd-reject', 'view' => $view]),
                                        ],
                                            [
                                            'attribute' => 'ItemID',
                                            'header' => 'รหัสสินค้า',
...
Modal::begin([
    'id' => 'verify-modal',
    'header' => '<h4 class="modal-title">ปรับปรุงรายการเวชภัณฑ์</h4>',
    'size' => 'modal-lg modal-primary',
    'clientOptions' => ['backdrop' => 'static', 'keyboard' => false],
    'closeButton' => false,
]);
...
/* Savedraft */
$('#formverify_nd').on('beforeSubmit', function (e)
{
...
//Edit Verify
    $('.activity-update-link').click(function (e) {
        ...
        { 
            ...
            $('#data').html(data);
            //$('.modal-title').html('ปรับปรุงรายการเวชภัณฑ์ ทวนสอบใบขอซื้อ');
            $('#checkover').val('');
            $('.page-content').waitMe('hide');
...
$('#verify_nd_pjax_id').on('pjax:success', function () {
