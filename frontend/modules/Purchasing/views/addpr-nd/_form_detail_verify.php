...
if ($view == 'wating-verify') {
    ...
    $this->title = 'ทวนสอบใบขอซื้อเวชภัณฑ์';
                                        ...
                                        if ($model->PRItemOnPCPlan == 1) {
                                            ...
                                            'columns' => [
                                                ...
                                                if ($model->dataonview->VerifyUnitCost == NULL) {
                                                    ...
                                                    return number_format($model->dataonview->VerifyUnitCost, 2);
                                                }
                                            }
                                                ],
                                                [
...
//                                                },
                ...
                Modal::begin([
                    'id' => 'verify-modal',
                    'header' => '<h4 class="modal-title">ปรับปรุงรายการเวชภัณฑ์ ทวนสอบใบขอซื้อ</h4>',
