...
use app\modules\Purchasing\models\TbPtService;
use app\modules\Purchasing\models\TbPtServiceMd;
?>
        ...
        <div class="profile-container">
            <div class="profile-header row">
                ...
                <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
                    <div class="row">
                        <div class="header-fullname"><b>คลีนิกเคมีบำบัด</b></div>
                            ...
                            <div id="overview" class="tab-pane active">
                                <div class="row profile-overview">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <a class="btn btn-success" id="_registerpatienopd">ลงทะเบียนผู้ป่วยนอก</a>
...
$('#registerbtn').click(function (e) {
    $.ajax({
        url: 'index.php?r=Purchasing/dashboard/save-service-arrive-opd',
        type: 'POST',
...
$('#searchipdopd').click(function (e) {
       var  hn = $('#hn').val();
        if(hn !== ""){
          $.ajax({
            url: 'index.php?r=Purchasing/dashboard/km4-get-tpu-opd',
            type: 'POST',
            data:{hn:hn},
            dataType: 'json',
            success: function (data) {
