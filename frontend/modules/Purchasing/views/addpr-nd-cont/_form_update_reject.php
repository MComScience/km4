...
<div class="well">
    <div class="row">
        ...
        <input type="hidden" id="vvwpritemdetail2-ids" name="VwPritemdetail2[ids]" value="<?php echo $modeledit['ids']; ?>"/>
        <input type="hidden" id="PackUnit" name="" value="<?php echo $PackUnit; ?>"/>
        <input type="hidden" id="vvwpritemdetail2-ids" name="VwPritemdetail2[TMTID_GPU]" value="<?php echo $modeledit['TMTID_GPU']; ?>"/>
        <div class="col-md-12">
