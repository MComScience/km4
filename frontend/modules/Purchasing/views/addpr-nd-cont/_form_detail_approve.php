                                ...
                                if ($model->PRItemOnPCPlan == 1) {
                                    ...
                                    'columns' => [
                                        ...
                                        [
                                            ...
                                            'detailUrl' => Url::to(['view-detail-approve']),
                                        ],
                                        [
                                            'attribute' => 'ItemID',
                                            'header' => 'รหัสสินค้า',
    ...
    swal({
        ...
        closeOnCancel: true,
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.post(
                            'index.php?r=Purchasing/addpr-nd-cont/approve-pr',
                            {
...
$('#SaveRejectApprove').click(function (e) {
    ...
    if (PRRejectReason == "") {
        ...
        $.post(
                'index.php?r=Purchasing/addpr-nd-cont/rejected-approve',
                {
