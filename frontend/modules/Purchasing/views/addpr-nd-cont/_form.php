                        ...
                        <div id="home" class="tab-pane in active">
                            <div class="well">
                                <div class="tb-pr2-temp-form">
                                    <?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'id' => 'form_nd_cont']); ?>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            $form->field($modelPR, 'POContactNum', ['showLabels' => false])->widget(Select2::classname(), [
                                                'data' => ArrayHelper::map(TbPcplan::find()->where(['PCPlanTypeID' => 6])->all(), 'PCPOContactID', 'PCPOContactID'),
                                                'language' => 'en',
                                                'options' => ['placeholder' => 'Select Option'],
                                                'pluginOptions' => [
                                                    'allowClear' => true
                                    ...
                                    <div class="form-group">
                                        <?php Pjax::begin([ 'id' => 'nd_cont_pjax_id']) ?>
                                        <?=
                                        GridView::widget([
                                        ...
                                        if ($model->PRItemOnPCPlan == 1) {
                                            ...
                                            'columns' => [
                                                ...
                                                [
                                                    ...
                                                    'detailUrl' => Url::to(['view-detailnd-cont']),
                                                ],
                                                [
                                                    'attribute' => 'ItemID',
                                                    'header' => 'รหัสสินค้า',
...
function init_click_handlers() {
    $('.activity-update-link').click(function (e) {
        ...
        LoadingClass();
        $.get(
                'index.php?r=Purchasing/addpr-nd-cont/update-detailnd',
                {
                    id: fID
                },
        function (data)
    ...
    swal({
        ...
        closeOnCancel: true,
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.post(
                            'index.php?r=Purchasing/addpr-nd-cont/delete-detailnd',
                            {
                                id: fID
                            },
                    function (data)
...
$('#nd_cont_pjax_id').on('pjax:success', function () {
    ...
    swal({
        ...
        closeOnCancel: true,
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.post(
                            'index.php?r=Purchasing/addpr-nd-cont/clear-nd',
                            {
                                PRID: PRID
                            },
                    function (data)
...
/* On Save */
    $('#form_nd_cont').on('beforeSubmit', function(e)
    {
...
$(document).ready(function () {
    $('#tbpr2temp-prtypeid').on('change', function () {
        ...
        if (PRType != '') {
            $.post({
                url: 'index.php?r=Purchasing/addpr-nd-cont/get-reasonnd', // your controller action
                dataType: 'json',
                data: {PRType: PRType},
                success: function (data) {
                    if (data.htl == null) {
...
JS;
                    ...
                    <script>
                        function SelectND(d) {
                            ...
                            LoadingClass();
                            $.ajax({
                                url: 'index.php?r=Purchasing/addpr-nd-cont/new-detailnd',
                                type: 'POST',
                            ...
                            swal({
                                ...
                                closeOnCancel: true,
                                    ...
                                    function (isConfirm) {
                                        if (isConfirm) {
                                            $.post(
                                                    'index.php?r=Purchasing/addpr-nd-cont/sendtoverify',
                                                    {
