...
$val1 = base64_encode($modelPR2['PRNum']);
if ($view == 'wating-approve') {
    ...
    $this->title = 'อนุมัติใบขอซื้อยาการค้า สัญญาจะซื้อจะขาย';
                ...
                <div id="home" class="tab-pane in active">
                    <div class="well">
                        <div class="tb-pr2-form">
                            <?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'id' => 'form-detail-approve']); ?>
    ...
    swal({
        ...
        closeOnCancel: true,
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.post(
                            'index.php?r=Purchasing/addpr-tpu-cont/approve-pr',
                            {
...
$('#SaveRejectApprove').click(function (e) {
    ...
    if (PRRejectReason == "") {
        ...
        $.post(
                'index.php?r=Purchasing/addpr-tpu-cont/rejected-approve',
                {
