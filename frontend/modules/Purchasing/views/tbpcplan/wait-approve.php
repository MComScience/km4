                                                    ...
                                                    'buttons' => [
                                                        'primacyaprove' => function ($url, $model, $key) {
                                                            if ($model->PCPlanTypeID == '1' || $model->PCPlanTypeID == '2') {
                                                                $url = '/km4/Purchasing/tbpcplan/primacyaprove?id=' . $key . '&type=' . Yii::$app->componentdate->aes128Encrypt($key, 'pharmacist');
                                                            } else if ($model->PCPlanTypeID == '3' || $model->PCPlanTypeID == '4') {
                                                                $url = '/km4/Purchasing/tbplan/primacyaprove?id=' . $key . '&type=' . Yii::$app->componentdate->aes128Encrypt($key, 'pharmacist');
                                                            } else
                                                            if ($model->PCPlanTypeID == '7' || $model->PCPlanTypeID == '8') {
                                                                $url = '/km4/Purchasing/tbplandrug/primacyaprove?id=' . $key . '&type=' . Yii::$app->componentdate->aes128Encrypt($key, 'pharmacist');
                                                            } else if ($model->PCPlanTypeID == '5') {
                                                                $url = '/km4/Purchasing/tbplandrugsale/primacyaprove?id=' . $key . '&type=' . Yii::$app->componentdate->aes128Encrypt($key, 'pharmacist');
                                                            } else if ($model->PCPlanTypeID == '6') {
                                                                $url = '/km4/Purchasing/tbplansale/primacyaprove?id=' . $key . '&type=' . Yii::$app->componentdate->aes128Encrypt($key, 'pharmacist');
                                                            }
