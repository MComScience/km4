...
<div class="well">
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRItemStdCost', ['showLabels' => false])->textInput([
                        ...
                        'value' => empty($modeledit->PRItemStdCost) ? NULL : number_format($modeledit->PRItemStdCost, 4)
                    ])
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRItemUnitCost', ['showLabels' => false])->textInput([
                        'readonly' => true,
                        'style' => 'background-color: #f9f9f9;text-align:right',
                        'value' => empty($modeledit->PRItemUnitCost) ? NULL : number_format($modeledit->PRItemUnitCost, 4)
                    ])
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRItemOrderQty', ['showLabels' => false])->textInput([
                        'readonly' => true,
                        'style' => 'background-color: #f9f9f9;text-align:right',
                        'value' => empty($modeledit->PRItemOrderQty) ? NULL : number_format($modeledit->PRItemOrderQty, 4)
                    ])
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRApprovedOrderQtySum', ['showLabels' => false])->textInput([
                        'readonly' => true,
                        'style' => 'background-color: #f9f9f9;text-align:right',
                        'value' => empty($modeledit->PRApprovedOrderQtySum) ? NULL : number_format($modeledit->PRApprovedOrderQtySum, 4)
                    ])
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRItemAvalible', ['showLabels' => false])->textInput([
                        'readonly' => true,
                        'style' => 'background-color: #f9f9f9;text-align:right',
                        'value' => empty($modeledit->PRItemAvalible) ? NULL : number_format($modeledit->PRItemAvalible, 4)
                    ])
                    ?>
                </div>
            </div>
        ...
        <div class="col-xs-6">
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('ขอซื้อแบบ') ?></label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('จำนวนแพค') ?><a id="checkจำนวนแพค"></a></label>
                <div class="col-sm-8">
                    <?=
                    $form->field($modeledit, 'PRPackQty', ['showLabels' => false])->textInput([
                        'style' => 'background-color: white;text-align:right',
                        'value' => empty($PRPackQty) ? NULL : number_format($PRPackQty, 4),
                    ])
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('หน่วยแพค') ?><a id="checkหน่วยแพค"></a></label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('ปริมาณ/แพค') ?></label>
                <div class="col-sm-8">
            ...
            <br>
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('ราคา/แพค') ?><a id="checkราคาต่อแพค"></a></label>
                <div class="col-sm-8">
                    <?=
                    $form->field($modeledit, 'ItemPackCost', ['showLabels' => false])->textInput([
                        'value' => empty($ItemPackCost) ? NULL : number_format($ItemPackCost, 4),
                        'style' => 'background-color: white;text-align:right',
                    ])
                    ?>
                </div>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('ขอซื้อ') ?><a id="checkขอซื้อ"></a></label>
                <div class="col-sm-8">
                    <?=
                    $form->field($modeledit, 'PROrderQty', ['showLabels' => false])->textInput([
                        'value' => empty($PROrderQty) ? NULL : number_format($PROrderQty, 4),
                        'style' => 'background-color: white;text-align:right',
                        'required' => true,
                    ])
                    ?>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right"><?= Html::encode('ราคาต่อหน่วย') ?><a
                        id="checkราคาต่อหน่วย"></a></label>
                <div class="col-sm-8">
                    <?=
                    $form->field($modeledit, 'PRUnitCost', ['showLabels' => false])->textInput([
                        'value' => empty($PRUnitCost) ? NULL : number_format($PRUnitCost, 4),
                        'style' => 'background-color: white;text-align:right',
                        'required' => true,
                    ])
                    ?>
...
$(document).ready(function () {
    ...
    $('#vwpritemdetail2-prunitcost').autoNumeric('init',{mDec: '4'});
    $('#vwpritemdetail2-prorderqty').autoNumeric('init',{mDec: '4'});
    $('#vwpritemdetail2-itempackcost').autoNumeric('init',{mDec: '4'});
    $('#vwpritemdetail2-prpackqty').autoNumeric('init',{mDec: '4'});
    $('#vwpritemdetail2-prlastunitcost').autoNumeric('init',{mDec: '4'});
...
$("#vwpritemdetail2-prorderqty").keyup(function () {
    ...
    if (orq > 0) {
        uni = uni.toFixed(4);
        $("#vwpritemdetail2-prextendedcost").val(addCommas(jj.toFixed(4)));
    } else {
        $("#vwpritemdetail2-prextendedcost").val('0.0000');
    }
});    
...
$("#vwpritemdetail2-prpackqty").keyup(function () {
    ...
    if (orq == 0) {
        $("#vwpritemdetail2-prorderqty").val(addCommas(uni.toFixed(4)));
    } else if (orq > 0) {
        orq = orq.toFixed(4);
        $("#vwpritemdetail2-prorderqty").val(addCommas(jj.toFixed(4)));
        $("#vwpritemdetail2-prextendedcost").val(addCommas(Total.toFixed(4)));
    }
});
...
$('#vwpritemdetail2-itempackid').on('change', function () {
    ...
    $.ajax({
        url: "index.php?r=Purchasing/addpr-gpu/get-qtygpu",
        type: "post",
        ...
        success: function (data) {
            ...
            if (data.qty == 0) {
                $('#vwpritemdetail2-prorderqty').val('0.0000');
            } else {
                $("#vwpritemdetail2-prorderqty").val(addCommas(jj.toFixed(4)));
                $("#vwpritemdetail2-prextendedcost").val(addCommas(Total.toFixed(4)));
                $("#vwpritemdetail2-prunitcost").val(addCommas(unitcost.toFixed(4)));
            }
        }
    });
});
...
$("#vwpritemdetail2-itempackcost").keyup(function () {
    ...
    if (orq > 0) {
        var jj = uni / orq;
        var ext = qty * jj;
        $("#vwpritemdetail2-prextendedcost").val(addCommas(ext.toFixed(4)));
        if (uni > 0) {
            orq = orq.toFixed(4);
            $("#vwpritemdetail2-prunitcost").val(addCommas(jj.toFixed(4)));
        } else {
            $("#vwpritemdetail2-prunitcost").val('0.0000');
        }
    }
    if (pritemunitcost > 0) {
