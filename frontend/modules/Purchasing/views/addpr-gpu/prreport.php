...
<tr>
    <td style="text-align: left;font-size: 16pt;" colspan="2">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ๖. วิธีที่จะชื้อยา และเหตุผลที่ต้องชื้อยา ดำเนินการ <?php echo $model->POType ?> เนื่องจากชื้อครั้งนี้ไม่เกิน <?php echo Yii::$app->componentdate->format_number($model->POPriceLimit) ?> บาท อ้างอิงตามคำสั่งเลขที่ กค (กวพ) ๐๔๒๑.๓/ว๒๙๙ ลว.๒๘ สิงหาคม ๒๕๕๘<br>
