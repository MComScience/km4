...
$(document).ready(function () {
        $('#list-reject-approve').addClass("active");
            ...
            <div class="tab-content">
                <div id="รายการใบขอซื้อ" class="tab-pane in active">
                    <div class="tb-pr2-temp-index">
                       ...
                       <?php echo $this->render('_search_detail', ['model' => $searchModel,'action' => 'list-reject-approve']); ?>
                        <p></p>
                        <?=
                        GridView::widget([
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        ...
                                        if ($model->PRTypeID == 1) {//ยาสามัญ
                                            ...
                                            if ($action === 'view') {
                                                return Url::to(['addpr-tpu/update-detail-approve', 'id' => $key, 'view' => 'reject-approve']);
                                            }
                                        } elseif ($model->PRTypeID == 3) {
                                            if ($action === 'view') {
                                                return Url::to(['addpr-nd/update-detail-approve', 'id' => $key, 'view' => 'reject-approve']);
                                            }
                                        } elseif ($model->PRTypeID == 4) {
                                            if ($action === 'view') {
                                                return Url::to(['addpr-tpu-cont/update-detail-approve', 'id' => $key, 'view' => 'reject-approve']);
                                            }
                                        } elseif ($model->PRTypeID == 5) {
                                            if ($action === 'view') {
                                                return Url::to(['addpr-nd-cont/update-detail-approve', 'id' => $key, 'view' => 'reject-approve']);
                                            }
                                        }
                                    }
                                        ],
