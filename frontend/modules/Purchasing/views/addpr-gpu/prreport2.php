...
<html>
    ...
    <tr>
        <td style="text-align: left;font-size: 16pt;" colspan="2">
            ที่&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>สธ๐๓๑๒.๕.๒.๑๒/ <?php echo  Yii::$app->componentdate->arabic_to_thai($model->PRNum) ?></u> &nbsp;&nbsp;&nbsp;วันที่ <u><?php echo Yii::$app->componentdate->convertnumbermonthyearthai(Yii::$app->componentdate->convertToMysql($model->PRDate)) ?></u>
</td>
</tr>
<tr>
    <td style="text-align: left;font-size: 16pt;" colspan="2">
...
<tr>
    <td style="text-align: left;font-size: 16pt;" colspan="2">
		...
		<table border="0" width="100%">
		<tr>
		<td style="text-align:center;font-size:14pt">ชื่อยา</td><td style="text-align:center;font-size:14pt">จำนวน x หน่วยบรรจุ</td><td style="text-align:center;font-size:14pt">ราคาที่เคยชื้อหลังสุด</td><td style="text-align:center;font-size:14pt">ราคาที่จะชื้อ</td><td style="text-align:center;font-size:14pt">ยอดรวม</td>
...
<?php
        ...
        foreach ($rs as $value) {
            ?>
			<tr>
			<td style="text-align:left;font-size:14pt"><?php echo $value->ItemName; ?></td><td style="text-align:center;font-size:14pt"><?php echo $value->PRQty; ?> * <?php echo $value->PRUnit ?></td><td style="text-align:center;font-size:14pt"><?php echo $value->PRLastUnitCost; ?></td><td style="text-align:center;font-size:14pt"><?php echo number_format($value->PRApprovedUnitCost,2); ?></td><td style="text-align:center;font-size:14pt"><?php echo number_format($value->ExtenedCost,2); ?></td><td></td>
            </tr>
			<?php 
        }
        ?>
