...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="profile-container">
            <?php echo $this->render('@frontend/modules/Purchasing/views/dashboard/_hd_manager.php'); ?>
            <div class="profile-body">
                <div class="col-lg-12">
                    <div class="tabbable">
                        <?php echo $this->render('@frontend/modules/Purchasing/views/dashboard/_tab_manager.php'); ?>
                            ...
                            <div id="overview" class="tab-pane active">
                                <div class="row profile-overview">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <?php echo $this->render('_search_detail', ['model' => $searchModel, 'action' => 'detail-approve']); ?>
                                        <p></p>
                                        <?=
                                        GridView::widget([
                                                ...
                                                [
                                                    ...
                                                    'buttons' => [
                                                        ...
                                                        if ($model->PRTypeID == 1 || $model->PRTypeID == 6) {//ยาสามัญ
                                                            if ($action === 'view') {
                                                                return Url::to(['update-detail-approve', 'id' => $key, 'view' => $val]);
                                                            }
                                                        } elseif ($model->PRTypeID == 2 || $model->PRTypeID == 7) {//ยาการค้า
                                                            if ($action === 'view') {
                                                                return Url::to(['addpr-tpu/update-detail-approve', 'id' => $key, 'view' => $val]);
                                                            }
                                                        } elseif ($model->PRTypeID == 3 || $model->PRTypeID == 8) {//เวชภัณฑ์
                                                            if ($action === 'view') {
                                                                return Url::to(['addpr-nd/update-detail-approve', 'id' => $key, 'view' => $val]);
                                                            }
                                                        } elseif ($model->PRTypeID == 4) {
                                                            if ($action === 'view') {
                                                                return Url::to(['addpr-tpu-cont/update-detail-approve', 'id' => $key, 'view' => $val]);
                                                            }
                                                        } elseif ($model->PRTypeID == 5) {
                                                            if ($action === 'view') {
                                                                return Url::to(['addpr-nd-cont/update-detail-approve', 'id' => $key, 'view' => $val]);
                                                            }
                                                        }
                                                    }
                                                        ],
