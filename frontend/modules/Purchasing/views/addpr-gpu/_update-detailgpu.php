...
<div class="well">
    <div class="row">
        <div class="col-xs-6">
            ...
            <input class="form-control" type="hidden" id="PackUnit" value="<?php echo $PackUnit; ?>"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PCPlanNum', ['showLabels' => false])->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(\app\modules\Inventory\models\VwGpuplanDetailAvalible::find()->where(['PCPlanNum' => $PCPlanNum])->all(), 'PCPlanNum', 'PCPlanNum'),
                        'language' => 'en',
                        'pluginOptions' => [
        ...
        <div class="col-xs-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRPackQty', ['showLabels' => false])->textInput([
                        ...
                        'value' => empty($modeledit['PRPackQty']) ? '' : number_format($modeledit['PRPackQty'], 4),
                    ])
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" readonly="" id="ItemPackSKUQty" name="ItemPackSKUQty"
                           style="background-color: #f9f9f9;text-align: right"
                           value="<?php
                           if (empty($ItemPackSKUQty)) {
                               echo '';
                           } else {
                               echo number_format($ItemPackSKUQty, 4);
                           }
                           ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'ItemPackCost', ['showLabels' => false])->textInput([
                        'value' => empty($modeledit['ItemPackCost']) ? '' : number_format($modeledit['ItemPackCost'], 4),
                        'style' => 'background-color: white;text-align:right',
                    ])
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PROrderQty', ['showLabels' => false])->textInput([
                        'value' => empty($modeledit['PROrderQty']) ? '' : number_format($modeledit['PROrderQty'], 4),
                        'style' => 'background-color: white;text-align:right',
                        'required' => true,
                    ])
                    ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRUnitCost', ['showLabels' => false])->textInput([
                        'value' => empty($modeledit['PRUnitCost']) ? '' : number_format($modeledit['PRUnitCost'], 4),
                        'required' => true,
                        'style' => 'background-color: white;text-align:right',
                    ])
                    ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    $form->field($modeledit, 'PRExtendedCost', ['showLabels' => false])->textInput([
                        /*'readonly' => true,*/
                        'value' => empty($modeledit['PRExtendedCost']) ? '' : number_format($modeledit['PROrderQty'] * $modeledit['PRUnitCost'], 4),
                        'style' => 'background-color: #ffff99;text-align:right',
                    ])
                    ?>
                </div>
        ...
        <input type="hidden" id="vwpritemdetail2temp-ids_pr_selected" name="VwPritemdetail2Temp[ids_PR_selected]"
               value="<?php echo $modeledit['ids_PR_selected']; ?>"/>
        <input type="hidden" id="vwpritemdetail2temp-prid" name="VwPritemdetail2Temp[PRID]"
               value="<?php echo $modeledit['PRID']; ?>"/>
        <input type="hidden" id="vvwpritemdetail2temp-ids" name="VwPritemdetail2Temp[ids]"
               value="<?php echo $modeledit['ids']; ?>"/>
        <div class="col-md-12">
...
$(document).ready(function () {
        ...
        $("#vwpritemdetail2temp-itempackid").val(PackUnit).trigger("change");
...
$('#vwpritemdetail2temp-itempackid').on('change', function () {
    ...
    var qty = parseFloat($("#vwpritemdetail2temp-prpackqty").val().replace(/[,]/g, ""));//จำนวนแพค
    //var PRUnitCost = parseFloat($("#vwpritemdetail2temp-prunitcost").val().replace(/[,]/g, ""));//ราคาต่อหน่วย
    var itempackcost = parseFloat($("#vwpritemdetail2temp-itempackcost").val().replace(/[,]/g, ""));//ราคาต่อแพค
    $.ajax({
        url: "get-qtygpu",
        type: "post",
        ...
        success: function (data) {
            ...
            if (data.qty == 0) {
                $('#vwpritemdetail2temp-prorderqty').val('0.0000');
            } else {
...
$("#vwpritemdetail2temp-prorderqty").keyup(function () {
    ...
    var pritemavalible = parseFloat($("#vwpritemdetail2temp-pritemavalible").val().replace(/[,]/g, ""));
...
$("#vwpritemdetail2temp-prunitcost").keyup(function () {
    ...
    var pritemunitcost = parseFloat($("#vwpritemdetail2temp-pritemunitcost").val().replace(/[,]/g, ""));
    var pritemstdcost = parseFloat($("#vwpritemdetail2temp-pritemstdcost").val().replace(/[,]/g, ""));
...
//คำนวณราคาต่อแพค
$("#vwpritemdetail2temp-itempackcost").keyup(function () {/* ราคา/แพค */
    //$('input[id="vwpritemdetail2temp-itempackcost"]').priceFormat({prefix: ''});/* ราคา/แพค */
    var qty = $("#vwpritemdetail2temp-prorderqty").val().replace(/[,]/g, ""); /* ขอซื้อ */
    var uni = parseFloat($("#vwpritemdetail2temp-itempackcost").val().replace(/[,]/g, ""));/* ราคา/แพค */
    var orq = parseFloat($("#ItemPackSKUQty").val().replace(/[,]/g, ""));/* ปริมาณต่อแพค */
    var pritemunitcost = parseFloat($("#vwpritemdetail2temp-pritemunitcost").val().replace(/[,]/g, ""));
    if (orq > 0) {
        var jj = uni / orq;
        var ext = qty * jj;
        ...
        if (uni > 0) {
            ...
            $("#vwpritemdetail2temp-prunitcost").val('0.0000');
        }
    }
    if (pritemunitcost > 0) {
...
{
    //var pritemstdcost = parseFloat($("#vwpritemdetail2temp-pritemstdcost").val().replace(/[,]/g, ""));/* ราคากลาง */
    var pritemunitcost = parseFloat($("#vwpritemdetail2temp-pritemunitcost").val().replace(/[,]/g, ""));/* ราคาต่อหน่วยตามแผน */
    var prunitcost = parseFloat($("#vwpritemdetail2temp-prunitcost").val().replace(/[,]/g, ""));/* ราคาต่อหน่วยขอซื้อ */
    var pritemavalible = parseFloat($("#vwpritemdetail2temp-pritemavalible").val().replace(/[,]/g, ""));/* จำนวนที่ขอซื้อได้ */
    var prorderqty = parseFloat($("#vwpritemdetail2temp-prorderqty").val().replace(/[,]/g, ""));/* จำนวนที่ขอซื้อได้ */
    ...
    $.post(
            ...
            .done(function (result) {
                ...
                } else if (result == 'stdover') { /* กรณีที่จำนวนขอซื้อเกินจำนวนที่ขอซื้อได้ในแผน */
                    swal({
                        title: "ยืนยันข้อมูลขอซื้อ?",
                        text: "ราคาต่อหน่วย เกิน  ราคากลาง!",
                        type: "warning",
                            ...
                            function (isConfirm) {
                                if (isConfirm) {
                                    if (prorderqty > pritemavalible) {
                                        swal({
                                            title: "ยืนยันข้อมูลขอซื้อ?",
                                            text: "ปริมาณขอซื้อ เกิน เกินปริมาณที่ขอซื้อได้!",
                                            type: "warning",
                                            confirmButtonText: "Confirm",
                                            showCancelButton: true,
                                            closeOnConfirm: false,
...
$(document).ready(function () {
        var prpackqty = $("#vwpritemdetail2temp-prpackqty").val();
