        ...
        <div class="tab-content bg-white">
            <div id="home" class="tab-pane in active">
                <div class="tb-pr2-temp-index">
                    ...
                    <?php echo $this->render('_search_detail_approve', ['model' => $searchModel]); ?>
                    <?=
                    GridView::widget([
                            ...
                            [
                                ...
                                'buttons' => [
                                    ...
                                    if ($model->PRTypeID == 1 || $model->PRTypeID == 5 || $model->PRTypeID == 8) {//ยาสามัญ
                                        ...
                                        if ($action === 'view') {
                                            return Url::to(['new-pr-tpu/update-detail-approve', 'id' => $key, 'view' => 'false']);
                                        }
