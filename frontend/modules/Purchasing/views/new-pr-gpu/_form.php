                ...
                <div id="home" class="tab-pane in active">
                    <div class="well">
                        <div class="tb-pr2-form">
                            <?php
                            $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'id' => 'formtempnewgpu']);
                            ?>
                            ...
                            <div class="form-group" >
                                ...
                                <?= Html::activeLabel($modelPR, 'PRExpectDate', ['label' => 'กำหนดส่งสินค้า
' . '<font color="red"> *</font>','class' => 'col-sm-2 control-label no-padding-right']) ?>
                                <div class="col-sm-3">
                                    <?=
                            ...
                            <?php if ($view == '') { ?>
                                <div class="form-group">
                                    <?php \yii\widgets\Pjax::begin([ 'id' => 'gpu_detail_id']) ?>
                                    <?php
...
$(document).ready(function () {
  ...
  $('#getdatagpu').click(function (e) {
                ...
                $.ajax({
                url: 'index.php?r=Purchasing/new-pr-gpu/getdatagpu',
                        type: 'POST',
                        dataType: 'json',
...
function init_click_handlers() {
    $('.activity-update-link').click(function (e) {
        ...
        $.get(
                'index.php?r=Purchasing/new-pr-gpu/update-detailgpu',
                {
                    id: fID
                },
        function (data)
    ...
    $('.activity-delete-link').click(function (e) {
        var fID = $(this).closest('tr').data('key');
            ...
            swal({   
                ...
                $.post(
                        'index.php?r=Purchasing/new-pr-gpu/delete-detailgpu',
                        {
                            id: fID
                        },
                function (data)
...
$('#gpu_detail_id').on('pjax:success', function () {
    init_click_handlers(); //reactivate links in grid after pjax update
});
//On Save
    $('#formtempnewgpu').on('beforeSubmit', function(e)
    {
    wait();
    var \$form = $(this);
            $.post(
...
$(document).ready(function () {
                    $('#tbpr2temp-prtypeid').on('change', function () {
                        ...
                        $.ajax({
                            url: 'index.php?r=Purchasing/new-pr-gpu/get-reasongpu',
                            type: 'POST',
                            data: {PRType: PRType},
                            dataType: 'json',
                            success: function (data) {
    ...
    $('#SaveDraft').click(function (e) {
        ...
        //if (reasonid != "") {
            $.post(
                    'index.php?r=Purchasing/new-pr-gpu/save-reason',
                    {
    ...
    $('#Clear').click(function (e) {
        var PRID = $("#tbpr2temp-prid").val();
            ...
            swal({   
                ...
                $.post(
                        'index.php?r=Purchasing/new-pr-gpu/clear-gpu',
                        {
                            PRID: PRID
                        },
                function (data)
...
JS;
            ...
            <script>
                ...
                wait();
                $.ajax({
                url: 'index.php?r=Purchasing/new-pr-gpu/new-detailgpu',
                        type: 'POST',
                ...
                $.post(
                        'index.php?r=Purchasing/new-pr-gpu/sendtoverify',
                {
