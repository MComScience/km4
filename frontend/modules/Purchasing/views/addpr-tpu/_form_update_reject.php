...
<div class="well">
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <?= $form->field($modeledit, 'TMTID_GPU', ['showLabels' => false])->hiddenInput(['value' => $TMTID_GPU]) ?>
            <?= $form->field($modeledit, 'ItemID', ['showLabels' => false])->hiddenInput(['value' => $ItemID]) ?>
            <input type="hidden" id="vvwpritemdetail2-itempackunit" name="VwPritemdetail2[ItemPackUnit]" value="<?php echo $modeledit['ItemPackUnit']; ?>"/>
        </div>
        <div class="col-md-12">
...
$('#vwpritemdetail2-pcplannum').on('change', function () {
    ...
    if (PCPlanNum != '') {
        $.ajax({
            url: 'index.php?r=Purchasing/addpr-tpu/getdata-pcplangpu',
            type: 'POST',
            dataType: 'json',
...
$('#vwpritemdetail2-itempackid').on('change', function () {
    ...
    if (ItemPackUnit != '') {
        $.ajax({
            url: "index.php?r=Purchasing/addpr-tpu/get-qtytpu",
            type: "post",
...
$(document).ready(function () {
    ...
    var ItemPackUnit = $("#vvwpritemdetail2-itempackunit").val();
