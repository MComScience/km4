...
<div class="well">
    <div class="row">
        ...
        <input type="hidden" id="vwpritemdetail2temp-ids" name="VwPritemdetail2Temp[ids]" value="<?php echo $modeledit['ids']; ?>"/>
        <input type="hidden" id="vwpritemdetail2temp-tmtid_gpu" name="VwPritemdetail2Temp[TMTID_GPU]" value="<?php echo $modeledit['TMTID_GPU']; ?>"/>
        <div class="col-md-12">
...
$(document).ready(function () {
        ...
        var UnitCost = $('#vwpritemdetail2temp-prunitcost').val();
        ...
        $('#vwpritemdetail2temp-itempackid').on('change', function () {
            ...
            $.ajax({
                url: "index.php?r=Purchasing/new-pr-tpu/get-qtygpu",
                type: "post",
        ...
        $('#vwpritemdetail2temp-pcplannum').on('change', function () {
                    ...
                    $.ajax({
                        url: 'index.php?r=Purchasing/new-pr-tpu/getdata-pcplangpu',
                        type: 'POST',
                        dataType: 'json',
