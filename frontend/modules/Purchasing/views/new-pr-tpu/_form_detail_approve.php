...
if ($view == 'wating-verify') {
    ...
    $this->params['breadcrumbs'][] = ['label' => 'ขอซื้อยาการค้า', 'url' => ['list-verify']];
    $this->params['breadcrumbs'][] = $this->title;
} elseif ($view == 'false') {
   $this->title = 'อนุมัติใบขอซื้อยาการค้า';
    $this->params['breadcrumbs'][] = ['label' => 'อนุมัติใบขอซื้อยา', 'url' => ['new-pr-gpu/detail-approve']];
    $this->params['breadcrumbs'][] = $this->title;
    ...
    $this->params['breadcrumbs'][] = ['label' => 'ขอซื้อยาการค้า', 'url' => ['list-reject-verify']];
    $this->params['breadcrumbs'][] = $this->title;
}
?>
<div class="row">
                                ...
                                kartik\grid\GridView::widget([
                                    ...
                                    'columns' => [
                                        ...
                                        [
                                            ...
                                            'detailAnimationDuration' => 'slow', //fast
                                            'detailRowCssClass' => kartik\grid\GridView::TYPE_DEFAULT,
                                            'detailUrl' => \yii\helpers\Url::to(['view-detail-approve', 'view' => $view]),
                                        ],
//                            [
//                                'header' => 'ราคารวม',
//                                'attribute' => 'PRExtendedCost',
...
//                                                ],
                        ...
                        <div class="form-group" style="text-align: right">
                            <?php if ($view == 'false') { ?>
                                <?= Html::a('Close', ['new-pr-gpu/detail-approve'], ['class' => 'btn btn-default']) ?>
                                <!--<a class="btn btn-danger">Clear</a>-->
                                <a class="btn btn-warning" id="RejectApprove">Reject</a>
                                <a class="btn btn-info" id="SaveApprove">Approve PR</a>
        ...
        $script = <<< JS
//SaveApprove
    $('#SaveApprove').click(function (e) {
        var PRID = $("#tbpr2-prid").val();
        var PRNum = $("#tbpr2-prnum").val();
        var PRTotal = $("#tbpr2-prtotal").val();
//       alert (PRTotal);
//      var PRPackQtyVerify = $("#tbpr2-prnum").val();
//      var ItemPackCostVerify = $("#tbpr2-prnum").val();
//      var PRVerifyUnitCost = $("#tbpr2-prnum").val();
//      var PRVerifyQty = $("#tbpr2-prnum").val();
    ...
    $('#RejectApprove').click(function (e) {
        ...
        $('.modal-title').html('เหตุผลการ Reject Approve</h4>');
    });
