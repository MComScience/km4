...
//                            'format' => 'raw',
//                            'value' => function ($data) {
//                    //$url = "http://localhost/PHPJasperXML-master/PHPJasperXML-master/report_plan_nondrung.php?pcnum='" . base64_encode($data->PCPlanNum) . "'&&xxx=eb72f6d57529f23648026ea393deb262";
//                                $url = "http://www.udcancer.org/km4/backend/web/report/report_plan_nondrung.php?pcnum='" . base64_encode($data->PCPlanNum) . "'&&xxx=eb72f6d57529f23648026ea393deb262";
