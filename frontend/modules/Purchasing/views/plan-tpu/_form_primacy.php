...
<script>
    ...
    function showselectdata() {
        if ($('#inputEmail3').val() == "") {
            ...
            l.ladda('start');
            $.ajax({
                url: "index.php?r=Purchasing/plan-tpu/datapcplandrug",
                type: "post",
                success: function (d) {
                    $('#dataread').html(d);
    ...
    function saveprdetail() {
        if ($("#gpuunitCost").val() == "" || $("#gpuunitCost").val() < 0.01) {
            ...
            l.ladda('start');
            $.ajax({
                url: "index.php?r=Purchasing/plan-tpu/savedata",
                type: "post",
    ...
    function approve(type) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                l.ladda('start');
                $.ajax({
                    url: "index.php?r=Purchasing/plan-tpu/approve",
                    type: "post",
    ...
    function deletelistdrug(ids) {
        swal({
            ...
            if (isConfirm) {
                var prnums = $("#inputEmail3").val();
                $.ajax({
                    url: "index.php?r=Purchasing/plan-tpu/deletelistdrug",
                    type: "post",
    ...
    function editlistdrugpcplan(id) {
        $.ajax({
            url: "index.php?r=Purchasing/plan-tpu/editlistdrug",
            type: "post",
            data: {id: id},
            dataType: 'json',
            success: function (r) {
