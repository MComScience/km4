        ...
        <div class="well">
            ...
            <div class="form-group">
                <div align="right" style="margin-right: 10px">
                    ...
                    <?= Html::submitButton($model->isNewRecord ? 'Save Draft' : 'Save', ['class' => $model->isNewRecord ? 'btn btn-success ladda-button' : 'btn btn-success ladda-button', 'name' => 'aaa', ' data-style' => 'expand-left']) ?>
...
<script>
    function showselectdata() {
        if ($('#inputEmail3').val() == "") {
            ...
            l.ladda('start');
            $.ajax({
                url: "index.php?r=Purchasing/tbplandrugsale/form_main",
                type: "post",
            ...
            $.ajax({
                url: "index.php?r=Purchasing/tbplandrugsale/datapcplandrug",
                type: "post",
                success: function (d) {
                    $('#dataread').html(d);
    ...
    function saveprdetail() {
        if ($("#gpuunitCost").val() == "" || $("#gpuunitCost").val() < 0.01) {
            ...
            l.ladda('start');
            $.ajax({
                url: "index.php?r=Purchasing/tbplandrugsale/savedata",
                type: "post",
    ...
    function myFunpcplanbydrug(id) {
        ...
        $.ajax({
            url: "index.php?r=Purchasing/tbplandrugsale/getdata",
            type: "post",
    ...
    function savepcplanbymainform() {
        $.ajax({
            url: "index.php?r=Purchasing/pcplanbydrugsale/savedaff",
            type: "post",
    ...
    function saveactive() {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                $.ajax({
                    url: "index.php?r=Purchasing/tbplandrugsale/saveactive",
                    type: "post",
                    data: {id: id},
                    dataType: 'json',
                    success: function (result) {
                        ...
                        setTimeout("location.href = 'index.php?r=Purchasing/tbplandrugsale';", 2000);
                    }
                });
            }
        }
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                var l = $('.ladda-button').ladda();
                    l.ladda('start');
                $.ajax({
                    url: "index.php?r=Purchasing/tbplandrugsale/send-to-approve",
                    type: "post",
                    data: {id: id},
                    dataType: 'json',
                    success: function (result) {
    ...
    function deletelistdrug(ids) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                var prnums = $("#inputEmail3").val();
                $.ajax({
                    url: "index.php?r=Purchasing/tbplandrugsale/deletelistdrug",
                    type: "post",
    ...
    function editlistdrugpcplan(id) {
        $.ajax({
            url: "index.php?r=Purchasing/tbplandrugsale/editlistdrug",
            type: "post",
            data: {id: id},
            dataType: 'json',
            success: function (r) {
