                                        ...
                                        kartik\grid\GridView::widget([
                                            ...
                                            'columns' => [
                                                ...
                                                [
                                                    ...
                                                    'detailUrl' => \yii\helpers\Url::to(['view-detailtpu']),
                                                ...
                                                [
                                                    ...
                                                    'hAlign' => kartik\grid\GridView::ALIGN_CENTER,
                                                    'value' => function ($model) {
                                                        if ($model->dispunit->DispUnit_TMT == NULL) {
                                                            return '-';
                                                        } else {
                                                            return $model->dispunit->DispUnit_TMT;
                                                        }
                                                    }
                                                ],
                                                [
...
//แก้ไขข้อมูล
        $('.activity-edit-link').click(function (e) {
                ...
                $.get(
                        'index.php?r=Purchasing/po/editpo-detailtpu',
                        {
                            ids: ids
                        },
                function (data)
