...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="">
            <?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'id' => 'form_edit_po_detail_verify1']); ?>

            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <?= Html::activeLabel($modeledit, 'ItemID', ['class' => 'col-sm-3 control-label no-padding-righ']) ?>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group">
                        <?= Html::activeLabel($modeledit, 'TMTID_TPU', ['class' => 'col-sm-3 control-label no-padding-righ']) ?>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-righ">รายการสินค้า</label>
                        <div class="col-sm-8">
                            <?=
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-righ"></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-righ">จำนวนแพค <a id="checkจำนวนแพค"></a></label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-righ">หน่วยแพค <a id="checkหน่วยแพค"></a></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" >
                        <label class="col-sm-3 control-label no-padding-righ">ปริมาณ/ต่อแพค</label>
                        <div class="col-sm-8">
                    ...
                    <br>
                    <div class="form-group" >
                        <label class="col-sm-3 control-label no-padding-righ">ราคา/แพค <a id="checkราคาต่อแพค"></a></label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group" >
                        <label class="col-sm-3 control-label no-padding-righ">ขอซื้อ <a id="checkขอซื้อ"></a></label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group" >
                        <label class="col-sm-3 control-label no-padding-righ">หน่วย</label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group" >
                        <label class="col-sm-3 control-label no-padding-righ">ราคา/หน่วย <a id="checkราคาต่อหน่วย"></a></label>
                        <div class="col-sm-8">
                            <?=
                    ...
                    <div class="form-group" >
                        <label class="col-sm-3 control-label no-padding-righ">รวมเป็นเงิน</label>
                        <div class="col-sm-8">
                            <?=
                     ...
                     <?=
                    $form->field($modeledit, 'PONum', ['showLabels' => false])->hiddenInput([
                        'readonly' => true,
                    ])
                    ?>
                     <?=
                    $form->field($modeledit, 'PRNum', ['showLabels' => false])->hiddenInput([
                        'readonly' => true,
                    ])
                    ?>
...
$(document).ready(function () {
    ...
    $('#form_edit_po_detail_verify1').on('beforeSubmit', function (e)
    {
