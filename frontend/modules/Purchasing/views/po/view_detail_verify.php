                ...
                DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'attribute' => 'PackUnit',
                            'label' => 'หน่วยแพค',
                            'value' => $model->dataonview->PRPackunit != null ? $model->dataonview->PRPackunit : '-',
                        ],
                        [
                            'attribute' => 'ItemPackSKUQty',
                            'label' => 'ปริมาณ/แพค',
                            'value' => $model->dataonview->ItemPackSKUQty != 0.00 ? number_format($model->dataonview->ItemPackSKUQty,2) : '-',
                        ...
                        [
                            'attribute' => 'DispUnit',
                            'value' => $model->dataonview->DispUnit != null ? $model->dataonview->DispUnit : '-',
                            'label' => 'หน่วย',
                            'format' => 'html',
                        ],
                        [
