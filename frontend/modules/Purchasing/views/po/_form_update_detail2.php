                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="radio">
                                <label class="radio-inline"><input type="radio" name="PackChin" value="1" id="แพค"> <span class="text">แพค  </span></label>
                                <label class="radio-inline"><input type="radio" name="PackChin" value="0" id="ชิ้น"> <span class="text">ชิ้น  </span></label>
                            </div> 
                        </div>
                    </div>
...
$script = <<< JS
    ...
    $('#vwpo2subpr2detail-poitempackid').on('change', function () {
        ...
        //var popackcostapprove = parseFloat($("#vwpo2subpr2detail-popackcostapprove").val().replace(/[,]/g, ""));//ราคาต่อแพค
