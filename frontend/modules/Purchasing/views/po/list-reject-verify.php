...
$this->title = 'ใบสั่งซื้อไม่ผ่านการทวนสอบ';
            ...
            <div class="tab-content">
                <div id="tab" class="tab-pane in active ">
                    <div class="tb-po2-temp-index">
                        ...
                        <?php echo $this->render('_search', ['model' => $searchModel,'action' => 'list-reject-verify']); ?>
                        <p></p>
                        <?=
                        GridView::widget([
                                    ...
                                    'buttons' => [
                                        ...
                                        'view' => function ($url, $model) {
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                            	$encode = base64_encode($model->PONum);
                                        if ($action === 'view') {
                                            return Url::to(['update-reject-verify', 'id' => $key, 'view' =>$encode]);
                                        }
                                    }
                                        ],
                                    ],
