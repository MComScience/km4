        ...
        <div class="well">
                ...
                <div class="col-sm-6">
                    ...
                    $form->field($model, 'SectionID')->widget(DepDrop::classname(), [
                        ...
                        'pluginOptions' => [
                            ...
                            'url' => \yii\helpers\Url::to(['getsection'])
                        ]
            ...
            <div class="form-group">
                <div align="right" style="margin-right: 10px">
                    ...
                    <?= Html::submitButton($model->isNewRecord ? 'Save Draft' : 'Save', ['class' => $model->isNewRecord ? 'btn btn-success ladda-button' : 'btn btn-success ladda-button', 'name' => 'aaa', ' data-style' => 'expand-left', 'id' => 'drafsave',]) ?>
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                setTimeout("location.href = 'index.php?r=Purchasing/plansale-tpu';", 10);
                            }
                        });
                    }
                }
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                setTimeout("location.href = '/km4/Purchasing/plansale-tpu/index';", 10);
                            }
                        });
                    }
                }
