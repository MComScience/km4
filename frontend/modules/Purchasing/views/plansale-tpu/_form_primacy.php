...
<script>
    function showselectdata() {
        if ($('#inputEmail3').val() == "") {
            ...
            l.ladda('start');
            $.ajax({
                url: "index.php?r=Purchasing/plandrugsale-tpu/datapcplandrug",
                type: "post",
                success: function (d) {
                    $('#dataread').html(d);
    ...
    function saveprdetail() {
        if ($("#gpuunitCost").val() == "" || $("#gpuunitCost").val() < 0.01) {
            ...
            l.ladda('start');
            $.ajax({
                url: "index.php?r=Purchasing/plandrugsale-tpu/savedata",
                type: "post",
    ...
    function myFunpcplanbydrug(id) {
        ...
        $.ajax({
            url: "index.php?r=Purchasing/plandrugsale-tpu/getdata",
            type: "post",
    ...
    function saveactive() {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                $.ajax({
                    url: "index.php?r=Purchasing/plandrugsale-tpu/saveactive",
                    type: "post",
                    data: {id: id},
                    dataType: 'json',
                    success: function (result) {
                        ...
                        setTimeout("location.href = 'index.php?r=Purchasing/plandrugsale-tpu';", 10);
                    }
                });
            }
        }
    ...
    function sendtoapprove() {
        ...
        function (isConfirm) {
            if (isConfirm) {
                var id = $("#inputEmail3").val();
                $.ajax({
                    url: "index.php?r=Purchasing/plandrugsale-tpu/send-to-approve",
                    type: "post",
                    data: {id: id},
                    dataType: 'json',
                    success: function (result) {
    ...
    function approve(type) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                l.ladda('start');
                $.ajax({
                    url: "index.php?r=Purchasing/plandrugsale-tpu/approve",
                    type: "post",
    ...
    function deletelistdrug(ids) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                var prnums = $("#inputEmail3").val();
                $.ajax({
                    url: "index.php?r=Purchasing/plandrugsale-tpu/deletelistdrug",
                    type: "post",
    ...
    function editlistdrugpcplan(id) {
        $.ajax({
            url: "index.php?r=Purchasing/plandrugsale-tpu/editlistdrug",
            type: "post",
            data: {id: id},
            dataType: 'json',
            success: function (r) {
