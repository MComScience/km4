...
class VwPo2Detail2New extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['PRPackQtyApprove', 'PRPackCostApprove', 'PRApprovedOrderQty', 'PRApprovedUnitCost', 'POPackQtyApprove', 'POPackCostApprove', 'POApprovedUnitCost', 'POApprovedOrderQty', 'PRQty', 'PRUnitCost', 'PRExtenedCost', 'POQty', 'POUnitCost', 'POExtenedCost'], 'number'],
