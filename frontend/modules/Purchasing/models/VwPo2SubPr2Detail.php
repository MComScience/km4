...
/**
 * This is the model class for table "vw_po2_sub_pr2_detail".
 *
 ...
 */
class VwPo2SubPr2Detail extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['POID', 'POItemNum', 'ItemID', 'TMTID_GPU', 'TMTID_TPU', 'POCreatedBy', 'ItemPackUnit', 'ItemPackID', 'ids'], 'integer'],
            [['PONum', 'PRNum', 'PCPlanNum', 'itemDispUnit'], 'string', 'max' => 50],
            [['ItemDetail', 'PRApprovedUnitCost', 'POPackCostApprove'], 'string', 'max' => 255],
            [['DispUnit', 'PackUnit'], 'string', 'max' => 45],
            [['POExtenedCost','PRPackQtyApprove', 'PRPackCostApprove', 'PRApprovedOrderQty', 'POPackQtyApprove'],'safe']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ItemDetail' => Yii::t('app', 'รายการสินค้า'),
