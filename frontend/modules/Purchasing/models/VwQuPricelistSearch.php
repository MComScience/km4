...
use app\modules\Purchasing\models\VwQuPricelist;

/**
 * VwQuPricelistSearch represents the model behind the search form about `app\modules\Purchasing\models\VwQuPricelist`.
 */
class VwQuPricelistSearch extends VwQuPricelist
{
    ...
    {
        $query = VwQuPricelist::find()->where(['ItemID' => $ItemID,'ItemCatID' => 2]);
