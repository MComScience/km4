...
class VwPritemdetail2TempNew extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ids', 'ItemID', 'TMTID_GPU', 'TMTID_TPU', 'PRItemOrderQty', 'PRApprovedOrderQtySum', 'PRItemAvalible', 'PROrderQty', 'PRApprovedUnitCost', 'PRApprovedOrderQty', 'ItemPackID', 'ItemPackUnit', 'ItemPackDefault', 'PRItemNumStatusID', 'PRItemOnPCPlan', 'PRCreatedBy', 'ids_PR_selected', 'ItemPackIDVerify'], 'integer'],
            [['ItemName'], 'string'],
            [['PRItemStdCost', 'PRItemUnitCost', 'PRVerifyUnitCost', 'PRVerifyQty', 'PRPackQty', 'ItemPackCost', 'ItemPackSKUQty', 'PRPackQtyVerify', 'ItemPackCostVerify', 'PRPackQtyApprove', 'ItemPackCostApprove', 'ItemPackIDApprove', 'PRQty', 'VerifyQty', 'VerifyUnitCost', 'ExtenedCost'], 'number'],
            [['PRNum', 'PCPlanNum'], 'string', 'max' => 50],
            [['PRUnitCost', 'PRUnitCost2', 'PRExtendedCost'], 'string', 'max' => 255],
