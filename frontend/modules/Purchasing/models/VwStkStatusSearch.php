...
use app\modules\Purchasing\models\VwStkStatus;

/**
 * VwStkStatusSearch represents the model behind the search form about `app\modules\Purchasing\models\VwStkStatus`.
 */
