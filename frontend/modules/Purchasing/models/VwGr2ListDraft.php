...
/**
 * This is the model class for table "vw_gr2_list_draft".
 *
 ...
 */
class VwGr2ListDraft extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['POType', 'GRStatusDesc'], 'required'],
            [['GRNum', 'VenderInvoiceNum', 'GRStatusDesc'], 'string', 'max' => 50],
            [['PONum'], 'string', 'max' => 20],
