...
use app\modules\Purchasing\models\VwPurchasingHistory;

/**
 * VwPurchasingHistorySearch represents the model behind the search form about `app\modules\Purchasing\models\VwPurchasingHistory`.
 */
