...
class TbPoitemdetail2Temp extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['POItemNum', 'ItemID', 'TMTID_GPU', 'TMTID_TPU', 'ItemPackID', 'POItemPackID', 'POApprovedUnitCost', 'POApprovedOrderQty', 'POItemNumStatusID', 'POCreatedBy', 'POItemType', 'POID'], 'integer'],
            [['PRPackQtyApprove', 'PRPackCostApprove', 'PRApprovedOrderQty', 'POPackQtyApprove'], 'number'],
            [['PONum', 'PRNum', 'PCPlanNum'], 'string', 'max' => 50],
            [['ItemName', 'PRApprovedUnitCost', 'POPackCostApprove'], 'string', 'max' => 255]
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'POItemPackID' => Yii::t('app', 'หน่วยแพค'),
            'POApprovedUnitCost' => Yii::t('app', 'ราคา/หน่วย'),
            'POApprovedOrderQty' => Yii::t('app', 'จำนวนสั่งซื้อ'),
    ...
    {
        return $this->hasOne(VwPo2SubPr2Detail::className(), ['ids' => 'ids']);
    }
}
