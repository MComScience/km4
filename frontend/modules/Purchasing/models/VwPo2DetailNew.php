...
class VwPo2DetailNew extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ids', 'POItemNum', 'ItemID', 'TMTID_GPU', 'TMTID_TPU', 'POID', 'POItemType', 'ItemPackID', 'POItemPackID', 'POApprovedOrderQty'], 'integer'],
            [['PRPackQtyApprove', 'PRPackCostApprove', 'PRApprovedOrderQty', 'PRApprovedUnitCost', 'POPackQtyApprove', 'POApprovedUnitCost', 'PRQty', 'PRUnitCost', 'PRExtenedCost', 'POQty', 'POExtenedCost'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'PRPackunit' => Yii::t('app', 'หน่วยของแพค'),
