...
<div class="clearfix"></div>
HTML;
$this->title = 'ใบสั่งยารอจัด';
$this->params['breadcrumbs'][] = ['label' => 'dispense', 'url' => ['list-wait-pharmacy']];
$this->params['breadcrumbs'][] = ['label' => 'จัดยา', 'url' => ['list-wait-pharmacy']];
$this->params['breadcrumbs'][] = $this->title;
?>

<ul class="nav nav-tabs" id="myTab">
    <li class="active">
        <?= Html::a('ใบสั่งยารอจัดยา', ['index']) ?>
        </a>
    </li>
</ul>
        ...
        fedemotta\datatables\DataTables::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'header' => 'Actions',
                    'contentOptions' => ['class' => 'text-center'],
                    'template' => '{verify-pharmacy}',
                    'buttons' => [

                        'verify-pharmacy' => function ($url, $model, $key) {
                            return Html::a('<span class="btn btn-success btn-xs btn-group"> Verify </span>', $url, [
