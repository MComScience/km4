...
$avatar = ($userAvatar = $header->getAvatar($header->cpoe_id)) ? $userAvatar : $header->getAvatar(NULL);
?>
                ...
                <div class="invoice-container">
                    <ul>
                        <div class="row">
                            ...
                            <li class="pull-right">
                                <?=
                                Html::a('<i class="glyphicon glyphicon-list-alt"></i>' . 'Detail', ['ardetail', 'vn_number' => $header['pt_vn_number']], ['role' => 'modal-remote', 'class' => 'btn btn-info  btn-xs'])
                                ?>
                                &nbsp;
                            </li>
                        </div>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            <tr width="33.3%" style="height: 40px;">
                                                ...
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">80/120</b>
                                                </td>
                                                <td class="text-center">Pulse:</td>
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">150</b>
                                                </td>
                                                <td class="text-center">BT(C):</td>
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">36.7</b>
                                                </td>
                                            </tr>
                                            <tr width="33.3%" style="height: 40px">
                                                <td class="text-center">Wt(kg.):</td>
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">65</b>
                                                </td>
                                                <td class="text-center">Ht(cm.):</td>
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">165</b>
                                                </td>
                                                <td class="text-center">SpO2(%):</td>
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">95</b>
                                                </td>
                                            </tr>
                                            <tr width="33.3%" style="height: 40px">
                                                <td class="text-center">BSA</td>
                                                <td>
                                                    <b class="pink" style="font-size: 14pt;">xxx</b>
                                                </td>
