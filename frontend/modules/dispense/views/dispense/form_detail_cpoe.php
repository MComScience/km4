...
$this->params['breadcrumbs'][] = ['label' => 'รายละเอียดใบสั่งยา', 'url' => ['/cpoe/default/index']];
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <textarea name="" rows="3" class="form-control" style="background-color:#ffff99"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-warning">Adj Requestion</button>
      </div>
    </div>
  </div>
</div>