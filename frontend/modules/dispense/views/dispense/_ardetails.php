...
$avatar = ($userAvatar = $profile->getAvatar($profile->cpoe_id)) ? $userAvatar : $profile->getAvatar(NULL);
?>
<style>
            ...
            <tbody>
                <?php foreach ($ardetails as $items) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <?= !empty($items->refer_hsender_doc_start)? Yii::$app->formatter->asDate($items->refer_hsender_doc_start,'php:d/m/Y') :'-'; ?>
                        </td>
                        <td class="text-center">
                            <?= !empty($items->refer_hsender_doc_expdate) ? Yii::$app->formatter->asDate($items->refer_hsender_doc_expdate,'php:d/m/Y') :''; ?>
                        </td>
                        <td class="text-center">
                            <?= $items->pt_ar_usage; ?>
                        </td>
