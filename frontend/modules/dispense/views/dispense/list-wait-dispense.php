				...
				<div class="tb-item-index">
                    ...
                    //'contentOptions' => ['class' => 'text-center'],
						...
						'issue' => function ($url, $model, $key) {
							return Html::a('<span class="btn btn-success btn-xs btn-group"> ISSUE </span>', $url, [
