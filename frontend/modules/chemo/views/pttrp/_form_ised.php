...
<div class="col-xs-12 col-sm-6 col-md-12">
    ...
    <ul class="list-group">
        <li class="list-group-item" style="background-color: #ddd">
            <b><?= Html::encode('Item Detail : '); ?></b><span class="text"><text class="itemdetail"></text></span>
        </li>
    </ul>
...
<script>
    ...
    $("button[id=clearstebised]").click(function () {
        $('#form_ised').trigger("reset"); //Reset Form id = form_ised
        $('input[id=tbdrugsetdetail-cpoe_narcotics_confirmed]').val(null);
        $('input[id=tbdrugsetdetail-ised]').val(null);
    ...
    $("input[id=cpoe_narcotics_confirmed]").click(function () {
        ...
        {
            $('#msgised2').html('');
            $('input[id=tbdrugsetdetail-cpoe_narcotics_confirmed]').val('1');
    ...
    $("input[name=isedreason]").click(function () {
        if ($(this).is(":checked"))
        {
            $('input[id=tbdrugsetdetail-ised_reason]').val($(this).val());
            ...
            $('input[id=tbdrugsetdetail-ised_reason]').val(null);
        }
    });
</script>