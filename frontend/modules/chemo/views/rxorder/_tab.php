...
$("#treatment").click(function (e) {               
    window.location.replace("index.php?r=chemo/pttrp/treatmentindex&hn=$header->pt_hospital_number&vn=$header->pt_visit_number");
});
$("#Patient").click(function (e) {               
    window.location.replace("index.php?r=chemo/pttrp/index&id=$header->pt_visit_number");
});
