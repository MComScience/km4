...
class TbCpoeDetail extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['cpoe_ids'], 'required'],
            [['cpoe_ids', 'cpoe_seq', 'cpoe_id', 'cpoe_parentid', 'cpoe_level', 'cpoe_drugset_id', 'cpoe_Itemtype', 'cpoe_rxordertype', 'ItemID', 'cpoe_narcotics_confirmed', 'cpoe_ItemStatus', 'cpoe_route_id', 'cpoe_prn_with_stat', 'cpoe_stat', 'cpoe_period', 'cpoe_period_value', 'cpoe_period_unit', 'cpoe_frequency', 'cpoe_frequency_unit', 'cpoe_dayrepeat', 'cpoe_dayrepeat_mon', 'cpoe_dayrepeat_tue', 'cpoe_dayrepeat_wed', 'cpoe_dayrepeat_thu', 'cpoe_dayrepeat_fri', 'cpoe_dayrepeat_sat', 'cpoe_dayrepeat_sun', 'cpoe_once', 'cpoe_repeat', 'cpoe_drugrouteid', 'cpoe_drugprandialadviceid', 'cpoe_verifyby', 'cpoe_checkby', 'cpoe_issueby', 'cpoe_seq_mindelay', 'chemo_regimen_ids'], 'safe'],
