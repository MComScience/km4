...
/**
 * TbCpoeSearch represents the model behind the search form about `app\modules\chemo\models\TbCpoe`.
 */
class TbCpoeSearch extends TbCpoe
{
    ...
    {
        return [
            [['cpoe_id', 'cpoe_schedule_type', 'cpoe_type', 'pt_vn_number', 'cpoe_order_by', 'cpoe_order_section', 'cpoe_status', 'cpoe_createby', 'pt_trp_chemo_id', 'chemo_regimen_ids', 'chemo_cycle_seq', 'chemo_cycle_day'], 'integer'],
