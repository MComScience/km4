...
/**
 * VwPtTrpChemoSearch represents the model behind the search form about `app\modules\chemo\models\VwPtTrpChemo`.
 */
class VwPtTrpChemoSearch extends VwPtTrpChemo {
    ...
    public function rules() {
        return [
            [['pt_trp_chemo_id', 'pt_hospital_number', 'medical_right_id', 'credit_group_id', 'pt_trp_regimen_status', 'pt_trp_regimen_createby'], 'integer'],
            [['pt_trp_regimen_name', 'pt_trp_regimen_id', 'pt_trp_credit_id', 'pt_trp_regimen_paycode', 'pt_trp_cpr_number', 'pt_trp_ocpa_number', 'pt_trp_comment', 'pt_visit_number'], 'safe'],
        ];
    }
     ...
     */
    public function search($params, $hn, $vn) {
        $query = VwPtTrpChemo::find()
                ->where(['pt_hospital_number' => $hn, 'pt_visit_number' => $vn]);
        ...
        $query->andFilterWhere(['like', 'pt_trp_regimen_name', $this->pt_trp_regimen_name])
                ...
                ->andFilterWhere(['like', 'pt_visit_number', $this->pt_visit_number])
