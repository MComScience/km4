...
class PttrpController extends Controller {
    ...
    public function actionTreatmentindex($hn, $vn) {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, $hn,$vn);
...
//        }
    ...
    public function actionSavetreatmentHeader() {
        ...
        if ($request->isPost) {
            ...
            Yii::$app->db->createCommand('CALL cmd_cpoe_trp_save(:pt_trp_chemo_id,:pt_trp_regimen_name,:medical_right_id,:pt_trp_cpr_number,:pt_trp_ocpa_number,:pt_trp_regimen_paycode,:pt_trp_comment);')
    ...
    public function actionEditIvsolution() {
        ...
        if ($request->isAjax) {
            ...
            $invmodel = VwIvsolutionDrugsetDetail::find()->where(['cpoe_parentid' => $id])->all();
            return $this->renderAjax('_formiv', [
                        'invmodel' => $invmodel,
                        'drugset_ids' => $id,
    ...
    public function actionCreateRxorder($ids, $vn) {
        ...
        Yii::$app->db->createCommand('CALL cmd_pt_chemo_rxorder_create(:chemo_regimen_ids,:pt_vn_number,:userid,:cpoe_id);')
                ...
                ->execute();
        return $this->redirect(['/chemo/rxorder/create', 'id' => $cpoe_id, 'vn' => $vn]);
    }
