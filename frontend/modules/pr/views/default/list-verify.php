...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="profile-container">
            <?php echo $this->render('dashboard_pharmacy', ['title' => 'หัวหน้าเภสัชกรรม']); ?>
            <div class="profile-body">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="tabbable">
                        <?php echo $this->render('_tab_pharmacy'); ?>
                                ...
                                <div class="row profile-overview">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        GridView::widget([
                                            ...
                                            'toolbar' => [
                                                /* ['content' =>
                                                  Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['list-verify'], ['class' => 'btn btn-default','data-pjax' => 0])
                                                  ], */
                                                '{toggleData}',
                                            ],
                                            'columns' => [
                                                    ...
                                                    'urlCreator' => function ($action, $model, $key, $index) {
                                                        if ($model->PRTypeID == 1) {//ยาสามัญ
                                                            if ($action === 'select') {
                                                                return Url::to(['/pr/gpu/verify-pr', 'data' => $key]);
                                                            }
                                                        } elseif ($model->PRTypeID == 2) {//ยาการค้า
                                                            if ($action === 'select') {
                                                                return Url::to(['/pr/tpu/verify-pr', 'data' => $key]);
                                                            }
                                                        } elseif ($model->PRTypeID == 3) {//เวชภัณฑ์
                                                            if ($action === 'select') {
                                                                return Url::to(['/pr/nd/verify-pr', 'data' => $key]);
                                                            }
                                                        } elseif ($model->PRTypeID == 4) {
                                                            if ($action === 'select') {
                                                                return Url::to(['/pr/tpu-cont/verify-pr', 'data' => $key]);
                                                            }
                                                        } elseif ($model->PRTypeID == 5) {
                                                            if ($action === 'select') {
                                                                return Url::to(['/pr/nd-cont/verify-pr', 'data' => $key]);
                                                            }
                                                        }
                                                    }
                                                ],
