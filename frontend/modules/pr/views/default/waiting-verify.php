                        ...
                        [
                            ...
                            'urlCreator' => function ($action, $model, $key, $index) {
                                if ($model->PRTypeID == 1) {//ยาสามัญ
                                    if ($action === 'detail') {
                                        return Url::to(['/pr/gpu/view-verify', 'data' => $key]);
                                    }
                                } elseif ($model->PRTypeID == 2) {//ยาการค้า
                                    if ($action === 'detail') {
                                        return Url::to(['/pr/tpu/view-verify', 'data' => $key]);
                                    }
                                } elseif ($model->PRTypeID == 3) {//เวชภัณฑ์
                                    if ($action === 'detail') {
                                        return Url::to(['/pr/nd/view-verify', 'data' => $key]);
                                    }
                                } elseif ($model->PRTypeID == 4) {
                                    if ($action === 'detail') {
                                        return Url::to(['/pr/tpu-cont/view-verify', 'data' => $key]);
                                    }
                                } elseif ($model->PRTypeID == 5) {
                                    if ($action === 'detail') {
                                        return Url::to(['/pr/nd-cont/view-verify', 'data' => $key]);
                                    }
                                }
                            }
                        ],
