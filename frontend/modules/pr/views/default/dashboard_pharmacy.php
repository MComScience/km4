...
<div class="profile-header row">
    ...
    <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
        <div class="header-fullname"><?= Html::encode($title) ?></div>
        <div class="header-information">
            <?= Html::encode('User ID : ') . Yii::$app->user->identity->profile->user_id; ?>
        </div>
        <div class="header-information">
            <?= Html::encode('User Name : ') . Yii::$app->user->identity->profile->User_fname.' '.Yii::$app->user->identity->profile->User_lname; ?>
        </div>
        <div class="header-information">
            <i class="fa fa-phone orange"></i> <span> : <?php echo Yii::$app->user->identity->profile->User_mobilephone; ?></span>
        </div>
    </div>
