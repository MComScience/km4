...
if ($type == 'edit' || $type == 'new') {
        ...
        'buttons' => [
            'update' => function ($url, $model, $key) {
                ...
                return Html::button(Icon::show('edit') . Yii::t('app', 'Edit'), [
                            'class' => 'btn btn-info btn-xs activity-update-link',
                            'title' => Yii::t('app', 'Edit'),
                            'data-toggle' => 'modal',
                            'data-id' => $key,
                            'data-pjax' => '0',
    ...
    $ButtonSelect = Html::button(Icon::show('plus') . 'เลือกรายการเวชภัณฑ์', ['disabled' => true, 'class' => 'btn btn-success',]);
...
<?php if ($action == 'view' || $action == 'update' || $action == 'update-reject-verify' || $action == 'view-reject-verify') : ?>
