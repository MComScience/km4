            ...
            <div class="widget-body">
                ...
                <div class="tb-pr2-temp-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3"> 
                            ...
                            $form->field($model, 'PRTypeID', ['showLabels' => false])->widget(Select2::classname(), [
                                'data' => ['2' => 'ขอซื้อยาการค้า']/* ArrayHelper::map(TbPrtype::find()->where(['PRTypeID' => '1'])->all(), 'PRTypeID', 'PRType') */,
                                'language' => 'en',
                    ...
                    <div class="form-group">
                        ...
                        <?= Html::activeLabel($model, 'PRExpectDate', ['label' => 'กำหนดเวลาการส่งมอบ', 'class' => 'col-sm-2 control-label no-padding-right', 'style' => 'color:black;']) ?>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group" style="text-align: right;">
                        <div class="col-sm-12">
                            ...
                            <?php if ($type == 'verify') : ?>
                                ...
                                <?= Html::button(Icon::show('share-alt', [], Icon::BSG) . 'Verify & AutoApprove', ['class' => 'btn btn-primary auto-approve', 'type' => 'button', 'disabled' => $model['PRStatusID'] == '5' ? false : true, 'title' => 'Verify & AutoApprove', 'id' => 'btn-approve']); ?>
                            <?php endif; ?>
                        </div>
                    </div>
