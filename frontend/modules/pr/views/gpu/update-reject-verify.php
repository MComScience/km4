...
$this->title = Yii::t('app', '{modelClass} ', [
            'modelClass' => 'ใบขอซื้อยาสามัญไม่ผ่านการทวนสอบ',
        ]);
            ...
            <div class="widget-body">
                ...
                <div class="tb-pr2-temp-form">
                    ...
                    <div class="form-group">
                        ...
                        <?= Html::activeLabel($model, 'PRExpectDate', ['label' => 'วัน', 'class' => 'col-sm-0 control-label no-padding-right', 'style' => 'color:black;']) ?>
                    </div>
