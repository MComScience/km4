                ...
                <div class="tb-pr2-temp-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2" style="text-align: right;">
                            <?php /*
                              ...
                              . '</div>',
                              'footer' => false,
                              'toggleButton' => ['label' => Icon::show('cog', [], Icon::BSG), 'class' => 'btn btn-primary', 'title' => 'Setting'],
                              ]); */
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-3">
                            ...
                            ?>
                            <?php /*
                              echo $form->field($model, 'PRDate',['showLabels' => false])->widget(DatePicker::classname(), [
                        ...
                        <div class="col-sm-2">
                            <?= Html::input('text', 'Auto-Gen', '', ['type' => 'hidden', 'id' => 'auto-genprnum-gpu', 'value' => '', 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            echo $form->field($model, 'POTypeID', ['showLabels' => false])->widget(Select2::classname(), [
                                'data' => ['1' => 'ตกลงราคา', '2' => 'ประกวดราคา']/* ArrayHelper::map(TbPotype::find()->where(['POTypeID' => [1, 2]])->all(), 'POTypeID', 'POType') */,
                                'language' => 'en',
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <?= $form->field($model, 'PRExpectDate', ['showLabels' => false])->input('number', ['min' => 0, 'style' => 'background-color:#ffff99', 'required' => true, 'placeholder' => 'จำนวนวัน']);
                            ?>
                        </div>
