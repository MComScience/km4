...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <?php // echo $this->render('config', ['action' => 'update-verify-gpu']); ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                $form->field($model, 'PRLastUnitCost', ['showLabels' => false])->textInput([
                    ...
                    'readonly' => true,
                    'value' => number_format($model['PRLastUnitCost'], 4)
                ])
                ?>
            </div>
        ...
        <div class="col-md-12">
            <div class="modal-footer">
                <?= Html::button(Icon::show('remove', [], Icon::BSG) . 'Close', ['class' => 'btn btn-default', 'data-dismiss' => 'modal', 'title' => 'Close']); ?>
...
<script type="text/javascript">
    ...
    $("#tbpritemdetail2-prpackqty").keyup(function () {
        ...
        var prunitcost = parseFloat($("#tbpritemdetail2-prunitcost").val().replace(/[,]/g, ""));
                        ...
                        swal({
                            ...
                            closeOnCancel: true,
                                ...
                                function (isConfirm) {
                                    if (isConfirm) {
                                        l.ladda('stop');
                                        $.pjax.reload({container: '#verify_gpu_pjax'});
