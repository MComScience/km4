...
if ($type == 'edit' || $type == 'new') {
    $ButtonSelect = Html::a(Icon::show('plus') . 'เลือกยาการค้า', 'javascript:void(0);', ['class' => 'btn btn-success', 'onclick' => 'GetModalTableTPU(this);', 'title' => 'เลือกรายการยาการค้า']);
...
<?php if ($action == 'update' || $action == 'update-reject-verify' || $action == 'view' || $action == 'view-reject-verify') : ?>
    <div class="form-group">
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <?php Pjax::begin(['id' => 'detail_tpu_pjax']) ?>
            <?=
            GridView::widget([
...
<?php if ($action == 'verify-pr' || $action == 'view-verify' || $action == 'approve-pr') : ?>
    ...
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <?php Pjax::begin(['id' => 'verify_tpu_pjax']) ?>
            <?=
            GridView::widget([
                'dataProvider' => $dataProvider,
                'showPageSummary' => true,
