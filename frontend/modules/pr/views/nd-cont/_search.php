...
/* @var $model app\modules\pr\models\TbPr2TempSearch */
...
<div class="tb-pr2-temp-search">
    ...
    <?php // echo $form->field($model, 'PRRejfromAppNote') ?>

    <?php // echo $form->field($model, 'PRVerifyby') ?>

    <?php // echo $form->field($model, 'PRApprovedby') ?>

    <?php // echo $form->field($model, 'PRVerifyNote') ?>

    <?php // echo $form->field($model, 'PRbudgetID') ?>
