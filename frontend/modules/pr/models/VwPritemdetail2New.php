...
class VwPritemdetail2New extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ids', 'ItemID', 'TMTID_GPU', 'TMTID_TPU', 'ItemPackID', 'ItemPackUnit', 'ItemPackDefault', 'PRItemNumStatusID', 'PRCreatedBy', 'ids_PR_selected', 'ItemPackIDVerify', 'ItemPackIDApprove', 'PRItemOnPCPlan'], 'integer'],
            [['ItemName1', 'ItemName'], 'string'],
            [['PRItemStdCost', 'PRItemUnitCost', 'PRItemOrderQty', 'PRApprovedOrderQtySum', 'PRItemAvalible', 'PRUnitCost', 'PROrderQty', 'PRVerifyUnitCost', 'PRVerifyQty', 'PRApprovedUnitCost', 'PRApprovedOrderQty', 'PRPackQty', 'ItemPackCost', 'ItemPackSKUQty', 'PRPackQtyVerify', 'ItemPackCostVerify', 'PRPackQtyApprove', 'ItemPackCostApprove', 'PRLastUnitCost', 'alertcolor_check', 'PRQty', 'PRUnitCost2', 'PRExtendedCost', 'VerifyQty', 'VerifyUnitCost', 'ExtenedCost'], 'number'],
