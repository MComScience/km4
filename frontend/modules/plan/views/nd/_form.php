                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            echo $form->field($model, 'PCPlanTypeID', ['showLabels' => false])->widget(Select2::classname(), [
                                'data' => ['3' => 'แผนการจัดซื้อเวชภัณฑ์ฯ ประจำปี', '4' => 'แผนการจัดซื้อเวชภัณฑ์ฯ เฉพาะกาล'],
                                'language' => 'en',
...
if ($action == 'update') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/nd/update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}

if ($action == 'view') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/nd/view-update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}

if ($action == 'verify') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/nd/verify.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}
?>
