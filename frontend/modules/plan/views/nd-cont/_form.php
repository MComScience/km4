        ...
        <div class="widget radius-bordered">
            ...
            <div class="widget-body">
                <div class="tb-pcplan-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            echo $form->field($model, 'PCPlanTypeID', ['showLabels' => false])->widget(Select2::classname(), [
                                'data' => ['6' => 'สัญญาจะซื้อจะขายเวชภัณฑ์ฯ'],
                                'language' => 'en',
                                'options' => ['placeholder' => '----- ประเภทแผนจัดซื้อ -----', 'value' => 6],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                ],
                            ])
                        ...
                        <div class="col-sm-1">
                            <input id="CheckOnSubmit" name="CheckOnSubmit" type="hidden"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <?= Html::activeLabel($model, 'PCPOContactID', ['label' => 'เลขที่สัญญาจะชื้อจะขาย' . '<font color="red"> *</font>', 'class' => 'col-sm-2 control-label no-padding-right']) ?>
                        <div class="col-sm-3">
                            <?= $form->field($model, 'PCPOContactID', ['showLabels' => false])->textInput(['style' => 'background-color: #ffff99',]); ?>
                        </div>
                        <?= Html::activeLabel($model, 'PCVendorID', ['label' => 'เลขประจำตัวผู้ขาย' . '<font color="red"> *</font>', 'class' => 'col-sm-2 control-label no-padding-right']) ?>
                        <div class="col-sm-3">
                            <?=
                            $form->field($model, 'PCVendorID', [
                                'showLabels' => false,
                                'addon' => [
                                    'append' => [
                                        'content' => Html::a('เลือก', ['get-vendor'], ['class' => 'btn btn-default', 'role' => 'modal-remote',]),
                                        'asButton' => true
                                    ]
                                ],
                            ])->textInput([
                    ...
                    <div class="form-group">
                        <?= Html::activeLabel($model, 'VendorName', ['label' => 'ชื่อผู้ขาย', 'class' => 'col-sm-2 control-label no-padding-right']) ?>
                        <div class="col-sm-8">
                             <?= $form->field($model, 'VendorName', ['showLabels' => false])->textInput(['readonly' => true]); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="text-align: right;">
                        <div class="col-sm-12">
                            <?php if ($action == 'view') : ?>
                                <?= Html::a(Icon::show('remove', [], Icon::BSG) . 'Close', ['/plan/default/plansale'], ['class' => 'btn btn-default']); ?>
                            <?php endif; ?>
...
if ($action == 'update') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/nd-cont/update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}

if ($action == 'view') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/nd-cont/view-update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}

if ($action == 'verify') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/nd-cont/verify.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}
?>