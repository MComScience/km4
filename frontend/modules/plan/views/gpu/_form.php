                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            echo $form->field($model, 'PCPlanTypeID', ['showLabels' => false])->widget(Select2::classname(), [
                                'data' => ['1' => 'แผนการจัดซื้อยาสามัญ ประจำปี', '2' => 'แผนการจัดซื้อยาสามัญ (เพิ่มเติม)'],
                                'language' => 'en',
...
if ($action == 'update') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/gpu/update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}
if ($action == 'view') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/gpu/view-update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}
if ($action == 'verify') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/gpu/verify.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}
?>
