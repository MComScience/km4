                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            echo $form->field($model, 'PCPlanTypeID', ['showLabels' => false])->widget(Select2::classname(), [
                                'data' => ['5' => 'สัญญาจะซื้อจะขายยา'],
                                'language' => 'en',
                                'options' => ['placeholder' => '----- ประเภทแผนจัดซื้อ -----', 'value' => 5],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                ],
                            ])
...
if ($action == 'update') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/tpu-cont/update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}

if ($action == 'view') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/tpu-cont/view-update.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}

if ($action == 'verify') {
    $this->registerJsFile(Yii::getAlias('@web') . '/js/plan/tpu-cont/verify.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
}
?>