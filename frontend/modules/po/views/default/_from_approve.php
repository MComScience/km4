...
$this->params['breadcrumbs'][] = ['label' => 'สั่งซื้อ', 'url' => ['/po/default/approve']];
            ...
            <div class="widget-body">
                <div class="tb-po2-temp-form">
                    ...
                    <div class="form-group" style="text-align: right;">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <?php if ((Yii::$app->controller->action->id == 'view-approve') && ($model['POStatus'] == 10)) : ?>
                                <?= Html::a(Icon::show('remove', [], Icon::BSG) . 'Close', ['waiting-approve'], ['class' => 'btn btn-default']) ?>
                            <?php endif; ?>

                            <?php if ((Yii::$app->controller->action->id == 'view-approve') && ($model['POStatus'] == 6)) : ?>
                                <?= Html::a(Icon::show('remove', [], Icon::BSG) . 'Close', ['reject-approve'], ['class' => 'btn btn-default']) ?>
                            <?php endif; ?>

                            <?php if ((Yii::$app->controller->action->id == 'update-approve') && ($model['POStatus'] == 11)) : ?>
                                <?= Html::a(Icon::show('remove', [], Icon::BSG) . 'Close', ['approve'], ['class' => 'btn btn-default']) ?>
                                <?= Html::a('ยกเลิกใบสั่งซื้อ', false, ['class' => 'btn btn-warning', 'onclick' => 'CancelPO(this);']) ?>
                            <?php endif; ?>

                            <?php if ((Yii::$app->controller->action->id == 'approve-po') && ($model['POStatus'] == 10)) : ?>
                                <?= Html::a(Icon::show('remove', [], Icon::BSG) . 'Close', ['list-approve'], ['class' => 'btn btn-default']) ?>
                                <?= Html::a(Icon::show('repeat', [], Icon::BSG) . 'Reject', false, ['class' => 'btn btn-warning', 'id' => 'btn-reject']) ?>
                                <?= Html::a(Icon::show('share-alt', [], Icon::BSG) . 'Approve', false, ['class' => 'btn btn-primary btn-approve']) ?>
                            <?php endif; ?>
                        </div>
                    </div>
