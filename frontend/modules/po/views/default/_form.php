        ...
        <div class="widget">
            <div class="widget-header">
                <span class="widget-caption"><h5>
                        <?= Html::encode(empty($model->potype->POType) ? 'สร้างใบสั่งซื้อ' : 'สร้างใบสั่งซื้อ' . $model->potype->POType) ?>
                    </h5></span>
            ...
            <div class="widget-body">
                <div class="tb-po2-temp-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            ...
                            $form->field($model, 'VendorID', [
                                'addon' => [
                                    'append' => [
                                        'content' => Html::a('เลือก', ['get-vendor', 'type' => 1,'action' => 'update'], ['class' => 'btn btn-default', 'role' => 'modal-remote',]),
                                        'asButton' => true
                                    ]
                                ],
                            ])->textInput([
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            ...
                            $form->field($model, 'Menu_VendorID', [
                                'addon' => [
                                    'append' => [
                                        'content' => Html::a('เลือก', ['get-vendor', 'type' => 2,'action' => 'update'], ['class' => 'btn btn-default', 'role' => 'modal-remote',]),
                                        'asButton' => true
                                    ]
                                ],
                            ])->textInput([
                    ...
                    <div class="form-group" style="text-align: right;">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <?= Html::a(Icon::show('remove', [], Icon::BSG) . 'Close', ['index'], ['class' => 'btn btn-default']) ?>
                            ...
                            <?= Html::button(Icon::show('share-alt', [], Icon::BSG) . 'Save & Send To Verify', ['class' => 'btn btn-primary btn-sendtoverify','disabled' => true]) ?>
                        </div>
                    </div>
