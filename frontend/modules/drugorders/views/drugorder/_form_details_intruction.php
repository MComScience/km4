...
use app\modules\drugorders\models\Tbcpoeperiodunit;
use app\modules\drugorders\models\Tbcpoeprnreason;
use app\modules\drugorders\models\Tbdrugroute;
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        ...
                        $form->field($model, 'cpoe_drugprandialadviceid', ['showLabels' => false])->widget(DepDrop::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'url' => Url::to(['/cpoes/drugorder/get-drugadvice']),
...
<script>
    ...
    function CalculateQty() {
        ...
        $.ajax({
            type: frm.attr('method'),
            url: 'index.php?r=cpoes/drugorder/calculate-qty',
            data: frm.serialize(),
            dataType: "JSON",
            success: function (data) {
    ...
    function CalculateDrugprice() {
        ...
        $.ajax({
            url: "index.php?r=cpoes/drugorder/calculate-drugprice",
            type: "post",
    ...
    $('select[id=tbcpoedetail-cpoe_sig_code]').on('change', function () {
        ...
        if (sigcodeid != '') {
            ...
            $.ajax({
                url: "index.php?r=cpoes/drugorder/changestate-sigcode",
                type: "post",
                data: {id: sigcodeid},
                dataType: "JSON",
                success: function (data) {
