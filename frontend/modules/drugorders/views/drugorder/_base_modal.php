...
<div class="row">
    <div class="col-md-7 col-md-offset-0">
        <div id="simplewizard" class="wizard" data-target="#simplewizard-steps">
            <ul class="steps">
                <li id="simplewizardstep1" data-target="#simplewizardstep1" class="active"><span class="step">1</span>เลือก Base Solution<span class="chevron"></span></li>
    ...
    $(document).ready(function () {
        ...
        function CheckedItemType() {
            ...
            if (typeid == '51') {
                ...
                //document.getElementById("cpoetype21").checked = true;
                $('input[id=tbcpoedetail-cpoe_itemtype]').val('51');
            }
        }
        //เช็คกรณีแก้ไขรายการ
