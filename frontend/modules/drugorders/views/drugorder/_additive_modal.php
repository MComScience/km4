...
<div class="row">
    <div class="col-md-7 col-md-offset-0">
        <div id="simplewizard" class="wizard" data-target="#simplewizard-steps">
            <ul class="steps">
                <li id="simplewizardstep1" data-target="#simplewizardstep1" class="active"><span class="step">1</span>เลือกตัวยา<span class="chevron"></span></li>
                ...
                <li id="simplewizardstep3" style="display: none;" data-target="#simplewizardstep3"><span class="step"><div id="numbersteb3"></div></span>กำหนดปริมาณ<span class="chevron"></span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content tabs-flat bg-white">
                            ...
                            <div id="tabised" class="tab-pane">
                                <div class="row">
                                    <?= $this->render('_form_ised', ['model' => $detailmodel, 'isedreason' => $isedreason]) ?>
                                </div>
                            </div>
                            <!-- End Content -->
                            ...
                            <div id="profile11" class="tab-pane">
                                ...
                                <?=
                                $this->render('_form_details_additive', [
                                    'model' => $detailmodel,
                                    'cpoeid' => $cpoeid,
                                    'route' => $route,
                                    'parentid' => $parentid,
...
<script>
    ...
    $(document).ready(function () {
        ...
        function CheckedItemType() {
            ...
            if (typeid == '52') {
                //document.getElementById("cpoetype21").checked = true;
            } else {
                //document.getElementById("cpoetype21").checked = true;
                $('input[id=tbcpoedetail-cpoe_itemtype]').val('52');
            }
        }
        //เช็คกรณีแก้ไขรายการ
