...
/**
 * VwcpoerxdetailSearch represents the model behind the search form about `app\modules\drugorders\models\Vwcpoerxdetail`.
 */
class VwcpoerxdetailSearch extends Vwcpoerxdetail
{
    ...
    {
        return [
            [['cpoe_ids', 'cpoe_seq', 'cpoe_id', 'cpoe_Itemtype', 'ItemID', 'cpoe_ItemStatus'], 'integer'],
            [['ItemDetail', 'ItemQty1', 'ised_reason', 'ised_reason_decs', 'Item_comment1', 'Item_comment2', 'Item_comment3', 'Item_comment4', 'schedule_period', 'schedule_begin2end','cpoe_parentid'], 'safe'],
