...
/**
 * This is the model class for table "KM4GETPTADMIT".
 *
 ...
 */
class KM4GETPTADMIT extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['PT_FNAME_TH', 'PT_LNAME_TH', 'PT_ADMISSION_NUMBER'], 'string', 'max' => 100],
            [['PT_CID', 'PT_REGISTRY_BY', 'PT_SERVICE_SECTION_ID', 'PT_SERVICE_FROM_SECTION_ID'], 'string', 'max' => 255],
        ];
    }
