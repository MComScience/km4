...
use app\modules\AuthenticationandFinance\models\KM4GETPTIPD;

/**
 * KM4GETPTIPDSearch represents the model behind the search form about `app\modules\AuthenticationandFinance\models\KM4GETPTIPD`.
 */
