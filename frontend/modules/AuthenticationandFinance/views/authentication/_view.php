    ...
    <div class="col-md-6">
        ...
        <div class="col-md-6" >
            <div class="col-lg-2 col-md-4 col-sm-12 text-center">
                <img src="<?php echo !empty($modelregitedlist->pt_picture_path) ? $modelregitedlist->pt_picture_path :'assets/img/avatars/admin.png' ?>" style="width: 150px;height: 150px;" id="image"  class="header-avatar">
            </div>
            ...
            <table id="example" border="1" width="100%" class="table table-striped table-bordered dt-responsive norap">
               <thead>
                <tr>
                    ...
                    <th style="text-align: center">ชื่อหน่วยงานลูกหนี้</th>
