    ...
    var t = $('table.default').DataTable({
        ...
        "language": {
            ...
            <ul class="dropdown-menu dropdown-success">\n\
                <li><a href="/km4/plan/tpu-cont/create" data-pjax="0" style="font-size:11pt;"><i class="glyphicon glyphicon-edit"></i> ยาการค้า</a></li>\n\
                <li><a href="/km4/plan/nd-cont/create" data-pjax="0" style="font-size:11pt;"><i class="glyphicon glyphicon-edit"></i> เวชภัณฑ์ฯ</a></li>\n\
            </ul></div>' + '\n\
                <div class="checkbox">\n\
        ...
        if ($(this).is(":checked") && $('#SortGPU').is(":checked") === false && $('#SortND').is(":checked") === false) {
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายยา.*$/))
                        {
                            return true;
                        }
                        return false;
            ...
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายยา.*$/) || sorttb.match(/^แผนการจัดซื้อยาสามัญ.*$/) || sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/))
                        {
                            return true;
                        }
                        return false;
            ...
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายยา.*$/) || sorttb.match(/^แผนการจัดซื้อยาสามัญ.*$/))
                        {
                            return true;
                        }
                        return false;
            ...
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายยา.*$/) || sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/))
                        {
                            return true;
                        }
                        return false;
            ...
            if ($('#SortGPU').is(":checked") === true && $('#SortND').is(":checked") === true) {
                $.fn.dataTable.ext.search.push(
                        function (settings, data, dataIndex) {
                            var sorttb = data[6] || null;
                            if (sorttb.match(/^แผนการจัดซื้อยาสามัญ.*$/) || sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/))
                            {
                                return true;
                            }
                            return false;
                ...
                $.fn.dataTable.ext.search.push(
                        function (settings, data, dataIndex) {
                            var sorttb = data[6] || null;
                            if (sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/))
                            {
                                return true;
                            }
                            return false;
    ...
    $('#SortND').click(function () {
        ...
        if ($(this).is(":checked") && $('#SortTPU').is(":checked") === false && $('#SortGPU').is(":checked") === false) {
            ...
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/) || sorttb.match(/^สัญญาจะซื้อจะขายยา.*$/) || sorttb.match(/^แผนการจัดซื้อยาสามัญ.*$/))
                        {
                            return true;
                        }
                        return false;
            ...
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/) || sorttb.match(/^สัญญาจะซื้อจะขายยา.*$/))
                        {
                            return true;
                        }
                        return false;
            ...
            $.fn.dataTable.ext.search.push(
                    function (settings, data, dataIndex) {
                        var sorttb = data[6] || null;
                        if (sorttb.match(/^สัญญาจะซื้อจะขายเวชภัณฑ์ฯ.*$/) || sorttb.match(/^แผนการจัดซื้อยาสามัญ.*$/))
                        {
                            return true;
                        }
                        return false;
