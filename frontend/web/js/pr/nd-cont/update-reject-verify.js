...
function SelectND(e) {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: {PRID: PRID, plan: plan, ItemID: ItemID},
        success: function (data)
        {
            if (data === 'false') {
                swal({
                ...
                $('#nd-modal .modal-title').html('บันทึกรายเวชภัณฑ์จะซื้อจะขาย ใบขอซื้อ');
                $('#data').html(data);
                $('.page-content').waitMe('hide');
                $('#nd-modal').modal('show');
    ...
    $('.activity-update-link').click(function (e) {
        ...
        $.get(
                ...
                function (data)
                {
                    ...
                    $('#nd-modal').find('.modal-body').html(data);
                    $('#data').html(data);
                    $('#nd-modal .modal-title').html('ปรับปรุงรายการเวชภัณฑ์จะซื้อจะขาย ใบขอซื้อ');
                    $('.page-content').waitMe('hide');
                    $('#nd-modal').modal('show');
