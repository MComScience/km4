    ...
    <div class="hpanel">
        <div class="hpanel">
            <ul class="nav nav-tabs">
                <li ><a  href="index.php?r=Opdandipd/km4getptopd" aria-expanded="true">รายชื่อผูป่วยรอลงทะเบียน</a></li>
                <li class="active"><a  href="index.php?r=Opdandipd/km4getptopd/opdregister" aria-expanded="false">รายชื่อผุ้ป่วยนอกลงทะเบียนแล้ว</a></li>
...
//
    ...
    function conf() {
        if ($("#pt_vs_bp_sys").val() == '' || $("input[name='pt_vs_bp_dia']").val() == '' || $("input[name='pt_vs_pr']").val() == '' || $("input[name='pt_vs_spo']").val() == '' || $("input[name='pt_vs_rr']").val() == '' || $("input[name='pt_vs_bodytemp']").val() == '' || $("input[name='pt_vs_height']").val() == '' || $("input[name='pt_vs_weight']").val() == '') {
