...
<div class="hpanel">
    <ul class="nav nav-tabs">
        <li class="active"><a  href="index.php?r=Opdandipd/km4getptipd" aria-expanded="true">รายชื่อผู้ป่วยรอลงทะเบียน</a></li>
        <li class=""><a  href="index.php?r=Opdandipd/km4getptipd/ipdregister" aria-expanded="false">รายชื่อผุ้ป่วยในลงทะเบียนแล้ว</a></li>
                            ...
                            foreach ($getipd as $r) {
                                if ($r->d['pt_registry_date'] != date('Y-m-d') && $r->d['pt_registry_date'] == null) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center"><?php echo $r->title['pt_titlename']; ?></td>
                                        <td style="text-align: center"><?php echo $r->PT_FNAME_TH ?></td>
                                        <td style="text-align: center"><?php echo $r->PT_LNAME_TH ?></td>
    ...
    function conf(hn, dat) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                $.get('index.php?r=Opdandipd/km4getptipd/save_service', {hn: hn, dat: dat}, function (response) {
