    ...
    <div class="hpanel">
        <div class="hpanel">
            <ul class="nav nav-tabs">
                ...
                <li ><a  href="index.php?r=Opdandipd/km4getptipd/ipdregister" aria-expanded="false">รายชื่อผุ้ป่วยในลงทะเบียนแล้ว</a></li>
                <li class="active"><a  href="index.php?r=Opdandipd/km4getptipd/waitregisterdoctor" aria-expanded="false">รายชื่อผู้ป่วยส่งพบแพทย์</a></li>
